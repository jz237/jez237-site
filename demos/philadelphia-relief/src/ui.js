import { normalizeSearch, searchScore } from './search-match.js?v=philly-2026092104';
/**
...
import { CONTROLS, LAYERS, GROUPS } from './schema.js?v=philly-2026092104';
import { WEATHER_PRESETS, dayLabel, clockLabel } from './solar.js?v=philly-2026092104';
import { getEra } from './eras.js?v=philly-2026092104';
import { PRESETS, QUICK_JUMPS } from './presets.js?v=philly-2026092104';
import { TOURS } from './tours.js?v=philly-2026092104';
import { ERAS } from './eras.js?v=philly-2026092104';
import { getTheme, THEME_IDS } from './themes.js?v=philly-2026092104';
