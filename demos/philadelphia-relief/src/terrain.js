...
import { hexToRgb, getTheme, bakeRamp } from './themes.js?v=philly-2026092117';
...
const FRAGMENT_SHADER = /* glsl */ `
  ...
  void main() {
    ...
    // Uniform branches avoid fetching inactive textures on every terrain pixel.
    if (uImageryCityOn > 0.0) {
