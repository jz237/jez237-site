...
import { lerp, lerpAngle, easeInOutCubic, clamp } from './geo.js?v=philly-2026092121';
import { CONTROLS, CAMERA, LAYERS, coercePatch } from './schema.js?v=philly-2026092121';
...
export const PRESETS = [
  ...
  },
  {
    ...
    settings: {
      ...
      fogDensity: 0.32, glow: 0.16, waterIntensity: 0.85,
      contourStrength: 0.18, contourInterval: 25,
      boundaryOpacity: 0.15, labelDensity: 0.75, labelSize: 1,
      structureDetail: 0.75, structureHeight: 1,
    },
    layers: { terrain: true, imagery: true, hillshade: true, contours: false, water: false,
      parks: false, rail: false, boundaries: false,
  ...
  },
  {
    ...
    settings: {
      ...
      boundaryOpacity: 0.1, labelDensity: 0.4, labelSize: 1,
      structureDetail: 0.7, structureHeight: 1.15,
    },
    layers: { terrain: true, imagery: true, hillshade: true, contours: false, water: false,
      parks: false, rail: true, boundaries: false,
      places: true, landmarks: true, structures: true },
  },
  {
    id: 'overview',
  ...
  },
  {
    ...
    settings: {
      ...
      boundaryOpacity: 0.18, labelDensity: 0.36, labelSize: 1,
      structureDetail: 0.7, structureHeight: 1,
    },
    layers: { terrain: true, imagery: false, hillshade: true, contours: true, water: true,
      parks: true, rail: false, boundaries: false,
      places: true, landmarks: true, structures: true },
  },
  {
    ...
    settings: {
      ...
      boundaryOpacity: 0.18, labelDensity: 0.55, labelSize: 1.05,
      structureDetail: 0.7, structureHeight: 1,
    },
    layers: { terrain: true, imagery: false, hillshade: true, contours: true, water: true,
      parks: true, rail: true, boundaries: false,
      places: true, landmarks: true, structures: true },
  },
  {
    id: 'wissahickon',
    ...
    settings: {
      ...
      boundaryOpacity: 0.14, labelDensity: 0.62, labelSize: 1.05,
  ...
  },
  {
    ...
    settings: {
      ...
      boundaryOpacity: 0.34, labelDensity: 0.6, labelSize: 1.05,
      structureDetail: 0.5, structureHeight: 1,
    },
    layers: { terrain: true, imagery: false, hillshade: true, contours: true, water: true,
      parks: true, rail: true, boundaries: true,
      places: true, landmarks: true, structures: true },
  },
  {
    id: 'night-metro',
    ...
    settings: {
      ...
      boundaryOpacity: 0.3, labelDensity: 0.55, labelSize: 1,
      structureDetail: 0.85, structureHeight: 1,
    },
    layers: { terrain: true, imagery: false, hillshade: true, contours: true, water: true,
      parks: false, rail: true, boundaries: true,
      places: true, landmarks: true, structures: true },
  },
];
