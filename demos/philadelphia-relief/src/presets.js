...
import { lerp, lerpAngle, easeInOutCubic, clamp } from './geo.js?v=philly-2026092005';
import { CONTROLS, CAMERA, LAYERS, coercePatch } from './schema.js?v=philly-2026092005';
...
export const PRESET_EXCLUDED = new Set(['quality', 'animationSpeed', 'floodMode', 'seaLevelRise',
  ...
  'compareMode', 'comparePosition', 'photoMode']);
