...
import { aircraftGeometry } from '../src/aircraft-model.js';
import { writeFile } from 'node:fs/promises';
const mesh = aircraftGeometry(), buffers = [], bufferViews = [], accessors = [];
let offset = 0;
...
const doc = { asset: { version: '2.0', generator: 'Philadelphia Relief original aircraft' },
...
await writeFile(new URL('../data/aircraft.glb', import.meta.url), Buffer.concat([
