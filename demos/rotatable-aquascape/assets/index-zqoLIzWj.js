...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Xs(e,t,n){let r=new Float32Array(Is),i=new W(0,1,0);return new Ya({name:`SphericalGaussianBlur`,defines:{n:Is,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:$s(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Zs(){return new Ya({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:$s(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Qs(){return new Ya({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:$s(),fragmentShader:`
	...
	`}var ec=class extends Xt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new na(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
float h=max(0.,position.y);transformed.x+=sin(waterTime*.7+position.x*2.+modelMatrix[3].x)*.035*h*h;transformed.z+=sin(waterTime*.5+position.z*3.)*.022*h*h;`)};for(let[n,r,s,c,l]of[[0,-3.5,.92,1.6,1],[1,-2.65,1.55,1.1,0],[2,-2.05,.73,1.35,2.2],[3,-1.1,.1,1.5,1.5],[0,-4.45,-.4,1.2,.8],[3,-3.48,-.95,1.4,2.1],[2,-.05,-1.2,1.05,.7],[1,3,-.5,1.3,2.5],[0,4.26,.45,1,1.5],[2,3.73,1.56,.8,1.6]]){let u=a[n].geometry.clone();u.computeBoundingBox();let d=u.boundingBox,f=d.getCenter(new W),p=d.getSize(new W);u.translate(-f.x,-d.min.y,-f.z);let m=new X(u,o);m.scale.setScalar(c/Math.max(p.x,p.z)),m.position.set(r,t(r,s)+.035,s),m.rotation.y=l,m.castShadow=m.receiveShadow=!0,m.customDepthMaterial=new eo({depthPacking:Ve,alphaMap:i,alphaTest:.4,side:2}),e.add(m)}}var Wd=class e extends X{constructor(t,n={}){super(t),this.isReflector=!0,this.type=`Reflector`,this.forceUpdate=!1,this._reflectionCameras=new WeakMap;let r=this,i=n.color===void 0?new J(8355711):new J(n.color),a=n.textureWidth||512,o=n.textureHeight||512,s=n.clipBias||0,c=n.shader||e.ReflectorShader,l=n.multisample===void 0?4:n.multisample,u=new Ai,d=new W,f=new W,p=new W,m=new q,h=new W(0,0,-1),g=new Jt,_=new W,v=new W,b=new Jt,x=new q,S=new Xt(a,o,{samples:l,type:y}),C=new Ya({name:c.name===void 0?`unspecified`:c.name,uniforms:Ka.clone(c.uniforms),fragmentShader:c.fragmentShader,vertexShader:c.vertexShader});C.uniforms.tDiffuse.value=S.texture,C.uniforms.color.value=i,C.uniforms.textureMatrix.value=x,this.material=C,this.onBeforeRender=function(e,t,n){let i=this.getReflectionCamera(n);if(f.setFromMatrixPosition(r.matrixWorld),p.setFromMatrixPosition(n.matrixWorld),m.extractRotation(r.matrixWorld),d.set(0,0,1),d.applyMatrix4(m),_.subVectors(f,p),_.dot(d)>0&&this.forceUpdate===!1)return;_.reflect(d).negate(),_.add(f),m.extractRotation(n.matrixWorld),h.set(0,0,-1),h.applyMatrix4(m),h.add(p),v.subVectors(f,h),v.reflect(d).negate(),v.add(f),i.position.copy(_),i.up.set(0,1,0),i.up.applyMatrix4(m),i.up.reflect(d),i.lookAt(v),i.far=n.far,i.updateMatrixWorld(),i.projectionMatrix.copy(n.projectionMatrix),x.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),x.multiply(i.projectionMatrix),x.multiply(i.matrixWorldInverse),x.multiply(r.matrixWorld),u.setFromNormalAndCoplanarPoint(d,f),u.applyMatrix4(i.matrixWorldInverse),g.set(u.normal.x,u.normal.y,u.normal.z,u.constant);let a=i.projectionMatrix;i.isOrthographicCamera?(b.x=(Math.sign(g.x)+a.elements[8])/a.elements[0],b.y=(Math.sign(g.y)+a.elements[9])/a.elements[5],b.z=-n.far,b.w=1):(b.x=(Math.sign(g.x)+a.elements[8])/a.elements[0],b.y=(Math.sign(g.y)+a.elements[9])/a.elements[5],b.z=-1,b.w=(1+a.elements[10])/a.elements[14]),g.multiplyScalar(2/g.dot(b)),a.elements[2]=g.x,a.elements[6]=g.y,i.isOrthographicCamera?(a.elements[10]=g.z-s,a.elements[14]=g.w-1):(a.elements[10]=g.z+1-s,a.elements[14]=g.w),r.visible=!1;let o=e.getRenderTarget(),c=e.xr.enabled,l=e.shadowMap.autoUpdate;e.xr.enabled=!1,e.shadowMap.autoUpdate=!1,e.setRenderTarget(S),e.state.buffers.depth.setMask(!0),e.autoClear===!1&&e.clear(),e.render(t,i),e.xr.enabled=c,e.shadowMap.autoUpdate=l,e.setRenderTarget(o);let y=n.viewport;y!==void 0&&e.state.viewport(y),r.visible=!0,this.forceUpdate=!1},this.getRenderTarget=function(){return S},this.dispose=function(){S.dispose(),r.material.dispose()},this.getReflectionCamera=function(e){let t=this._reflectionCameras.get(e);return t===void 0&&(t=e.clone(),this._reflectionCameras.set(e,t)),t}}};Wd.ReflectorShader={name:`ReflectorShader`,uniforms:{color:{value:null},tDiffuse:{value:null},textureMatrix:{value:null}},vertexShader:`
		...
		}`};var Gd=class extends Dn{surfaces=[];constructor(){super();for(let e of[!0,!1]){let t=new Wd(new Ra(10.08,4.6),{textureWidth:1024,textureHeight:512,clipBias:.002,multisample:0,shader:{name:`AquariumWaterReflection`,uniforms:{color:{value:new J(16777215)},tDiffuse:{value:null},textureMatrix:{value:new q},time:{value:0},underside:{value:+!!e}},vertexShader:`uniform mat4 textureMatrix;varying vec4 reflectionUv;varying vec3 world;void main(){reflectionUv=textureMatrix*vec4(position,1.);world=(modelMatrix*vec4(position,1.)).xyz;gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.);}`,fragmentShader:`uniform sampler2D tDiffuse;uniform float time;uniform float underside;varying vec4 reflectionUv;varying vec3 world;
    void main(){
     ...
     #include <tonemapping_fragment>
     #include <colorspace_fragment>
    }`}});t.position.y=5.36,t.rotation.x=e?Math.PI/2:-Math.PI/2,t.renderOrder=6,t.material.transparent=!0,t.material.depthWrite=!1,this.add(t),this.surfaces.push(t)}}update(e,t){this.surfaces.forEach((n,r)=>{n.visible=t<5.36==(r===0),n.material.uniforms.time.value=e})}};function Kd(e=2731){let t=document.createElement(`canvas`);t.width=512,t.height=1024;let n=t.getContext(`2d`),r=n.createImageData(512,1024),i=e,a=()=>(i=Math.imul(i,1664525)+1013904223>>>0,i/4294967296);for(let e=0;e<1024;e++)for(let t=0;t<512;t++){let n=t/512,i=e/1024,o=(e*512+t)*4,s=Math.sin(t*.087+Math.sin(e*.031)*2.2)*Math.sin(e*.063+Math.sin(t*.053))*5,c=Math.sin(n*17+Math.sin(i*14))*Math.sin(i*22)*6,l=180+26*Math.sin(i*Math.PI)+s+c+(a()-.5)*16;r.data[o]=r.data[o+1]=r.data[o+2]=l,r.data[o+3]=255}n.putImageData(r,0,0);for(let e=0;e<18;e++){let t=80+e*49+(a()-.5)*15;for(let e of[-1,1]){n.strokeStyle=`rgba(245,249,220,.28)`,n.lineWidth=1.6,n.beginPath(),n.moveTo(256,t),n.bezierCurveTo(256+e*60,t-18,256+e*157,t-95,256+e*255,t-118),n.stroke();for(let r=1;r<7;r++){let i=256+e*r*32,a=t-r*15;n.strokeStyle=`rgba(230,238,213,.12)`,n.lineWidth=.6,n.beginPath(),n.moveTo(i,a),n.quadraticCurveTo(i+e*18,a-22,i+e*25,a-50),n.stroke()}}}n.strokeStyle=`rgba(94,105,65,.4)`,n.lineWidth=5,n.beginPath(),n.moveTo(258,1024),n.quadraticCurveTo(256,512,256,0),n.stroke(),n.strokeStyle=`rgba(249,250,223,.62)`,n.lineWidth=2,n.beginPath(),n.moveTo(255,1024),n.quadraticCurveTo(254,512,256,0),n.stroke();let o=new ra(t);return o.colorSpace=He,o.anisotropy=8,o}var qd=(e,t,n)=>new W((e-940)*.014,(550-t)*.014+.65,(n-.5)*2.52+.25),Jd=e=>({x:e.x/.014+940,y:550-(e.y-.65)/.014,z:(e.z-.25)/2.52+.5});function Yd(e,t,n=.23){for(let r=0;r<8;r++){let r=!1;for(let i of t){let t=e.clone().sub(i.center),a=t.length(),o=i.radius+n;a<o-1e-7&&(a<.001?t.set(0,1,0):t.divideScalar(a),e.copy(i.center).addScaledVector(t,o+1e-4),r=!0)}if(!r)break}return e}function Xd(e,t){let n=1,r=e.position,i=new W;for(let a=0;a<t.count;a++){i.fromBufferAttribute(t,a).applyMatrix4(e.matrix).sub(r);for(let[e,t]of[[`x`,4.96],[`z`,2.2],[`y`,5.25]]){let a=i[e],o=r[e];a>0&&(n=Math.min(n,(t-o)/(a+.05))),a<0&&e!==`y`&&(n=Math.min(n,(-t-o)/(a-.05)))}}n<1&&(e.scale.multiplyScalar(Math.max(.02,n)),e.updateMatrix())}var Zd=(e,t,n)=>new W(e,t,n),Qd=Zd(0,1,0);function $d(e,t,n){let r=84237,i=()=>(r=Math.imul(r,1664525)+1013904223>>>0,r/4294967296),a=new Map,o=new En;for(let e of[`stem`,`rotala`,`sword`,`anubias`,`carpet`,`moss`]){let t=[],n=[],r=[],i=e===`sword`?20:e===`anubias`?10:6,o=e===`sword`?6:e===`anubias`?4:2;for(let a=0;a<=i;a++){let s=a/i,c=Math.max(0,(s-.08)/.92),l=e===`anubias`?Math.sin(c*Math.PI)**.54:e===`sword`?Math.sin(c*Math.PI)**.9:Math.sin(c*Math.PI)**.67,u=s<.08?.012:l*.5;for(let c=0;c<=o;c++){let l=c/o,d=l*2-1,f=Math.abs(d),p=Math.sin(s*22+d*3)*f*f*(e===`sword`?.03:.012),m=(e===`sword`?.25:.13)*s*s;if(t.push(d*u,s,-m+f*f*.055*Math.sin(s*Math.PI)+p),n.push(l,s),a<i&&c<o){let e=a*(o+1)+c;r.push(e,e+1,e+o+1,e+1,e+o+2,e+o+1)}}}let s=new kr;s.setAttribute(`position`,new Y(t,3)),s.setAttribute(`uv`,new Y(n,2)),s.setIndex(r),s.computeVertexNormals(),a.set(e,{geometry:s,matrices:[],colors:[]})}let s=(e,t,n,r,i,s,c,l,u=0)=>{let d=a.get(e);o.position.copy(t),o.quaternion.setFromUnitVectors(Qd,n.normalize()),o.rotateY(u),o.scale.set(i,r,r),o.updateMatrix(),Xd(o,d.geometry.getAttribute(`position`)),d.matrices.push(o.matrix.clone()),d.colors.push(new J().setHSL(s,c,l).convertSRGBToLinear())},c=[],l=(e,t,n,r)=>c.push({a:e,b:t,r:n,color:new J(r)});for(let[e,n,r,a,o]of[[-4.1,-1.55,1.15,4.55,!1],[-2.7,-1.7,.95,4.4,!1],[-.65,-1.55,1,4.1,!0],[.8,-1.65,.9,4.15,!0],[2.2,-1.5,.95,3.65,!0],[3.6,-1.55,1.1,4.45,!1],[4.2,-.75,.6,3.5,!1]])for(let c=0;c<(o?33:49);c++){let c=At.clamp(e+(i()-.5)*r*1.6,-4.85,4.85),u=At.clamp(n+(i()-.5)*.8,-2.1,1.5),d=t(c,u),f=Math.min(5.22-d,a*(.6+i()*.4)),p=(i()-.5)*.5,m=(i()-.5)*.25,h=i()*6,g=e=>Zd(c+p*e+Math.sin(e*3+h)*.065*e,d+f*e,u+m*e),_=21+Math.floor(i()*7),v=g(0);for(let e=1;e<=_;e++){let t=e/_,n=g(t);l(v,n,.009*(1-t*.6),o?7692857:6388528),v=n;for(let r=0;r<2;r++){let a=e*Math.PI*.51+h+r*Math.PI,c=(.23+i()*.15)*(1-t*.25);s(o?`rotala`:`stem`,n,Zd(Math.cos(a),.25+i()*.7,Math.sin(a)),c,c*(o?.28:.34),o?.03+i()*.018+(1-t)*.05:.2+i()*.065,o?.62:.71,o?.24+i()*.1:.25+i()*.12,i()*.6)}}}for(let[e,n,r]of[[-4.1,-.2,7],[-3.6,-1.1,4],[3.95,-.35,6],[3.5,-1.05,4],[-1.35,-1.3,3]])for(let a=0;a<r;a++){let r=e+(i()-.5)*.8,o=n+(i()-.5)*.7,c=t(r,o);for(let e=0;e<11;e++){let t=e*2.399+a,n=.8+i()*1.65;s(`sword`,Zd(r,c,o),Zd(Math.cos(t)*.46,.55+i()*.5,Math.sin(t)*.5),n,.13+i()*.19,.2+i()*.045,.68,.24+i()*.095,i()*.65)}}for(let e=0;e<70;e++){let n=-4.6+i()*4.9,r=-.5+i()*2.5,a=t(n,r)+.02;for(let t=0;t<5;t++){let o=t*2.399+e,c=.13+i()*.15,u=Zd(n,a,r),d=u.clone().add(Zd(Math.cos(o)*.15,.04+i()*.08,Math.sin(o)*.15));l(u,d,.007,4348708),s(`anubias`,d,Zd(Math.cos(o)*.65,.2+i()*.5,Math.sin(o)*.65),c,c*.7,.22+i()*.025,.65,.18+i()*.07,i())}}for(let e=0;e<4800;e++){let e=(i()-.5)*9.85,n=(i()-.5)*4.4,r=1.5+Math.sin(n*1.05)*.65,a=.42+(n+2.2)*.16;if(Math.abs(e-r)<a+.1+i()*.08||n<-.75&&i()<.7)continue;let o=t(e,n)+.015;for(let t=0;t<4;t++){let t=i()*Math.PI*2,r=.06+i()*.1;s(`carpet`,Zd(e,o,n),Zd(Math.cos(t)*.8,.35+i()*.7,Math.sin(t)*.8),r,r*.73,.19+i()*.07,.7,.25+i()*.14)}}let u=Kd();for(let[t,r]of a){let i=new Za({color:16777215,map:u,bumpMap:u,bumpScale:t===`sword`?.035:.012,roughness:t===`anubias`?.48:.67,side:2});i.onBeforeCompile=e=>{e.uniforms.waterTime=n,e.vertexShader=`uniform float waterTime;varying vec2 botanicalUv;
`+e.vertexShader,e.vertexShader=e.vertexShader.replace(`#include <begin_vertex>`,`#include <begin_vertex>
botanicalUv=uv;vec3 root=instanceMatrix[3].xyz;transformed.z+=sin(waterTime*.8+root.x*1.2+root.z*2.)*.035*uv.y*uv.y;transformed.x+=sin(waterTime*.55+root.x*2.)*.016*uv.y*uv.y;`),e.fragmentShader=`varying vec2 botanicalUv;
`+e.fragmentShader,e.fragmentShader=e.fragmentShader.replace(`#include <color_fragment>`,`#include <color_fragment>
   ...
   `),e.fragmentShader=e.fragmentShader.replace(`#include <opaque_fragment>`,`outgoingLight+=diffuseColor.rgb*.11;
#include <opaque_fragment>`)};let a=new Ei(r.geometry,i,r.matrices.length);r.matrices.forEach((e,t)=>{a.setMatrixAt(t,e),a.setColorAt(t,r.colors[t])}),a.castShadow=!0,a.receiveShadow=!0,a.computeBoundingSphere(),e.add(a)}let d=new Ei(new ca(1,1,1,5),new Za({roughness:.85}),c.length);c.forEach(({a:e,b:t,r:n,color:r},i)=>{o.position.copy(e).add(t).multiplyScalar(.5),o.quaternion.setFromUnitVectors(Qd,t.clone().sub(e).normalize()),o.scale.set(n,e.distanceTo(t),n),o.updateMatrix(),d.setMatrixAt(i,o.matrix),d.setColorAt(i,r)}),d.computeBoundingSphere(),e.add(d)}var ef={type:`change`},tf={type:`start`},nf={type:`end`},rf=new Hr,af=new Ai,of=Math.cos(70*At.DEG2RAD),sf=new W,cf=2*Math.PI,lf={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},uf=1e-6,df=class extends bs{constructor(n,r=null){super(n,r),this.state=lf.NONE,this.target=new W,this.cursor=new W,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:`ArrowLeft`,UP:`ArrowUp`,RIGHT:`ArrowRight`,BOTTOM:`ArrowDown`},this.mouseButtons={LEFT:e.ROTATE,MIDDLE:e.DOLLY,RIGHT:e.PAN},this.touches={ONE:t.ROTATE,TWO:t.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._cursorStyle=`auto`,this._domElementKeyEvents=null,this._lastPosition=new W,this._lastQuaternion=new jt,this._lastTargetPosition=new W,this._quat=new jt().setFromUnitVectors(n.up,new W(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new ys,this._sphericalDelta=new ys,this._scale=1,this._panOffset=new W,this._rotateStart=new U,this._rotateEnd=new U,this._rotateDelta=new U,this._panStart=new U,this._panEnd=new U,this._panDelta=new U,this._dollyStart=new U,this._dollyEnd=new U,this._dollyDelta=new U,this._dollyDirection=new W,this._mouse=new U,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=pf.bind(this),this._onPointerDown=ff.bind(this),this._onPointerUp=mf.bind(this),this._onContextMenu=xf.bind(this),this._onMouseWheel=_f.bind(this),this._onKeyDown=vf.bind(this),this._onTouchStart=yf.bind(this),this._onTouchMove=bf.bind(this),this._onMouseDown=hf.bind(this),this._onMouseMove=gf.bind(this),this._interceptControlDown=Sf.bind(this),this._interceptControlUp=Cf.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}set cursorStyle(e){this._cursorStyle=e,e===`grab`?this.domElement.style.cursor=`grab`:this.domElement.style.cursor=`auto`}get cursorStyle(){return this._cursorStyle}connect(e){super.connect(e),this.domElement.addEventListener(`pointerdown`,this._onPointerDown),this.domElement.addEventListener(`pointercancel`,this._onPointerUp),this.domElement.addEventListener(`contextmenu`,this._onContextMenu),this.domElement.addEventListener(`wheel`,this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener(`keydown`,this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction=`none`}disconnect(){this.domElement.removeEventListener(`pointerdown`,this._onPointerDown),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.domElement.removeEventListener(`pointercancel`,this._onPointerUp),this.domElement.removeEventListener(`wheel`,this._onMouseWheel),this.domElement.removeEventListener(`contextmenu`,this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener(`keydown`,this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction=``}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(ef),this.update(),this.state=lf.NONE}pan(e,t){this._pan(e,t),this.update()}dollyIn(e){this._dollyIn(e),this.update()}dollyOut(e){this._dollyOut(e),this.update()}rotateLeft(e){this._rotateLeft(e),this.update()}rotateUp(e){this._rotateUp(e),this.update()}update(e=null){let t=this.object.position;sf.copy(t).sub(this.target),sf.applyQuaternion(this._quat),this._spherical.setFromVector3(sf),this.autoRotate&&this.state===lf.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let n=this.minAzimuthAngle,r=this.maxAzimuthAngle;isFinite(n)&&isFinite(r)&&(n<-Math.PI?n+=cf:n>Math.PI&&(n-=cf),r<-Math.PI?r+=cf:r>Math.PI&&(r-=cf),n<=r?this._spherical.theta=Math.max(n,Math.min(r,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(n+r)/2?Math.max(n,this._spherical.theta):Math.min(r,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let i=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{let e=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),i=e!=this._spherical.radius}if(sf.setFromSpherical(this._spherical),sf.applyQuaternion(this._quatInverse),t.copy(this.target).add(sf),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let e=null;if(this.object.isPerspectiveCamera){let t=sf.length();e=this._clampDistance(t*this._scale);let n=t-e;this.object.position.addScaledVector(this._dollyDirection,n),this.object.updateMatrixWorld(),i=!!n}else if(this.object.isOrthographicCamera){let t=new W(this._mouse.x,this._mouse.y,0);t.unproject(this.object);let n=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),i=n!==this.object.zoom;let r=new W(this._mouse.x,this._mouse.y,0);r.unproject(this.object),this.object.position.sub(r).add(t),this.object.updateMatrixWorld(),e=sf.length()}else console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled.`),this.zoomToCursor=!1;e!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(e).add(this.object.position):(rf.origin.copy(this.object.position),rf.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(rf.direction))<of?this.object.lookAt(this.target):(af.setFromNormalAndCoplanarPoint(this.object.up,this.target),rf.intersectPlane(af,this.target))))}else if(this.object.isOrthographicCamera){let e=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),e!==this.object.zoom&&(this.object.updateProjectionMatrix(),i=!0)}return this._scale=1,this._performCursorZoom=!1,i||this._lastPosition.distanceToSquared(this.object.position)>uf||8*(1-this._lastQuaternion.dot(this.object.quaternion))>uf||this._lastTargetPosition.distanceToSquared(this.target)>uf?(this.dispatchEvent(ef),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e===null?cf/60/60*this.autoRotateSpeed:cf/60*this.autoRotateSpeed*e}_getZoomScale(e){let t=Math.abs(e*.01);return .95**(this.zoomSpeed*t)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,t){sf.setFromMatrixColumn(t,0),sf.multiplyScalar(-e),this._panOffset.add(sf)}_panUp(e,t){this.screenSpacePanning===!0?sf.setFromMatrixColumn(t,1):(sf.setFromMatrixColumn(t,0),sf.crossVectors(this.object.up,sf)),sf.multiplyScalar(e),this._panOffset.add(sf)}_pan(e,t){let n=this.domElement;if(this.object.isPerspectiveCamera){let r=this.object.position;sf.copy(r).sub(this.target);let i=sf.length();i*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*i/n.clientHeight,this.object.matrix),this._panUp(2*t*i/n.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/n.clientWidth,this.object.matrix),this._panUp(t*(this.object.top-this.object.bottom)/this.object.zoom/n.clientHeight,this.object.matrix)):(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - pan disabled.`),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_updateZoomParameters(e,t){if(!this.zoomToCursor)return;this._performCursorZoom=!0;let n=this.domElement.getBoundingClientRect(),r=e-n.left,i=t-n.top,a=n.width,o=n.height;this._mouse.x=r/a*2-1,this._mouse.y=-(i/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(cf*this._rotateDelta.x/t.clientHeight),this._rotateUp(cf*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let t=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(cf*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),t=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-cf*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),t=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(cf*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),t=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-cf*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),t=!0}t&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateStart.set(n,r)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panStart.set(n,r)}}_handleTouchStartDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyStart.set(0,i)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateEnd.set(n,r)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(cf*this._rotateDelta.x/t.clientHeight),this._rotateUp(cf*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panEnd.set(n,r)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyEnd.set(0,i),this._dollyDelta.set(0,(this._dollyEnd.y/this._dollyStart.y)**+this.zoomSpeed),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);let a=(e.pageX+t.x)*.5,o=(e.pageY+t.y)*.5;this._updateZoomParameters(a,o)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId){this._pointers.splice(t,1);return}}_isTrackingPointer(e){for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId)return!0;return!1}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new U,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){let t=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[t]}_customWheelEvent(e){let t=e.deltaMode,n={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(t){case 1:n.deltaY*=16;break;case 2:n.deltaY*=100}return e.ctrlKey&&!this._controlActive&&(n.deltaY*=10),n}};function ff(e){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(e.pointerId),this.domElement.ownerDocument.addEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.addEventListener(`pointerup`,this._onPointerUp)),!this._isTrackingPointer(e)&&(this._addPointer(e),e.pointerType===`touch`?this._onTouchStart(e):this._onMouseDown(e),this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grabbing`)))}function pf(e){this.enabled!==!1&&(e.pointerType===`touch`?this._onTouchMove(e):this._onMouseMove(e))}function mf(e){switch(this._removePointer(e),this._pointers.length){case 0:this.domElement.releasePointerCapture(e.pointerId),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.dispatchEvent(nf),this.state=lf.NONE,this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grab`);break;case 1:let t=this._pointers[0],n=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:n.x,pageY:n.y})}}function hf(t){let n;switch(t.button){case 0:n=this.mouseButtons.LEFT;break;case 1:n=this.mouseButtons.MIDDLE;break;case 2:n=this.mouseButtons.RIGHT;break;default:n=-1}switch(n){case e.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(t),this.state=lf.DOLLY;break;case e.ROTATE:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=lf.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=lf.ROTATE}break;case e.PAN:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=lf.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=lf.PAN}break;default:this.state=lf.NONE}this.state!==lf.NONE&&this.dispatchEvent(tf)}function gf(e){switch(this.state){case lf.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(e);break;case lf.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(e);break;case lf.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(e)}}function _f(e){this.enabled!==!1&&this.enableZoom!==!1&&this.state===lf.NONE&&(e.preventDefault(),this.dispatchEvent(tf),this._handleMouseWheel(this._customWheelEvent(e)),this.dispatchEvent(nf))}function vf(e){this.enabled!==!1&&this._handleKeyDown(e)}function yf(e){switch(this._trackPointer(e),this._pointers.length){case 1:switch(this.touches.ONE){case t.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(e),this.state=lf.TOUCH_ROTATE;break;case t.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(e),this.state=lf.TOUCH_PAN;break;default:this.state=lf.NONE}break;case 2:switch(this.touches.TWO){case t.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(e),this.state=lf.TOUCH_DOLLY_PAN;break;case t.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(e),this.state=lf.TOUCH_DOLLY_ROTATE;break;default:this.state=lf.NONE}break;default:this.state=lf.NONE}this.state!==lf.NONE&&this.dispatchEvent(tf)}function bf(e){switch(this._trackPointer(e),this.state){case lf.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(e),this.update();break;case lf.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(e),this.update();break;case lf.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(e),this.update();break;case lf.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(e),this.update();break;default:this.state=lf.NONE}}function xf(e){this.enabled!==!1&&e.preventDefault()}function Sf(e){e.key===`Control`&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}function Cf(e){e.key===`Control`&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}var wf=class extends In{constructor(){super(),this.name=`RoomEnvironment`,this.position.y=-3.5;let e=new sa;e.deleteAttribute(`uv`);let t=new Za({side:1}),n=new Za,r=new Xo(16777215,900,28,2);r.position.set(.418,16.199,.3),this.add(r);let i=new X(e,t);i.position.set(-.757,13.219,.717),i.scale.set(31.713,28.305,28.591),this.add(i);let a=new Ei(e,n,6),o=new En;o.position.set(-10.906,2.009,1.846),o.rotation.set(0,-.195,0),o.scale.set(2.328,7.905,4.651),o.updateMatrix(),a.setMatrixAt(0,o.matrix),o.position.set(-5.607,-.754,-.758),o.rotation.set(0,.994,0),o.scale.set(1.97,1.534,3.955),o.updateMatrix(),a.setMatrixAt(1,o.matrix),o.position.set(6.167,.857,7.803),o.rotation.set(0,.561,0),o.scale.set(3.927,6.285,3.687),o.updateMatrix(),a.setMatrixAt(2,o.matrix),o.position.set(-2.017,.018,6.124),o.rotation.set(0,.333,0),o.scale.set(2.002,4.566,2.064),o.updateMatrix(),a.setMatrixAt(3,o.matrix),o.position.set(2.291,-.756,-2.621),o.rotation.set(0,-.286,0),o.scale.set(1.546,1.552,1.496),o.updateMatrix(),a.setMatrixAt(4,o.matrix),o.position.set(-2.193,-.369,-5.547),o.rotation.set(0,.516,0),o.scale.set(3.875,3.487,2.986),o.updateMatrix(),a.setMatrixAt(5,o.matrix),this.add(a);let s=new X(e,Tf(50));s.position.set(-16.116,14.37,8.208),s.scale.set(.1,2.428,2.739),this.add(s);let c=new X(e,Tf(50));c.position.set(-16.109,18.021,-8.207),c.scale.set(.1,2.425,2.751),this.add(c);let l=new X(e,Tf(17));l.position.set(14.904,12.198,-1.832),l.scale.set(.15,4.265,6.331),this.add(l);let u=new X(e,Tf(43));u.position.set(-.462,8.89,14.52),u.scale.set(4.38,5.441,.088),this.add(u);let d=new X(e,Tf(20));d.position.set(3.235,11.486,-12.541),d.scale.set(2.5,2,.1),this.add(d);let f=new X(e,Tf(100));f.position.set(0,20,0),f.scale.set(1,.1,1),this.add(f)}dispose(){let e=new Set;this.traverse(t=>{t.isMesh&&(e.add(t.geometry),e.add(t.material))});for(let t of e)t.dispose()}};function Tf(e){return new $a({color:0,emissive:16777215,emissiveIntensity:e})}function Ef(e,t,n){return e+Math.max(0,Math.min(.1,Number.isFinite(t)?t:0))*(.8+Math.max(0,Math.min(1.5,n))*11)}function Df(e,t,n){let r=Math.max(0,Math.min(1.5,n)),i=Math.max(0,Math.min(1.3,(.33-e)/.65)),a=.002+r*.195,o=t-i*3.3,s=i**1.25,c=a*s*Math.sin(o),l=i>0?-a/.65*(1.25*i**.25*Math.sin(o)-3.3*s*Math.cos(o)):0;return{x:e,z:c,angle:Math.atan(l)}}function Of(e,t,n,r,i){let a=Df(e,r,i);return[a.x-n*Math.sin(a.angle),t,a.z+n*Math.cos(a.angle)]}function kf(e,t,n,r,i,a,o=1,s=r*1.65,c=1){let l=Math.max(0,Math.min(1.5,i));if(a===`tail`){let i=-.3,a=e-i,o=Df(i,r,l),s=o.angle+Math.sin(r-3.7)*(.025+l*.22);return[o.x+a*Math.cos(s)-n*Math.sin(s),t,o.z+a*Math.sin(s)+n*Math.cos(s)]}if(a===`pectoral`){let i=.25,a=-.055,u=o*.049,d=e-i,f=t-a,p=n-u,m=s+o*.7,h=.35+c*.65,g=Math.sin(m)*.65*h,_=(.45+Math.sin(m-.5)*.4)*o*h,v=d*Math.cos(g)-f*Math.sin(g),y=d*Math.sin(g)+f*Math.cos(g);return Of(i+v,a+y*Math.cos(_)-p*Math.sin(_),u+y*Math.sin(_)+p*Math.cos(_),r,l)}let u=0;return a===`dorsal`&&(u=Math.max(0,t-.07)),a===`anal`&&(u=Math.max(0,-t-.12)),Of(e+Math.sin(r*.7+e*11)*u*.1,t+Math.sin(r*.85+e*8)*u*.08,n+Math.sin(r*.9+e*13)*u*.38,r,l)}var Af=class{group=new Dn;meshes=[];phase=0;pectoralPhase=0;fins=new Map;originals=new Map;shaders=[];eyes=[];constructor(e,t=0,n=!0){this.phase=t,this.pectoralPhase=t*1.7;let r=new Qa({map:e,roughness:.43,metalness:.12,clearcoat:.35,clearcoatRoughness:.25}),i=r.clone();i.transparent=!0,i.opacity=.65,i.alphaTest=.12,i.side=2,i.depthWrite=!1,i.roughness=.55;let a=i.clone();a.map=null,a.color.set(12112584),a.opacity=.48,a.alphaTest=.01;let o=[[-.32,.025],[-.26,.041],[-.14,.073],[0,.106],[.14,.115],[.27,.101],[.37,.075],[.445,.038],[.49,.003]],s=[],c=[],l=[],u=n?65:33,d=n?32:16;for(let e=0;e<u;e++){let t=-.32+e/(u-1)*.81,n=0;for(;n<o.length-2&&o[n+1][0]<t;)n++;let r=o[n],i=o[n+1],a=At.smoothstep(t,r[0],i[0]),f=At.lerp(r[1],i[1],a);for(let n=0;n<=d;n++){let r=n/d*Math.PI*2,i=-.035+Math.cos(r)*f,a=Math.sin(r)*f*.52;if(s.push(t,i,a),c.push(t+.5,.5+i/.45),e<u-1&&n<d){let t=e*(d+1)+n;l.push(t,t+1,t+d+1,t+1,t+d+2,t+d+1)}}}for(let[e,t]of[[0,-.32],[u-1,.49]]){let n=s.length/3;s.push(t,-.035,0),c.push(t+.5,.5-.035/.45);for(let t=0;t<d;t++){let r=e*(d+1)+t,i=r+1;e===0?l.push(n,i,r):l.push(n,r,i)}}let f=new kr;f.setAttribute(`position`,new Y(s,3)),f.setAttribute(`uv`,new Y(c,2)),f.setIndex(l),f.computeVertexNormals(),this.add(f,r);let p=(e,t,n=1)=>{let r=[],o=[];for(let t=1;t<e.length-1;t++){let n=e[0],i=e[t],a=e[t+1],s=(e,t)=>{let s=1-e-t,c=n[0]*s+i[0]*e+a[0]*t,l=n[1]*s+i[1]*e+a[1]*t,u=(n[2]||0)*s+(i[2]||0)*e+(a[2]||0)*t;r.push(c,l,u),o.push(c+.5,.5+l/.45)};for(let e=0;e<7;e++)for(let t=0;t<7-e;t++)s(e/7,t/7),s((e+1)/7,t/7),s(e/7,(t+1)/7),e+t<6&&(s((e+1)/7,t/7),s((e+1)/7,(t+1)/7),s(e/7,(t+1)/7))}let s=new kr;s.setAttribute(`position`,new Y(r,3)),s.setAttribute(`uv`,new Y(o,2)),s.computeVertexNormals(),this.add(s,t===`pectoral`?a:i,t,n)};p([[-.3,-.035],[-.495,.12],[-.43,.015],[-.395,-.035],[-.43,-.09],[-.495,-.185]],`tail`),p([[-.1,.056],[-.065,.22],[.1,.07]],`dorsal`),p([[-.23,-.079],[-.12,-.21],[.005,-.141],[.12,-.13]],`anal`);for(let e of[-1,1])p([[.25,-.055,e*.049],[.05,-.17,e*.1],[.18,-.1,e*.022]],`pectoral`,e);let m=new Qa({color:6527370,roughness:.25,metalness:.3}),h=new Qa({color:132613,roughness:.16,clearcoat:1});for(let e of[-1,1]){let t=new X(new za(.027,16,12),m);t.scale.set(1,1,.45),t.position.set(.426,-.022,e*.034),this.group.add(t),this.eyes.push(t);let n=new X(new za(.018,16,12),h);n.scale.set(1,1,.3),n.position.set(.426,-.022,e*.047),this.group.add(n),this.eyes.push(n)}}add(e,t,n=`body`,r=1){let i=new X(e,t);this.meshes.push(i),this.fins.set(i,{kind:n,side:r}),this.originals.set(e,new Float32Array(e.getAttribute(`position`).array)),this.group.add(i)}update(e,t,n,r,i,a,o,s=.35){this.phase=Ef(this.phase,o,t),this.pectoralPhase+=o*(5+s*13);for(let e of this.meshes){let n=e.geometry.getAttribute(`position`),r=this.originals.get(e.geometry);for(let i=0;i<n.count;i++){let a=r[i*3],o=r[i*3+1],c=r[i*3+2],l=this.fins.get(e),u=kf(a,o,c,this.phase,t,l.kind,l.side,this.pectoralPhase,s);n.setXYZ(i,...u)}n.needsUpdate=!0,e.geometry.computeVertexNormals()}for(let t of this.shaders)t.uniforms.photograph.value=n,t.uniforms.sceneTime.value=e,t.uniforms.flow.value=r,t.uniforms.depth.value=i,t.uniforms.daylight.value=a}dispose(){let e=new Set;this.group.traverse(t=>{t instanceof X&&(t.geometry.dispose(),e.add(t.material))}),e.forEach(e=>e.dispose())}},jf=e=>Math.max(0,Math.min(1,e));function Mf(){return{hunger:.6,energy:.85,curiosity:.65,decisionIn:0,biteIn:0,seed:723,intent:{kind:`explore`,reason:`Exploring the planting.`},consumedFood:null,visited:[]}}var Nf=e=>(e.seed=Math.imul(e.seed,1664525)+1013904223>>>0,e.seed/4294967296);function Pf(e,t,n){e.visited.push({x:t,y:n,age:0}),e.visited.length>6&&e.visited.shift(),e.curiosity*=.35}function Ff(e,t,n,r,i,a,o=.65){let s=e=>Math.hypot(e.x-n,e.y-r,((e.z??o)-o)*180);if(t<=0)return e.intent;e.hunger=jf(e.hunger+t*.0015),e.energy=jf(e.energy+t*(i<2?.018:-.0015-i*18e-5)),e.curiosity=jf(e.curiosity+t*.006),e.visited.forEach(e=>e.age+=t),e.visited=e.visited.filter(e=>e.age<100),e.biteIn=Math.max(0,e.biteIn-t),e.decisionIn-=t;let c=a.food.filter(e=>s(e)<330).sort((e,t)=>s(e)-s(t))[0];c&&e.hunger>.18&&s(c)<22&&e.biteIn===0&&(e.consumedFood=c.id,e.hunger=jf(e.hunger-.23),e.energy=jf(e.energy+.08),e.biteIn=1.2,e.decisionIn=0);let l=a.neighbors.filter(e=>s(e)<26).sort((e,t)=>s(e)-s(t))[0];if(e.decisionIn>0&&!l&&!(c&&e.hunger>.35&&e.intent.kind!==`feed`)&&(e.intent.kind!==`feed`||c))return e.intent.kind===`feed`&&c&&(e.intent.target=c),e.intent;if(e.decisionIn=.7+Nf(e)*.8,l)e.intent={kind:`space`,reason:`Giving a nearby fish more room.`,target:{id:-1,x:n+(n>=l.x?65:-65),y:r+(r>=l.y?22:-22),z:jf(o+(o>=(l.z??o)?.09:-.09))}};else if(c&&e.hunger>.18)e.intent={kind:`feed`,reason:`Food detected — approaching a flake.`,target:c};else if(e.energy<.28||e.intent.kind===`rest`&&e.energy<.62)e.intent={kind:`rest`,reason:`Resting and fanning its fins to hold position.`};else{let t=a.neighbors.filter(e=>s(e)<260&&s(e)>45);if((t.length>=2||a.schoolGoal)&&Nf(e)<(a.schoolGoal?.88:.48)){let i=Math.max(1,t.length),s=a.schoolGoal,c=t.length?t.reduce((e,t)=>e+t.x,0)/i:n,l=t.length?t.reduce((e,t)=>e+t.y,0)/i:r,u=t.length?t.reduce((e,t)=>e+(t.z??o),0)/i:o,d=t.reduce((e,t)=>e+(t.vx??0),0)/i;e.intent={kind:`school`,reason:`Swimming with the tetra school.`,target:{id:-2,x:s?s.x:c+d*5,y:s?s.y:l,z:s?s.z??u:u,vx:s?.vx??d}},e.decisionIn=1.8+Nf(e)*2}else e.intent={kind:`explore`,reason:e.curiosity>.6?`Looking for an unfamiliar leaf to inspect.`:`Exploring between the plants.`},e.decisionIn=4+Nf(e)*4}return e.intent}var If=.24,Lf=(e,t,n)=>Math.max(t,Math.min(n,e)),Rf=(e,t,n,r)=>e+(t-e)*(1-Math.exp(-r*n));function zf(e){return e.seed=Math.imul(e.seed,1664525)+1013904223>>>0,e.seed/4294967296}function Bf(e=237){return{x:1110,y:330,vx:16,vy:0,yaw:0,pitch:0,speed:16,direction:1,sinceTurn:10,elapsed:0,behavior:`cruising`,remaining:2.6,targetX:1190,targetY:345,cruiseSpeed:16,effort:.7,pectoralEffort:.35,seed:e,wasFeeding:!1,turnRate:.8,depthTarget:445,depthRemaining:20,depthBand:2,z:.62,vz:0,targetZ:.18,depthHeading:0,depthTimer:0,brain:Mf()}}function Vf(e,t){e.behavior=t;let n=zf(e);if(t===`cruising`&&(e.remaining=3+n*5,e.cruiseSpeed=11+zf(e)*10,e.targetY=e.depthTarget),t===`burst`&&(e.remaining=.7+n*1.1,e.cruiseSpeed=24+zf(e)*7),t===`gliding`&&(e.remaining=1.8+n*2.6),t===`inspecting`&&(e.remaining=2.2+n*3.5,Pf(e.brain,e.targetX,e.targetY)),t===`approaching`){let t=[[1170,380],[1090,397],[975,382],[890,327],[760,355],[690,340],[1180,480],[1060,465],[950,490],[810,465],[820,287],[990,275],[1150,290]],r=t.filter(([t,n])=>(t-e.x)*e.direction>25&&(t-e.x)*e.direction<250&&Math.abs(n-e.y)<85),i=r.length?r:t.filter(([,t])=>Math.abs(t-e.y)<85),a=i.filter(([t,n])=>!e.brain.visited.some(e=>Math.hypot(e.x-t,e.y-n)<55)),o=a.length?a:i,s=o[Math.floor(n*o.length)]||t[2];e.targetX=s[0],e.targetY=s[1]-12,e.remaining=20,e.sinceTurn>6&&Math.sign(e.targetX-e.x)!==e.direction&&(e.direction=e.direction===1?-1:1,e.sinceTurn=0,e.turnRate=.65+zf(e)*.2)}t===`foraging`&&(e.remaining=2+n*2,e.targetX=990+zf(e)*65,e.targetY=257+zf(e)*10)}function Hf(e,t,n=!1,r=!1,i){let a=Lf(Number.isFinite(t)?t:0,0,.1);if(!a)return;let o=i?Ff(e.brain,a,e.x,e.y,e.speed,i,e.z):null;if(o&&(n=o.kind===`feed`),e.elapsed+=a,e.sinceTurn+=a,e.remaining-=a,!n&&(e.depthRemaining-=a,e.depthRemaining<=0&&Math.abs(e.depthTarget-e.y)<24)){e.depthBand=(e.depthBand+1+ +(zf(e)<.25))%3;let t=[[267,305],[345,390],[440,485]][e.depthBand];e.depthTarget=t[0]+zf(e)*(t[1]-t[0]),e.depthRemaining=18+zf(e)*18}if(n&&!e.wasFeeding&&Vf(e,`foraging`),!n&&e.wasFeeding&&Vf(e,`gliding`),e.wasFeeding=n,e.remaining<=0){if(n)Vf(e,`foraging`);else if(e.behavior===`burst`)Vf(e,`gliding`);else if(e.behavior===`approaching`)Vf(e,`inspecting`);else if(e.behavior===`inspecting`)Vf(e,zf(e)<.6?`burst`:`cruising`);else{let t=zf(e);Vf(e,t<.36&&Math.abs(e.depthTarget-e.y)<30?`approaching`:t<.7?`burst`:`cruising`)}}e.sinceTurn>6&&(e.direction===1&&e.x>1210||e.direction===-1&&e.x<660)&&(e.direction=e.direction===1?-1:1,e.sinceTurn=0,e.turnRate=.65+zf(e)*.2,n||Vf(e,`cruising`)),n&&e.sinceTurn>6&&(e.targetX-e.x)*e.direction<-22&&(e.direction=e.direction===1?-1:1,e.sinceTurn=0),o?.target&&(e.targetX=Lf(o.target.x,650,1220),e.targetY=Lf(o.target.y,240,500),(o.kind===`school`||o.kind===`space`)&&(e.behavior=`cruising`,e.cruiseSpeed=o.kind===`space`?9:15,e.remaining=Math.max(1,e.remaining)),e.sinceTurn>6&&(e.targetX-e.x)*e.direction<-35&&(e.direction=e.direction===1?-1:1,e.sinceTurn=0));let s=e.direction===1?0:Math.PI,c=Math.abs(s-e.yaw)>.18,l=e.behavior===`inspecting`,u=l?(1+Math.sin(e.elapsed*1.1))*.045:0,d=s+(e.direction===1?u:-u);e.yaw+=Lf(d-e.yaw,-a*e.turnRate,a*e.turnRate);let f=e.cruiseSpeed,p=e.cruiseSpeed/28,m=.35;if(e.behavior===`burst`&&(p=1+(e.cruiseSpeed-24)/20,m=.25),e.behavior===`gliding`&&(f=0,p=.025,m=.18),l&&(f=0,p=.02,m=.8+Math.sin(e.elapsed*1.7)*.12),(e.behavior===`approaching`||e.behavior===`foraging`)&&(f=Lf(((e.targetX-e.x)*e.direction-5)*.55,0,e.behavior===`foraging`?23:15),Math.abs(e.targetY-e.y)>20&&(f=Math.max(f,7)),p=f/24,m=f<3?.8:.4,e.behavior===`approaching`&&Math.abs(e.targetX-e.x)<19&&Math.abs(e.targetY-e.y)<17&&(Vf(e,`inspecting`),f=0,p=.02,m=.9)),o?.kind===`school`&&(f=Lf(Math.abs(o.target?.vx??12)*.8+Math.abs(e.targetX-e.x)*.025,13,23),p=f/28),o?.kind===`rest`&&(f=0,p=.015,m=.85,e.behavior=`gliding`,e.remaining=2),c&&(f=Math.min(f,8),p=.3,m=.7),r&&(f=Math.min(f,11),p=Math.min(p,.55)),i)for(let t of i.neighbors){let n=t.x-e.x,r=t.y-e.y,i=((t.z??e.z)-e.z)*180,a=Math.hypot(n,r,i),o=n*e.direction>0,s=(e.vx-(t.vx??0))*n+(e.vy-(t.vy??0))*r;o&&s>0&&a<90&&Math.abs(r)<38&&Math.abs(i)<45&&(f=Math.min(f,Math.max(8,(a-55)*.35)),m=Math.max(m,.85),p=Math.min(p,.18))}e.speed=Rf(e.speed,f,e.behavior===`gliding`?.65:1.65,a),e.effort=Rf(e.effort,p,3,a),e.pectoralEffort=Rf(e.pectoralEffort,m,3,a);let h=e.behavior===`inspecting`||o?.kind===`rest`,g=o?.target||e.behavior===`approaching`||e.behavior===`foraging`?e.targetY:e.depthTarget,_=Math.min(5,Math.max(1,e.speed)*Math.tan(If)),v=c||h?0:Lf((g-e.y)*.16,-_,_);e.vy=Rf(e.vy,v,2,a),e.vx=e.speed*Math.cos(e.yaw),e.x+=e.vx*a,e.y+=e.vy*a;let y=c?0:h?Math.sin(e.elapsed*.9)*.025:Lf(Math.atan2(-e.vy,Math.max(1,e.speed)),-.24,If);e.depthTimer-=a,Math.abs(e.z-e.targetZ)<.045&&e.depthTimer<=0&&(e.targetZ=e.targetZ<.5?.72+zf(e)*.2:.08+zf(e)*.22,e.depthTimer=8+zf(e)*10);let b=o?.target?.z??(n?.65:e.targetZ),x=h||c?0:Lf((b-e.z)*.15,-e.speed*.65/180,e.speed*.65/180);e.vz=Rf(e.vz,x,1.6,a),e.z=Lf(e.z+e.vz*a,.06,.94);let S=c?0:Math.atan2(-e.vz*180,Math.max(2,e.speed))*e.direction;e.depthHeading+=Lf(S-e.depthHeading,-.25*a,.25*a),e.pitch+=Lf((y-e.pitch)*(1-Math.exp(-a*2)),-.25*a,.25*a)}function Uf(e){return e.brain.intent.kind===`rest`?`Resting`:e.brain.intent.kind===`school`?`Following the school`:e.brain.intent.kind===`space`?`Making space`:{cruising:`Exploring`,burst:`Short swimming burst`,gliding:`Gliding`,approaching:`Approaching a leaf`,inspecting:`Inspecting the planting`,foraging:`Looking for food`}[e.behavior]}var Wf=()=>({direction:1,time:0});function Gf(e,t,n){if(t>0){e.time+=t;let r=n.reduce((e,t)=>e+t.x,0)/Math.max(1,n.length);r>1120?e.direction=-1:r<750&&(e.direction=1)}return{id:-3,x:e.direction===1?1220:650,y:365+65*Math.sin(e.time*.03),z:.5+.25*Math.sin(e.time*.04),vx:e.direction*17}}function Kf(e,t){return{...e,y:e.y+Math.sin(t*2.4)*45,z:Math.max(.2,Math.min(.8,(e.z??.5)+Math.cos(t*2.4)*.14))}}function qf(e){for(let t=0;t<24;t++){let t=0;for(let n=0;n<e.length;n++)for(let r=n+1;r<e.length;r++){let i=e[n],a=e[r],o=a.x-i.x,s=a.y-i.y,c=(a.z-i.z)*180,l=Math.hypot(o,s,c),u=i.radius+a.radius;if(l>=u)continue;l<1e-8&&(o=0,s=0,c=i.id<a.id?1:-1,l=1);let d=u-l;t=Math.max(t,d);let f=(d+.001)*.5/l;i.x-=o*f,i.y-=s*f,i.z-=c*f/180,a.x+=o*f,a.y+=s*f,a.z+=c*f/180}for(let t of e)t.x=Math.max(620+t.radius,Math.min(1260-t.radius,t.x)),t.y=Math.max(220+t.radius,Math.min(550-t.radius,t.y)),t.z=Math.max(.03+t.radius/180,Math.min(.97-t.radius/180,t.z));if(t<.002)break}}var Jf=(e,t,n)=>new W(e,t,n),Yf=At.clamp,Xf=class{host;ready;paused=!1;evening=!1;status=`Exploring`;renderer;scene=new In;camera=new Ko(37,1,.1,100);controls;targetCamera=null;time=0;last=0;seed=237;daylight=1;key=new Jo(15268077,200,26,.94,.65,1.1);fill=new Po(12772070,2634018,1.65);swimShader={value:0};fishes=[];school=Wf();texture=new qt;obstacles=[];food=[];dust;bubbles;water;frame=0;diagnosticTime=0;diagnosticFrames=0;resizeObserver;constructor(e){this.host=e,this.renderer=new Ru({antialias:!0,alpha:!1,powerPreference:`high-performance`}),this.renderer.setPixelRatio(Math.min(devicePixelRatio,1.65)),this.renderer.outputColorSpace=He,this.renderer.toneMapping=4,this.renderer.toneMappingExposure=1.12,this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=1,e.appendChild(this.renderer.domElement),this.renderer.domElement.tabIndex=0,this.renderer.domElement.setAttribute(`aria-label`,`Aquarium. Drag to rotate, use the view and zoom buttons below.`),this.scene.background=new J(528146),this.scene.fog=new Fn(661019,.023);let t=new Gs(this.renderer),n=new wf;this.scene.environment=t.fromScene(n,.035).texture,this.scene.environmentIntensity=.1,n.dispose(),t.dispose(),this.controls=new df(this.camera,this.renderer.domElement),this.controls.target.set(0,2.75,0),this.controls.enableDamping=!0,this.controls.dampingFactor=.07,this.controls.enablePan=!1,this.controls.minAzimuthAngle=-Math.PI*.42,this.controls.maxAzimuthAngle=Math.PI*.46,this.controls.minPolarAngle=Math.PI*.31,this.controls.maxPolarAngle=Math.PI*.515,this.controls.minDistance=10.8,this.controls.maxDistance=29,this.controls.rotateSpeed=.55,this.controls.zoomSpeed=.7,this.controls.addEventListener(`start`,()=>this.targetCamera=null),this.camera.position.set(0,3.3,21.5),this.scene.add(this.fill,this.key),this.key.position.set(-1.5,8,1.7),this.key.target.position.set(0,1,-.5),this.scene.add(this.key.target),this.key.castShadow=!0,this.key.shadow.mapSize.set(2048,2048),this.key.shadow.bias=-3e-4,this.key.shadow.normalBias=.035,this.key.shadow.radius=3;let r=new $o(13819839,.65);r.position.set(-5,6,-3),this.scene.add(r);let i=new Xo(16767405,7,18,2);i.position.set(6,5,5),this.scene.add(i),this.buildTank(),this.buildLandscape(),$d(this.scene,(e,t)=>this.height(e,t),this.swimShader),this.water=this.buildWater(),this.dust=this.buildParticles(),this.bubbles=new Ei(new za(.018,7,5),new Qa({color:13823712,roughness:.05,metalness:.1,transparent:!0,opacity:.36,depthWrite:!1}),48),this.scene.add(this.bubbles),this.resizeObserver=new ResizeObserver(()=>this.resize()),this.resizeObserver.observe(e),this.resize(),this.ready=Promise.all([Ud(this.scene,(e,t)=>this.height(e,t),this.swimShader),this.loadFish(),Hd(this.scene,this.obstacles,(e,t)=>this.height(e,t))]).then(()=>{}),this.frame=requestAnimationFrame(this.animate),document.addEventListener(`visibilitychange`,()=>{this.last=0})}random(){return this.seed=Math.imul(this.seed,1664525)+1013904223>>>0,this.seed/4294967296}mesh(e,t,n,r=!0){let i=new X(e,t);return i.position.copy(n),i.castShadow=r,i.receiveShadow=r,this.scene.add(i),i}box(e,t,n,r,i,a=!0){return this.mesh(new sa(e,t,n),r,i,a)}soilMaterial(e){let t=document.createElement(`canvas`);t.width=t.height=512;let n=t.getContext(`2d`);n.fillStyle=e,n.fillRect(0,0,512,512);for(let e=0;e<28e3;e++){let e=this.random()*512,t=this.random()*512;n.fillStyle=this.random()>.5?`rgba(205,201,167,${this.random()*.2})`:`rgba(5,11,9,${this.random()*.35})`;let r=.4+this.random()*1.9;n.beginPath(),n.ellipse(e,t,r,r*.65,0,0,Math.PI*2),n.fill()}let i=new ra(t);i.colorSpace=He,i.wrapS=i.wrapT=r,i.repeat.set(8,8),i.anisotropy=8;let a=new Za({map:i,bumpMap:i,bumpScale:.018,roughness:.94});return this.caustics(a),a}caustics(e){e.onBeforeCompile=e=>{e.uniforms.waterTime=this.swimShader,e.vertexShader=`varying vec3 waterWorld;
`+e.vertexShader,e.vertexShader=e.vertexShader.replace(`#include <project_vertex>`,`#include <project_vertex>
waterWorld=(modelMatrix*vec4(transformed,1.)).xyz;`),e.fragmentShader=`uniform float waterTime;varying vec3 waterWorld;
`+e.fragmentShader,e.fragmentShader=e.fragmentShader.replace(`#include <dithering_fragment>`,`float ca=sin(waterWorld.x*7.+sin(waterWorld.z*5.+waterTime*.31)*1.9+waterTime*.42)*sin(waterWorld.z*8.-waterTime*.37+sin(waterWorld.x*4.)*1.6);float pool=pow(max(0.,ca),12.);gl_FragColor.rgb+=pool*.047*vec3(.68,1.,.83);
#include <dithering_fragment>`)}}buildTank(){let e=new Za({color:1121310,roughness:.35,metalness:.65}),t=new Ur({color:527888});this.box(100,.2,100,t,Jf(0,-1.1,0)),this.box(10.45,.88,4.95,e,Jf(0,-.51,0)),this.box(10.7,.13,5.1,new Za({color:1581347,metalness:.75,roughness:.28}),Jf(0,-.035,0));let n=new Ur({color:264459});for(let e of[-2.6,0,2.6])this.box(.012,.7,.012,n,Jf(e,-.53,2.479),!1);let r=new Qa({color:16777215,metalness:0,roughness:.005,transparent:!0,opacity:.14,transmission:.985,ior:1.5,thickness:.035,side:2,depthWrite:!1,envMapIntensity:.7,attenuationColor:new J(13033940),attenuationDistance:12}),i=(e,t,n,i=0)=>{let a=this.mesh(new sa(e,t,.024),r,n,!1);a.rotation.y=i,a.renderOrder=8};i(10.2,5.55,Jf(0,2.8,2.36)),i(10.2,5.55,Jf(0,2.8,-2.36)),i(4.72,5.55,Jf(-5.1,2.8,0),Math.PI/2),i(4.72,5.55,Jf(5.1,2.8,0),Math.PI/2);let a=new Ur({color:10275001,transparent:!0,opacity:.56,depthWrite:!1});for(let e of[-5.1,5.1])for(let t of[-2.36,2.36])this.box(.025,5.6,.025,a,Jf(e,2.8,t),!1);for(let e of[-2.36,2.36])for(let t of[.06,5.59])this.box(10.2,.023,.025,a,Jf(0,t,e),!1);for(let e of[-5.1,5.1])for(let t of[.06,5.59])this.box(.025,.023,4.72,a,Jf(e,t,0),!1);this.box(9.2,.12,.65,e,Jf(0,6.4,-.15));let o=new Za({color:14744046,emissive:14744046,emissiveIntensity:3});for(let e=0;e<3;e++)this.box(8.75,.018,.105,o,Jf(0,6.335,-.37+e*.2),!1);for(let t of[-3.8,3.8])this.box(.019,4,.019,e,Jf(t,8.45,-.15),!1);let s=new Qa({color:15069417,transparent:!0,opacity:1,transmission:.96,thickness:.035,ior:1.5,roughness:.025,metalness:0,depthWrite:!1,envMapIntensity:1.2});for(let e of[4.4,4.77]){let t=[Jf(e,1.1,-1.99),Jf(e,5.1,-1.99),Jf(e,5.79,-1.99),Jf(e,5.84,-2.55),Jf(e,3.5,-2.62)];this.mesh(new Ba(new ya(t),96,.065,24,!1),s,Jf(0,0,0),!1)}}height(e,t){return .3+.55*Math.exp(-((e+2.5)**2/6+(t+.8)**2/2))+.22*(1-(t+2.3)/4.6)+.035*Math.sin(e*2+t)*Math.cos(t*3)}buildLandscape(){let e=this.soilMaterial(`#34332a`),t=new Ra(10.12,4.64,110,55);t.rotateX(-Math.PI/2);let n=t.getAttribute(`position`);for(let e=0;e<n.count;e++)n.setY(e,this.height(n.getX(e),n.getZ(e))+(this.random()-.5)*.035);t.computeVertexNormals(),this.mesh(t,e,Jf(0,0,0)),this.box(10.13,.32,4.64,e,Jf(0,.17,0));let r=[],i=[],a=[];for(let e=0;e<=65;e++){let t=2.29-e/65*4.5,n=1.5+Math.sin(t*1.05)*.65,o=.42+(t+2.2)*.16;for(let s=0;s<=12;s++){let c=n+(s/12-.5)*o*2;if(r.push(c,this.height(c,t)+.026,t),i.push(s/5,e/10),e<65&&s<12){let t=e*13+s;a.push(t,t+1,t+13,t+1,t+14,t+13)}}}let o=new kr;o.setAttribute(`position`,new Y(r,3)),o.setAttribute(`uv`,new Y(i,2)),o.setIndex(a),o.computeVertexNormals();let s=this.soilMaterial(`#b9ae92`);s.bumpScale=.025,this.mesh(o,s,Jf(0,0,0));let c=new Za({color:8620153,roughness:.95}),l=new Ei(new La(1,0),c,700),u=new En;for(let e=0;e<700;e++){let t=(this.random()-.5)*10,n=(this.random()-.5)*4.5,r=.025+this.random()*.057;u.position.set(t,this.height(t,n)+r*.35,n),u.scale.set(r,r*.65,r*.8),u.rotation.set(this.random()*3,this.random()*3,this.random()),u.updateMatrix(),l.setMatrixAt(e,u.matrix),l.setColorAt(e,new J().setHSL(.13,.12,.55+this.random()*.3))}l.receiveShadow=!0,this.scene.add(l)}buildWater(){let e=new Gd;this.scene.add(e);let t=new Ur({color:12968913,transparent:!0,opacity:.5,depthWrite:!1});for(let e of[-2.3,2.3])this.box(10.08,.015,.012,t,Jf(0,5.36,e),!1);return e}buildParticles(){let e=[];for(let t=0;t<180;t++)e.push((this.random()-.5)*9.8,.7+this.random()*4.5,(this.random()-.5)*4.4);let t=new kr;t.setAttribute(`position`,new Y(e,3));let n=new ea(t,new Yi({color:12638652,size:.013,transparent:!0,opacity:.32,depthWrite:!1,sizeAttenuation:!0}));return this.scene.add(n),n}async loadFish(){let e=new Image;e.src=`./living-species.png`,await e.decode();let t=document.createElement(`canvas`);t.width=e.width/2,t.height=e.height/2;let n=t.getContext(`2d`);n.drawImage(e,0,0,t.width,t.height,0,0,t.width,t.height);let r=n.getImageData(0,0,t.width,t.height).data,i=t.width,a=t.height,o=0,s=0;for(let e=0;e<t.height;e++)for(let n=0;n<t.width;n++)r[(e*t.width+n)*4+3]>32&&(i=Math.min(i,n),o=Math.max(o,n),a=Math.min(a,e),s=Math.max(s,e));let c=document.createElement(`canvas`);c.width=o-i+1,c.height=s-a+1,c.getContext(`2d`).drawImage(t,i,a,c.width,c.height,0,0,c.width,c.height),this.texture=new ra(c),this.texture.colorSpace=He,this.texture.anisotropy=8;for(let e=0;e<16;e++){let t=new Af(this.texture,e*.83,!1),n=Bf(237+e*7919),r=.48+this.random()*.09;Object.assign(n,{x:870+e%4*65,y:310+Math.floor(e/4)*33,z:.28+e%3*.19,elapsed:e*.7,remaining:2+e*.23}),n.brain.seed=723+e*3571,n.brain.energy=.72+this.random()*.22,n.brain.hunger=.45+this.random()*.22,t.group.scale.setScalar(r),t.group.traverse(e=>{e instanceof X&&(e.castShadow=!0,e.receiveShadow=!0,e.renderOrder=0)}),this.fishes.push({model:t,swim:n,size:r}),this.scene.add(t.group)}}feed(){if(!(this.food.length>12))for(let e=0;e<12;e++){let e=this.mesh(new La(.028,0),new Za({color:12297329,roughness:1}),Jf(.65+(this.random()-.5)*1.6,5.12+this.random()*.13,.62+(this.random()-.5)*.3),!1);e.scale.set(1,.35,.8),this.food.push({mesh:e,age:0})}}zoom(e){this.targetCamera=null;let t=this.camera.position.clone().sub(this.controls.target);t.setLength(Yf(t.length()*e,this.controls.minDistance,this.controls.maxDistance)),this.camera.position.copy(this.controls.target).add(t),this.controls.update()}view(e){let t=this.host.clientWidth/this.host.clientHeight<.9?23:21.5,n=e===`front`?0:e===`side`?1.28:.47;this.targetCamera=Jf(Math.sin(n)*t,e===`front`?3.3:7.5,Math.cos(n)*t)}resize(){let e=this.host.clientWidth,t=this.host.clientHeight;this.camera.aspect=e/t,this.camera.fov=e/t<.8?52:e/t<1.1?48:33,this.camera.updateProjectionMatrix(),this.renderer.setSize(e,t)}avoidSolid(e){let t=qd(e.x,e.y,e.z),n=t.clone();Yd(t,this.obstacles),t.distanceToSquared(n)>1e-6&&(e.targetZ=Yf(e.z+.1,.1,.9),e.depthTarget=Math.max(260,e.y-30)),Object.assign(e,Jd(t))}animate=e=>{this.frame=requestAnimationFrame(this.animate);let t=this.last?(e-this.last)/1e3:0,n=Math.min(t,.05);this.last=e;let r=this.paused||document.hidden?0:n;this.time+=r,this.swimShader.value=this.time,this.targetCamera&&(this.camera.position.lerp(this.targetCamera,1-Math.exp(-n*4)),this.camera.position.distanceTo(this.targetCamera)<.02&&(this.targetCamera=null)),this.controls.update(),this.daylight=At.lerp(this.daylight,this.evening?.27:1,1-Math.exp(-n*1.4)),this.key.intensity=155*this.daylight,this.fill.intensity=.18+this.daylight*.4,this.renderer.toneMappingExposure=.8+.32*this.daylight;let i=this.fishes.map(({swim:e},t)=>({id:t,x:e.x,y:e.y,z:e.z,vx:e.vx,vy:e.vy,radius:25})),a=Gf(this.school,r,i),o=this.food.map(e=>({id:e.mesh.id,...Jd(e.mesh.position)}));if(this.fishes.forEach(({swim:e},t)=>{if(Hf(e,r,!1,!1,{food:o,neighbors:i.filter(e=>e.id!==t),schoolGoal:Kf(a,t)}),r&&this.avoidSolid(e),e.brain.consumedFood!==null){let t=this.food.findIndex(t=>t.mesh.id===e.brain.consumedFood);if(t>=0){let e=this.food.splice(t,1)[0];this.scene.remove(e.mesh),e.mesh.geometry.dispose(),e.mesh.material.dispose()}e.brain.consumedFood=null}}),r){let e=this.fishes.map(({swim:e},t)=>({id:t,x:e.x,y:e.y,z:e.z,radius:25}));qf(e),e.forEach((e,t)=>Object.assign(this.fishes[t].swim,{x:e.x,y:e.y,z:e.z}))}this.fishes.forEach(({model:e,swim:t})=>{e.group.position.copy(qd(t.x,t.y,t.z)),e.group.rotation.set(0,t.yaw+t.depthHeading,t.pitch,`YXZ`),e.update(this.time,t.effort,this.texture,.65,t.z,1,r,t.pectoralEffort)}),this.status=this.food.length?`Foraging`:this.fishes.length?Uf(this.fishes[0].swim):`Exploring`;for(let e=this.food.length-1;e>=0;e--){let t=this.food[e];t.age+=r,t.mesh.position.y-=r*.07,t.mesh.rotation.y+=r*.5,t.age>48&&(this.scene.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),this.food.splice(e,1))}let s=new En;for(let e=0;e<48;e++){let t=(this.time*(.11+e%4*.015)+e*.137)%1;s.position.set(4.36+Math.sin(t*8+e)*.045+t*.16,.85+t*4.46,-1.7+Math.cos(t*6+e)*.06),s.scale.setScalar(.4+(1-t)*.6),s.updateMatrix(),this.bubbles.setMatrixAt(e,s.matrix)}this.bubbles.instanceMatrix.needsUpdate=!0;let c=this.dust.geometry.getAttribute(`position`);if(r){for(let e=0;e<c.count;e++){let t=c.getX(e)+Math.sin(e+this.time*.2)*r*.018,n=c.getY(e)+r*.006;n>5.3&&(n=.7),c.setXY(e,t,n)}c.needsUpdate=!0}this.water.update(this.time,this.camera.position.y),performance.now(),this.renderer.render(this.scene,this.camera)}};document.querySelector(`#app`).innerHTML=`
<main>
...
</main>`;var Zf=document.querySelector(`#scene`);async function Qf(){try{let e=new Xf(Zf);await e.ready,document.querySelector(`#loading`).remove(),document.querySelector(`#status`).textContent=`Exploring`,document.querySelectorAll(`[data-view]`).forEach(t=>t.onclick=()=>{e.view(t.dataset.view),document.querySelectorAll(`[data-view]`).forEach(e=>e.classList.toggle(`active`,e===t))});let t=document.querySelector(`#pause`);t.onclick=()=>{e.paused=!e.paused,t.textContent=e.paused?`Resume`:`Pause`,t.setAttribute(`aria-pressed`,String(e.paused))};let n=document.querySelector(`#light`);n.onclick=()=>{e.evening=!e.evening,n.textContent=e.evening?`Daylight`:`Evening`,n.setAttribute(`aria-pressed`,String(e.evening))};let r=document.querySelector(`#feed`);r.onclick=()=>{e.feed(),r.disabled=!0,r.textContent=`Food released`,setTimeout(()=>{r.disabled=!1,r.textContent=`Feed fish`},6e3)},document.querySelector(`#zoomIn`).onclick=()=>e.zoom(.85),document.querySelector(`#zoomOut`).onclick=()=>e.zoom(1.18),document.querySelector(`#reset`).onclick=()=>{e.view(`angle`),document.querySelectorAll(`[data-view]`).forEach(e=>e.classList.toggle(`active`,e.dataset.view===`angle`))},Zf.addEventListener(`pointerdown`,()=>document.querySelectorAll(`[data-view]`).forEach(e=>e.classList.remove(`active`))),setInterval(()=>document.querySelector(`#status`).textContent=e.paused?`Paused`:e.status,1200)}catch(e){console.error(e),document.querySelector(`#loading`).innerHTML=`The 3D aquarium could not start.<br><small>Try a browser with WebGL enabled, or visit the photographic version above.</small>`}}Qf();