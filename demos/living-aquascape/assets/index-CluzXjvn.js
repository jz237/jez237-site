...
void main() {
	...
	`}var Zo=class extends cn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ri(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,Vl=class{group=new zn;meshes=[];phase=0;pectoralPhase=0;fins=new Map;originals=new Map;shaders=[];eyes=[];constructor(e,t=0,n=!0){this.phase=t,this.pectoralPhase=t*1.7;let r=new ha({map:e,roughness:.43,metalness:.12,clearcoat:.35,clearcoatRoughness:.25}),i=r.clone();i.transparent=!0,i.opacity=.65,i.alphaTest=.12,i.side=2,i.depthWrite=!1,i.roughness=.55;let a=i.clone();a.map=null,a.color.set(12112584),a.opacity=.48,a.alphaTest=.01;let o=[[-.32,.025],[-.26,.041],[-.14,.073],[0,.106],[.14,.115],[.27,.101],[.37,.075],[.445,.038],[.49,.003]],s=[],c=[],l=[],u=n?65:33,d=n?32:16;for(let e=0;e<u;e++){let t=-.32+e/(u-1)*.81,n=0;for(;n<o.length-2&&o[n+1][0]<t;)n++;let r=o[n],i=o[n+1],a=Vt.smoothstep(t,r[0],i[0]),f=Vt.lerp(r[1],i[1],a);for(let n=0;n<=d;n++){let r=n/d*Math.PI*2,i=-.035+Math.cos(r)*f,a=Math.sin(r)*f*.52;if(s.push(t,i,a),c.push(t+.5,.5+i/.45),e<u-1&&n<d){let t=e*(d+1)+n;l.push(t,t+1,t+d+1,t+1,t+d+2,t+d+1)}}}for(let[e,t]of[[0,-.32],[u-1,.49]]){let n=s.length/3;s.push(t,-.035,0),c.push(t+.5,.5-.035/.45);for(let t=0;t<d;t++){let r=e*(d+1)+t,i=r+1;e===0?l.push(n,i,r):l.push(n,r,i)}}let f=new Vr;f.setAttribute(`position`,new kr(s,3)),f.setAttribute(`uv`,new kr(c,2)),f.setIndex(l),f.computeVertexNormals(),this.add(f,r);let p=(e,t,n=1)=>{let r=[],o=[];for(let t=1;t<e.length-1;t++){let n=e[0],i=e[t],a=e[t+1],s=(e,t)=>{let s=1-e-t,c=n[0]*s+i[0]*e+a[0]*t,l=n[1]*s+i[1]*e+a[1]*t,u=(n[2]||0)*s+(i[2]||0)*e+(a[2]||0)*t;r.push(c,l,u),o.push(c+.5,.5+l/.45)};for(let e=0;e<7;e++)for(let t=0;t<7-e;t++)s(e/7,t/7),s((e+1)/7,t/7),s(e/7,(t+1)/7),e+t<6&&(s((e+1)/7,t/7),s((e+1)/7,(t+1)/7),s(e/7,(t+1)/7))}let s=new Vr;s.setAttribute(`position`,new kr(r,3)),s.setAttribute(`uv`,new kr(o,2)),s.computeVertexNormals(),this.add(s,t===`pectoral`?a:i,t,n)};p([[-.3,-.035],[-.495,.12],[-.43,.015],[-.395,-.035],[-.43,-.09],[-.495,-.185]],`tail`),p([[-.1,.056],[-.065,.22],[.1,.07]],`dorsal`),p([[-.23,-.079],[-.12,-.21],[.005,-.141],[.12,-.13]],`anal`);for(let e of[-1,1])p([[.25,-.055,e*.049],[.05,-.17,e*.1],[.18,-.1,e*.022]],`pectoral`,e);let m=new ha({color:6527370,roughness:.25,metalness:.3}),h=new ha({color:132613,roughness:.16,clearcoat:1});for(let e of[-1,1]){let t=new ui(new ra(.027,16,12),m);t.scale.set(1,1,.45),t.position.set(.426,-.022,e*.034),this.group.add(t),this.eyes.push(t);let n=new ui(new ra(.018,16,12),h);n.scale.set(1,1,.3),n.position.set(.426,-.022,e*.047),this.group.add(n),this.eyes.push(n)}this.group.traverse(t=>{if(t instanceof ui){t.renderOrder=3;let n=t.material;n.onBeforeCompile=t=>{t.uniforms.photograph={value:e},t.uniforms.flow={value:.65},t.uniforms.sceneTime={value:0},t.uniforms.depth={value:.55},t.uniforms.daylight={value:1},t.vertexShader=`varying vec2 sceneUv;
...
#include <dithering_fragment>`),this.shaders.push(t)},n.customProgramCacheKey=()=>`tetra-depth-v1`}})}add(e,t,n=`body`,r=1){let i=new ui(e,t);this.meshes.push(i),this.fins.set(i,{kind:n,side:r}),this.originals.set(e,new Float32Array(e.getAttribute(`position`).array)),this.group.add(i)}update(e,t,n,r,i,a,o,s=.35){this.phase=Fl(this.phase,o,t),this.pectoralPhase+=o*(5+s*13);for(let e of this.meshes){let n=e.geometry.getAttribute(`position`),r=this.originals.get(e.geometry);for(let i=0;i<n.count;i++){let a=r[i*3],o=r[i*3+1],c=r[i*3+2],l=this.fins.get(e),u=Rl(a,o,c,this.phase,t,l.kind,l.side,this.pectoralPhase,s);n.setXYZ(i,...u)}n.needsUpdate=!0,e.geometry.computeVertexNormals()}for(let t of this.shaders)t.uniforms.photograph.value=n,t.uniforms.sceneTime.value=e,t.uniforms.flow.value=r,t.uniforms.depth.value=i,t.uniforms.daylight.value=a}dispose(){let e=new Set;this.group.traverse(t=>{t instanceof ui&&(t.geometry.dispose(),e.add(t.material))}),e.forEach(e=>e.dispose())}},Hl=e=>Math.max(0,Math.min(1,e));function Ul(){return{hunger:.6,energy:.85,curiosity:.65,decisionIn:0,biteIn:0,seed:723,intent:{kind:`explore`,reason:`Exploring the planting.`},consumedFood:null,visited:[]}}var Wl=e=>(e.seed=Math.imul(e.seed,1664525)+1013904223>>>0,e.seed/4294967296);function Gl(e,t,n){e.visited.push({x:t,y:n,age:0}),e.visited.length>6&&e.visited.shift(),e.curiosity*=.35}function Kl(e,t,n,r,i,a,o=.65){let s=e=>Math.hypot(e.x-n,e.y-r,((e.z??o)-o)*180);if(t<=0)return e.intent;e.hunger=Hl(e.hunger+t*.0015),e.energy=Hl(e.energy+t*(i<2?.018:-.0015-i*18e-5)),e.curiosity=Hl(e.curiosity+t*.006),e.visited.forEach(e=>e.age+=t),e.visited=e.visited.filter(e=>e.age<100),e.biteIn=Math.max(0,e.biteIn-t),e.decisionIn-=t;let c=a.food.filter(e=>s(e)<330).sort((e,t)=>s(e)-s(t))[0];c&&e.hunger>.18&&s(c)<22&&e.biteIn===0&&(e.consumedFood=c.id,e.hunger=Hl(e.hunger-.23),e.energy=Hl(e.energy+.08),e.biteIn=1.2,e.decisionIn=0);let l=a.neighbors.filter(e=>s(e)<26).sort((e,t)=>s(e)-s(t))[0];if(e.decisionIn>0&&!l&&!(c&&e.hunger>.35&&e.intent.kind!==`feed`)&&(e.intent.kind!==`feed`||c))return e.intent.kind===`feed`&&c&&(e.intent.target=c),e.intent;if(e.decisionIn=.7+Wl(e)*.8,l)e.intent={kind:`space`,reason:`Giving a nearby fish more room.`,target:{id:-1,x:n+(n>=l.x?65:-65),y:r+(r>=l.y?22:-22),z:Hl(o+(o>=(l.z??o)?.09:-.09))}};else if(c&&e.hunger>.18)e.intent={kind:`feed`,reason:`Food detected — approaching a flake.`,target:c};else if(e.energy<.28||e.intent.kind===`rest`&&e.energy<.62)e.intent={kind:`rest`,reason:`Resting and fanning its fins to hold position.`};else{let t=a.neighbors.filter(e=>s(e)<260&&s(e)>45);if((t.length>=2||a.schoolGoal)&&Wl(e)<(a.schoolGoal?.88:.48)){let i=Math.max(1,t.length),s=a.schoolGoal,c=t.length?t.reduce((e,t)=>e+t.x,0)/i:n,l=t.length?t.reduce((e,t)=>e+t.y,0)/i:r,u=t.length?t.reduce((e,t)=>e+(t.z??o),0)/i:o,d=t.reduce((e,t)=>e+(t.vx??0),0)/i;e.intent={kind:`school`,reason:`Swimming with the tetra school.`,target:{id:-2,x:s?s.x:c+d*5,y:s?s.y:l,z:s?s.z??u:u,vx:s?.vx??d}},e.decisionIn=1.8+Wl(e)*2}else e.intent={kind:`explore`,reason:e.curiosity>.6?`Looking for an unfamiliar leaf to inspect.`:`Exploring between the plants.`},e.decisionIn=4+Wl(e)*4}return e.intent}var ql=.24,Jl=(e,t,n)=>Math.max(t,Math.min(n,e)),Yl=(e,t,n,r)=>e+(t-e)*(1-Math.exp(-r*n));function Xl(e){return e.seed=Math.imul(e.seed,1664525)+1013904223>>>0,e.seed/4294967296}function Zl(e=237){return{x:1110,y:330,vx:16,vy:0,yaw:0,pitch:0,speed:16,direction:1,sinceTurn:10,elapsed:0,behavior:`cruising`,remaining:2.6,targetX:1190,targetY:345,cruiseSpeed:16,effort:.7,pectoralEffort:.35,seed:e,wasFeeding:!1,turnRate:.8,depthTarget:445,depthRemaining:20,depthBand:2,z:.62,vz:0,targetZ:.18,depthHeading:0,depthTimer:0,brain:Ul()}}function Ql(e,t){e.behavior=t;let n=Xl(e);if(t===`cruising`&&(e.remaining=3+n*5,e.cruiseSpeed=11+Xl(e)*10,e.targetY=e.depthTarget),t===`burst`&&(e.remaining=.7+n*1.1,e.cruiseSpeed=24+Xl(e)*7),t===`gliding`&&(e.remaining=1.8+n*2.6),t===`inspecting`&&(e.remaining=2.2+n*3.5,Gl(e.brain,e.targetX,e.targetY)),t===`approaching`){let t=[[1170,380],[1090,397],[975,382],[890,327],[760,355],[690,340],[1180,480],[1060,465],[950,490],[810,465],[820,287],[990,275],[1150,290]],r=t.filter(([t,n])=>(t-e.x)*e.direction>25&&(t-e.x)*e.direction<250&&Math.abs(n-e.y)<85),i=r.length?r:t.filter(([,t])=>Math.abs(t-e.y)<85),a=i.filter(([t,n])=>!e.brain.visited.some(e=>Math.hypot(e.x-t,e.y-n)<55)),o=a.length?a:i,s=o[Math.floor(n*o.length)]||t[2];e.targetX=s[0],e.targetY=s[1]-12,e.remaining=20,e.sinceTurn>6&&Math.sign(e.targetX-e.x)!==e.direction&&(e.direction=e.direction===1?-1:1,e.sinceTurn=0,e.turnRate=.65+Xl(e)*.2)}t===`foraging`&&(e.remaining=2+n*2,e.targetX=990+Xl(e)*65,e.targetY=257+Xl(e)*10)}function $l(e,t,n=!1,r=!1,i){let a=Jl(Number.isFinite(t)?t:0,0,.1);if(!a)return;let o=i?Kl(e.brain,a,e.x,e.y,e.speed,i,e.z):null;if(o&&(n=o.kind===`feed`),e.elapsed+=a,e.sinceTurn+=a,e.remaining-=a,!n&&(e.depthRemaining-=a,e.depthRemaining<=0&&Math.abs(e.depthTarget-e.y)<24)){e.depthBand=(e.depthBand+1+ +(Xl(e)<.25))%3;let t=[[267,305],[345,390],[440,485]][e.depthBand];e.depthTarget=t[0]+Xl(e)*(t[1]-t[0]),e.depthRemaining=18+Xl(e)*18}if(n&&!e.wasFeeding&&Ql(e,`foraging`),!n&&e.wasFeeding&&Ql(e,`gliding`),e.wasFeeding=n,e.remaining<=0){if(n)Ql(e,`foraging`);else if(e.behavior===`burst`)Ql(e,`gliding`);else if(e.behavior===`approaching`)Ql(e,`inspecting`);else if(e.behavior===`inspecting`)Ql(e,Xl(e)<.6?`burst`:`cruising`);else{let t=Xl(e);Ql(e,t<.36&&Math.abs(e.depthTarget-e.y)<30?`approaching`:t<.7?`burst`:`cruising`)}}e.sinceTurn>6&&(e.direction===1&&e.x>1210||e.direction===-1&&e.x<660)&&(e.direction=e.direction===1?-1:1,e.sinceTurn=0,e.turnRate=.65+Xl(e)*.2,n||Ql(e,`cruising`)),n&&e.sinceTurn>6&&(e.targetX-e.x)*e.direction<-22&&(e.direction=e.direction===1?-1:1,e.sinceTurn=0),o?.target&&(e.targetX=Jl(o.target.x,650,1220),e.targetY=Jl(o.target.y,240,500),(o.kind===`school`||o.kind===`space`)&&(e.behavior=`cruising`,e.cruiseSpeed=o.kind===`space`?9:15,e.remaining=Math.max(1,e.remaining)),e.sinceTurn>6&&(e.targetX-e.x)*e.direction<-35&&(e.direction=e.direction===1?-1:1,e.sinceTurn=0));let s=e.direction===1?0:Math.PI,c=Math.abs(s-e.yaw)>.18,l=e.behavior===`inspecting`,u=l?(1+Math.sin(e.elapsed*1.1))*.045:0,d=s+(e.direction===1?u:-u);e.yaw+=Jl(d-e.yaw,-a*e.turnRate,a*e.turnRate);let f=e.cruiseSpeed,p=e.cruiseSpeed/28,m=.35;if(e.behavior===`burst`&&(p=1+(e.cruiseSpeed-24)/20,m=.25),e.behavior===`gliding`&&(f=0,p=.025,m=.18),l&&(f=0,p=.02,m=.8+Math.sin(e.elapsed*1.7)*.12),(e.behavior===`approaching`||e.behavior===`foraging`)&&(f=Jl(((e.targetX-e.x)*e.direction-5)*.55,0,e.behavior===`foraging`?23:15),Math.abs(e.targetY-e.y)>20&&(f=Math.max(f,7)),p=f/24,m=f<3?.8:.4,e.behavior===`approaching`&&Math.abs(e.targetX-e.x)<19&&Math.abs(e.targetY-e.y)<17&&(Ql(e,`inspecting`),f=0,p=.02,m=.9)),o?.kind===`school`&&(f=Jl(Math.abs(o.target?.vx??12)*.8+Math.abs(e.targetX-e.x)*.025,13,23),p=f/28),o?.kind===`rest`&&(f=0,p=.015,m=.85,e.behavior=`gliding`,e.remaining=2),c&&(f=Math.min(f,8),p=.3,m=.7),r&&(f=Math.min(f,11),p=Math.min(p,.55)),i)for(let t of i.neighbors){let n=t.x-e.x,r=t.y-e.y,i=((t.z??e.z)-e.z)*180,a=Math.hypot(n,r,i),o=n*e.direction>0,s=(e.vx-(t.vx??0))*n+(e.vy-(t.vy??0))*r;o&&s>0&&a<90&&Math.abs(r)<38&&Math.abs(i)<45&&(f=Math.min(f,Math.max(8,(a-55)*.35)),m=Math.max(m,.85),p=Math.min(p,.18))}e.speed=Yl(e.speed,f,e.behavior===`gliding`?.65:1.65,a),e.effort=Yl(e.effort,p,3,a),e.pectoralEffort=Yl(e.pectoralEffort,m,3,a);let h=e.behavior===`inspecting`||o?.kind===`rest`,g=o?.target||e.behavior===`approaching`||e.behavior===`foraging`?e.targetY:e.depthTarget,_=Math.min(5,Math.max(1,e.speed)*Math.tan(ql)),v=c||h?0:Jl((g-e.y)*.16,-_,_);e.vy=Yl(e.vy,v,2,a),e.vx=e.speed*Math.cos(e.yaw),e.x+=e.vx*a,e.y+=e.vy*a;let y=c?0:h?Math.sin(e.elapsed*.9)*.025:Jl(Math.atan2(-e.vy,Math.max(1,e.speed)),-.24,ql);e.depthTimer-=a,Math.abs(e.z-e.targetZ)<.045&&e.depthTimer<=0&&(e.targetZ=e.targetZ<.5?.72+Xl(e)*.2:.08+Xl(e)*.22,e.depthTimer=8+Xl(e)*10);let b=o?.target?.z??(n?.65:e.targetZ),x=h||c?0:Jl((b-e.z)*.15,-e.speed*.65/180,e.speed*.65/180);e.vz=Yl(e.vz,x,1.6,a),e.z=Jl(e.z+e.vz*a,.06,.94);let S=c?0:Math.atan2(-e.vz*180,Math.max(2,e.speed))*e.direction;e.depthHeading+=Jl(S-e.depthHeading,-.25*a,.25*a),e.pitch+=Jl((y-e.pitch)*(1-Math.exp(-a*2)),-.25*a,.25*a)}function eu(e){return e.brain.intent.kind===`rest`?`Resting`:e.brain.intent.kind===`school`?`Following the school`:e.brain.intent.kind===`space`?`Making space`:{cruising:`Exploring`,burst:`Short swimming burst`,gliding:`Gliding`,approaching:`Approaching a leaf`,inspecting:`Inspecting the planting`,foraging:`Looking for food`}[e.behavior]}var tu=`
...
`,nu=()=>({light:65,co2:24,flow:65,agitation:35,temperature:24,photoperiod:8,feed:1,fertilizer:1,kh:4}),ru=()=>({hours:0,co2:24,oxygen:8.1,temperature:24,ammonia:.015,nitrite:.01,nitrate:4.5,waste:.3,algae:.04,biomass:1,bacteria:.95,ph:6.7}),iu=[`Balanced mature aquarium`,`Newly cycled aquarium`,`CO₂ turned off`,`Excessive light`,`Overfeeding event`,`Clogged filter`,`Missed water changes`,`Post-trim recovery`,`Algae bloom and correction`,`Day to night`];function au(e){let t=ru(),n=nu(),r=`A mature biological filter, moderate light and distributed carbon support steady growth. Try 1 day per second to observe several light cycles.`;switch(e){case iu[1]:t.bacteria=.35,t.ammonia=.15,t.nitrite=.1,r=`Recently cycled filters have less reserve capacity. Watch bacterial capacity develop over days; additional food can still overwhelm it.`;break;case iu[2]:n.co2=0,r=`Dissolved carbon declines over hours. Plant growth slows; under the same light, algae pressure builds over days. Restore carbon and allow recovery time.`;break;case iu[3]:n.light=100,n.photoperiod=14,r=`Long, intense light increases demand for carbon and nutrients. Algae pressure accumulates if demand outpaces supply. Shorten the photoperiod to recover.`;break;case iu[4]:t.waste=5,r=`Uneaten food becomes organic waste. Mineralization releases ammonia; nitrification consumes oxygen and produces nitrite, then nitrate.`;break;case iu[5]:n.flow=8,r=`Restricted circulation reduces delivery to the filter and plants. Organic waste accumulates. Restore flow and watch gases recover before slower biology.`;break;case iu[6]:t.nitrate=18,t.waste=3,r=`Accumulated nitrogen and organic material reflect missed maintenance. A water change dilutes dissolved waste; it does not instantly erase algae.`;break;case iu[7]:t.biomass=.55,r=`Trimming reduces photosynthetic area immediately. Biomass and roots recover gradually as light reaches lower growth points.`;break;case iu[8]:t.algae=.7,n.light=45,n.photoperiod=6,r=`The bloom begins with corrected conditions. Established algae declines gradually; remove some manually, restore carbon and keep maintenance consistent.`;break;case iu[9]:t.hours=5.8,r=`The photoperiod ends at 18:00. Photosynthesis stops, while plants, fish and microbes keep respiring. Surface gas exchange becomes especially important.`}return{state:t,environment:n,explanation:r}}var ou=(e,t,n)=>Math.max(t,Math.min(n,e));function su(e,t){let n=(12+e.hours)%24,r=14-t.photoperiod/2,i=14+t.photoperiod/2;return ou(Math.min((n-r)*2,(i-n)*2),0,1)*t.light/65}function cu(e,t,n){let r=Math.max(0,n);for(;r>1e-9;){let n=Math.min(r,1/60);r-=n;let i=su(e,t),a=t.flow/100,o=.1+t.agitation/65+a*.25,s=e.co2/(e.co2+8),c=e.nitrate/(e.nitrate+1),l=.25+.75*a,u=i*s*c*l*e.biomass,d=.18+.1*e.biomass+.035*e.waste;e.co2+=((i>0?t.co2:0)*.13+d*1.35-(e.co2-.6)*o*.12-u*.48)*n;let f=Math.min(e.waste/n,e.waste*.075);e.waste+=(t.feed*.032-f)*n;let p=Math.min(e.ammonia/n,e.ammonia*(.2+a)*e.bacteria*ou(e.oxygen/5,0,1)),m=Math.min(e.nitrite/n,e.nitrite*(.18+a)*e.bacteria*ou(e.oxygen/5,0,1));e.ammonia+=(f*.18-p)*n,e.nitrite+=(p-m)*n,e.nitrate=Math.max(0,e.nitrate+(m+t.fertilizer*.014-u*.025)*n);let h=8.4-(e.temperature-24)*.16;e.oxygen=ou(e.oxygen+((h-e.oxygen)*o*.42+u*.9-d-p*3.43-m*1.14)*n,.2,14),e.co2=ou(e.co2,.1,100),e.temperature+=(t.temperature-e.temperature)*Math.min(1,n/3);let g=Math.max(0,i-s*c*l*1.8)+.08*e.waste;e.algae=ou(e.algae+(g*.011-e.algae*.006)*n,0,1),e.biomass=ou(e.biomass+(u*.0028-e.biomass*4e-4-e.algae*3e-4)*n,.15,2),e.bacteria=ou(e.bacteria+(.0025*(1-e.bacteria)-Math.max(0,3-e.oxygen)*.001*e.bacteria)*n,.05,1),e.ph=7-Math.log10(e.co2/(3*t.kh)),e.hours+=n}return e}function lu(e,t=.3){for(let n of[`ammonia`,`nitrite`,`nitrate`,`waste`])e[n]*=1-t}function uu(e,t){return{oxygen:ou((e.oxygen-2)/5,0,1),nitrogen:ou(1-(e.ammonia+e.nitrite)*2,0,1),circulation:t.flow/100,algae:1-e.algae}}function du(e,t){let n=uu(e,t);return Math.round(100*(n.oxygen*.35+n.nitrogen*.35+n.circulation*.15+n.algae*.15))}var fu=1672,pu=941,mu=`varying vec2 vUv; void main(){vUv=uv;gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0);}`,hu=`precision highp float;
...
#include <colorspace_fragment>
}`}),s=new ui(new ta(n,n*a,24,6),o);o.side=2,s.renderOrder=3;let c=t===3?640+this.random()*560:610+this.random()*610,l=t===3?580+this.random()*30:t===2?420:280+this.random()*235,u={mesh:s,x:c,y:l,vx:(this.random()>.5?1:-1)*18,vy:0,targetX:c,targetY:l,size:n,phase:this.random()*30,depth:t===3?1:.18+this.random()*.65,species:t,turn:0};if(this.fish.push(u),this.scene.add(s),t===0){let t=new Vl(r,e*.83,e===0),n=Zl(237+e*7919);u.size=e===0?48:36+this.random()*8,u.x=860+e%4*65,u.y=315+Math.floor(e/4)*38,u.depth=.3+e%3*.17,Object.assign(n,{x:u.x,y:u.y,z:u.depth,elapsed:e*.7,remaining:2+e*.23}),n.brain.seed=723+e*3571,n.brain.energy=.72+this.random()*.22,n.brain.hunger=.4+this.random()*.25,this.tetras.set(e,{model:t,swim:n}),this.scene.add(t.group)}}}}buildFlow(){for(let e=0;e<9;e++){let t=e*6,n=new ea([this.pos(1265,228+t),this.pos(1080,268+t),this.pos(770,282+t),this.pos(385,350+t),this.pos(520,553+t),this.pos(1060,565+t),this.pos(1260,463+t),this.pos(1265,228+t)]),r=new ki(new Vr().setFromPoints(n.getPoints(100)),new Si({color:e%2?13026977:10997974,transparent:!0,opacity:.28,depthTest:!1}));r.renderOrder=6,this.flow.add(r);for(let t=0;t<5;t++){let r=new ui(new Ki(1.6,6,3),new Qr({color:e%2?14865575:12905969,transparent:!0,opacity:.7,depthTest:!1}));r.renderOrder=7,this.flow.add(r),this.arrows.push({mesh:r,path:n,phase:t/5+e*.03})}}}buildRoots(){let e=new ui(new ta(600,100),new Qr({color:1448204,transparent:!0,opacity:.74,depthTest:!1}));e.position.copy(this.pos(955,623,3)),e.renderOrder=5,this.roots.add(e);for(let e=0;e<30;e++){let e=680+this.random()*540,t=578+this.random()*12,n=[this.pos(e,t,5)],r=e,i=t;for(let e=0;e<12;e++)if(r+=(this.random()-.5)*13,i+=5+this.random()*3,n.push(this.pos(r,i,5)),e%3==1){let e=[this.pos(r,i,5),this.pos(r+(this.random()-.5)*35,i+17,5)],t=new ki(new Vr().setFromPoints(e),new Si({color:11246443,transparent:!0,opacity:.58,depthTest:!1}));t.renderOrder=8,this.roots.add(t)}let a=new ki(new Vr().setFromPoints(n),new Si({color:14535073,transparent:!0,opacity:.82,depthTest:!1}));a.renderOrder=8,this.roots.add(a)}}setMode(e){this.mode=e,this.flow.visible=e===`Flow`,this.roots.visible=e===`Roots`,this.selected=null,this.onSelectedFish?.(null),this.cameraPreset(e===`Equipment`?`Equipment`:e===`Roots`?`Root zone`:e===`Biology`?`Leaf macro`:`Gallery`)}cameraPreset(e){let t={Gallery:[0,0,1],Aquascape:[-15,30,1.35],"Open water":[235,100,1.8],"Root zone":[115,-125,1.75],Equipment:[590,25,2],"Leaf macro":[0,0,1]},n=t[e]||t.Gallery;[this.targetX,this.targetY,this.zoomTarget]=n,this.clampCamera()}focusPrototype(){this.setMode(`Living`),this.selected=0;let e=this.fish[0];e&&(this.targetX=e.x-fu/2,this.targetY=pu/2-e.y,this.zoomTarget=2.4,this.clampCamera(),this.report(e,0))}zoom(e){this.zoomTarget=Vt.clamp(e,1,2.4),this.clampCamera()}nudge(e,t){this.targetX+=e,this.targetY+=t,this.clampCamera()}clampCamera(){let e=this.host.clientWidth/Math.max(1,this.host.clientHeight),t=e>fu/pu?fu/e:pu,n=t*e/this.zoomTarget/2,r=t/this.zoomTarget/2;this.targetX=Vt.clamp(this.targetX,-Math.max(0,fu/2-n),Math.max(0,fu/2-n)),this.targetY=Vt.clamp(this.targetY,-Math.max(0,pu/2-r),Math.max(0,pu/2-r))}setQuality(e){this.quality=e,this.resize()}selectFish(e){this.selected=e,e===null&&this.onSelectedFish?.(null)}feedAt(){this.feeding=30;for(let e=0;e<16;e++){let e=new ui(new Wi(1.1,5),new Qr({color:10190402,transparent:!0,opacity:.85}));e.position.copy(this.pos(1e3+(this.random()-.5)*180,220+this.random()*25,3)),this.food.add(e)}}update(e,t,n,r,i){e=Number.isFinite(e)?Math.max(0,Math.min(e,.1)):0;let a=r||i?0:e;this.time+=a,this.flowPhase+=a*.015*n.flow/65,this.feeding=Math.max(0,this.feeding-a),this.selected===0&&this.fish[0]&&(this.targetX=this.fish[0].x-fu/2,this.targetY=pu/2-this.fish[0].y,this.clampCamera());let o=r?1:Math.min(1,e*3.2);this.zoomCurrent+=(this.zoomTarget-this.zoomCurrent)*o,this.centerX+=(this.targetX-this.centerX)*o,this.centerY+=(this.targetY-this.centerY)*o,this.camera.zoom=this.zoomCurrent,this.camera.position.set(this.centerX,this.centerY,250),this.camera.updateProjectionMatrix(),this.macroBlend+=(+(this.mode===`Biology`)-this.macroBlend)*o;let s=this.background.material.uniforms;s.time.value=this.time,s.flow.value+=(n.flow/100-s.flow.value)*(1-Math.exp(-e*4)),s.agitation.value+=(n.agitation/100-s.agitation.value)*(1-Math.exp(-e*4)),s.day.value=Math.min(1,su(t,n)),s.algae.value=t.algae,s.biomass.value=t.biomass,s.macroBlend.value=this.macroBlend,this.dust.visible=this.mode!==`Biology`,this.bubbles.visible=this.mode!==`Biology`,this.food.visible=this.mode!==`Biology`;let c=this.dust.geometry.getAttribute(`position`);if(a){for(let e=0;e<c.count;e++){let t=c.getX(e),r=c.getY(e);t+=a*(r>50?-1:1)*(2+n.flow*.08),r+=Math.sin(this.time*.4+e)*a*.65,t<320-fu/2&&(t=1280-fu/2),t>1280-fu/2&&(t=320-fu/2),c.setXY(e,t,r)}c.needsUpdate=!0}this.roots.scale.y=.7+t.biomass*.3,this.roots.position.y=(pu/2-578)*(1-this.roots.scale.y);let l=this.fish.map((e,t)=>({id:t,x:e.x,y:e.y,z:e.depth,vx:e.vx,vy:e.vy,radius:e.size*.68})).filter(e=>this.tetras.has(e.id)),u=p(this.schoolRoute,a,l);for(let[e,n]of this.tetras){let r=this.fish[e];if(n){let i=n.swim;$l(i,a,this.feeding>0,t.oxygen<4,{food:this.food.children.map(e=>({id:e.id,z:.65,x:e.position.x+fu/2,y:pu/2-e.position.y})),neighbors:l.filter(t=>t.id!==e),schoolGoal:m(u,e)});let o=this.food.children.find(e=>e.id===i.brain.consumedFood);o instanceof ui&&(this.food.remove(o),o.geometry.dispose(),o.material.dispose()),i.brain.consumedFood=null,r.x=i.x,r.y=i.y,r.vx=i.vx,r.vy=i.vy,r.turn=i.yaw,r.depth=i.z}}if(a){let e=[...this.tetras].map(([e])=>{let t=this.fish[e];return{id:e,x:t.x,y:t.y,z:t.depth,radius:t.size*.68}});h(e);for(let t of e){let e=this.fish[t.id],n=this.tetras.get(t.id).swim;e.x=n.x=t.x,e.y=n.y=t.y,e.depth=n.z=t.z}}for(let e=0;e<this.fish.length;e++){let n=this.fish[e],r=n.species===3,i=this.tetras.get(e);if(n.mesh.visible=this.mode!==`Biology`&&!i,a>0&&!i){let i=r?[430,1280,563,619]:[350,1290,240,565];(Math.hypot(n.targetX-n.x,n.targetY-n.y)<45||Math.sin(this.time*.22+n.phase)>.997)&&(n.targetX=i[0]+this.random()*(i[1]-i[0]),n.targetY=i[2]+this.random()*(i[3]-i[2])),this.feeding&&!r&&(n.targetX=1e3+Math.sin(n.phase)*80,n.targetY=246+Math.sin(n.phase*2)*20);let o=!this.feeding&&Math.sin(this.time*.33+n.phase)>.88,s=(n.targetX-n.x)*.028,c=(n.targetY-n.y)*.028;o&&(n.vx*=Math.exp(-a*1.8),n.vy*=Math.exp(-a*1.8),s*=.12,c*=.12);for(let e of this.fish){if(n===e)continue;let t=e.x-n.x,i=e.y-n.y,a=Math.hypot(t,i);a<28&&a>0?(s-=t*.12,c-=i*.12):a<140&&n.species===e.species&&!r&&(s+=t*8e-4+(e.vx-n.vx)*.016,c+=i*7e-4+(e.vy-n.vy)*.016)}let l=r?1.1:n.species===2?this.feeding?17:9:(t.oxygen<4?9:18)*(this.feeding?1.5:1);n.vx+=s*a,n.vy+=c*a;let u=Math.hypot(n.vx,n.vy);u>l&&(n.vx*=l/u,n.vy*=l/u);let d=e===0?Math.max(0,Math.cos(n.turn)*(n.vx>=0?1:-1)):1;n.x=Vt.clamp(n.x+n.vx*a*d,i[0],i[1]),n.y=Vt.clamp(n.y+n.vy*a*(e===0?.25+.75*d:1),i[2],i[3])}if(!i){let e=n.vx>=0?0:Math.PI;n.turn+=(e-n.turn)*(1-Math.exp(-a*2.4))}n.mesh.position.copy(this.pos(n.x,n.y+Math.sin(this.time*1.1+n.phase)*.6,1+n.depth*180)),n.mesh.rotation.y=n.turn,n.mesh.scale.setScalar(.82+n.depth*.18),n.mesh.rotation.z=Vt.clamp(-n.vy*.008,-.15,.15)*(n.vx>0?1:-1);let o=n.mesh.material.uniforms;if(o.time.value=this.time+n.phase,o.sceneTime.value=this.time,o.flow.value=s.flow.value,o.photograph.value=this.photograph,o.depth.value=n.depth,o.light.value=s.day.value,o.activity.value=r?.08:Math.max(.22,Math.hypot(n.vx,n.vy)/18),i){let{model:e,swim:t}=i;e.group.visible=this.mode!==`Biology`,e.group.position.copy(this.pos(n.x,n.y,1+n.depth*180)),e.group.rotation.set(0,t.yaw+t.depthHeading,t.pitch,`YXZ`),e.group.scale.setScalar(n.size*(.72+n.depth*.48)),e.update(this.time,t.effort,this.photograph,s.flow.value,n.depth,s.day.value,a,t.pectoralEffort)}}for(let e=0;e<this.bubbleData.length;e++){let r=this.bubbleData[e];r.mesh.visible=e<(this.quality===`Performance`?24:62)&&(r.co2?n.co2>0&&s.day.value>.1:t.oxygen>8.35),a&&(r.y-=r.speed*a*(r.co2?Math.max(.2,n.co2/24):Math.max(.2,t.oxygen/8)),r.y<200&&(r.y=r.originY,r.x=r.originX));let i=(r.originY-r.y)/Math.max(1,r.originY-200),o=r.co2?Math.max(.12,.75*(1-i)):1+i*.1;r.mesh.scale.setScalar(o),r.mesh.position.copy(this.pos(r.x+Math.sin(this.time*.6+r.phase)*2+i*n.flow*.13,r.y,4))}for(let e of this.arrows){let t=Vt.euclideanModulo(this.flowPhase+e.phase,1);e.mesh.position.copy(e.path.getPointAt(t)),e.mesh.quaternion.setFromUnitVectors(new W(0,1,0),e.path.getTangentAt(t))}if(this.food.children.forEach(e=>{e.position.y-=a*4}),this.food.children.length)for(let e of this.food.children.filter(e=>pu/2-e.position.y>560))e.geometry.dispose(),e.material.dispose(),this.food.remove(e);if(this.selected!==null&&this.time-this.lastReport>.5){this.lastReport=this.time;let e=this.fish[this.selected];e&&this.report(e,this.selected)}for(let e of this.markers){let t=this.pos(e.x,e.y,0).project(this.camera);e.button.style.left=(t.x+1)*.5*this.host.clientWidth+`px`,e.button.style.top=(1-t.y)*.5*this.host.clientHeight+`px`,e.button.hidden=this.mode!==`Living`||Math.abs(t.x)>.92||Math.abs(t.y)>.84}this.renderer.render(this.scene,this.camera)}report(e,t){let n=this.tetras.get(t)?.swim;this.onSelectedFish?.({id:t,species:[`Cardinal tetra · 3D school`,`Harlequin rasbora`,`Pearl gourami`,`Amano shrimp`][e.species],size:e.size,speed:Math.hypot(e.vx,e.vy),hunger:n?n.brain.hunger:0,energy:n?n.brain.energy:void 0,reason:n?n.brain.intent.reason:void 0,mood:n?eu(n):this.feeding?`Foraging`:e.species===3?`Grazing`:`Exploring`,preferredDepth:n?(e.y<310?`Upper water`:e.y>420?`Lower planting`:`Midwater`)+` / `+(e.depth>.68?`Near front glass`:e.depth<.32?`Back planting`:`Tank interior`):e.species===3?`Planted foreground`:`Midwater`})}world(e,t){let n=this.canvas.getBoundingClientRect(),r=new W((e-n.left)/n.width*2-1,-(t-n.top)/n.height*2+1,0);return r.unproject(this.camera),{x:r.x+fu/2,y:pu/2-r.y}}down=e=>{if(this.canvas.setPointerCapture(e.pointerId),this.pointers.set(e.pointerId,{x:e.clientX,y:e.clientY}),this.pointer={startX:e.clientX,startY:e.clientY,cx:this.targetX,cy:this.targetY,distance:0},this.pointers.size===2){let e=[...this.pointers.values()];this.pinch=Math.hypot(e[0].x-e[1].x,e[0].y-e[1].y),this.pinchZoom=this.zoomTarget}};move=e=>{if(!this.pointers.has(e.pointerId))return;if(this.pointers.set(e.pointerId,{x:e.clientX,y:e.clientY}),this.pointers.size===2){let e=[...this.pointers.values()];this.zoom(this.pinchZoom*Math.hypot(e[0].x-e[1].x,e[0].y-e[1].y)/Math.max(1,this.pinch)),this.pointer&&(this.pointer.distance=100);return}if(!this.pointer)return;let t=e.clientX-this.pointer.startX,n=e.clientY-this.pointer.startY;this.pointer.distance=Math.hypot(t,n);let r=(this.camera.right-this.camera.left)/(this.host.clientWidth*this.zoomCurrent);this.targetX=this.pointer.cx-t*r,this.targetY=this.pointer.cy+n*r,this.clampCamera()};up=e=>{if(this.pointer&&this.pointer.distance<8){let t=this.world(e.clientX,e.clientY),n=-1,r=1/0;this.fish.forEach((e,i)=>{let a=Math.hypot(t.x-e.x,t.y-e.y);a<Math.max(18,e.size*.5)&&a<r&&(n=i,r=a)}),n>=0&&(this.selected=n,this.report(this.fish[n],n))}this.cancel(e)};cancel=e=>{this.pointers.delete(e.pointerId),this.pointer=null,this.canvas.hasPointerCapture(e.pointerId)&&this.canvas.releasePointerCapture(e.pointerId)};wheel=e=>{e.preventDefault(),this.zoom(this.zoomTarget*Math.exp(-e.deltaY*.001))};resize=()=>{let e=Math.max(1,this.host.clientWidth),t=Math.max(1,this.host.clientHeight),n=e/t,r=n>fu/pu?fu/n:pu;this.camera.left=-r*n/2,this.camera.right=r*n/2,this.camera.top=r/2,this.camera.bottom=-r/2,this.camera.updateProjectionMatrix(),this.renderer.setPixelRatio(Math.min(devicePixelRatio,this.quality===`Performance`?1:this.quality===`High`?1.5:2)),this.renderer.setSize(e,t),this.clampCamera()};capture(){this.renderer.render(this.scene,this.camera);let e=document.createElement(`a`);e.download=`living-aquascape.png`,e.href=this.canvas.toDataURL(`image/png`),e.click()}dispose(){this.destroyed=!0,window.removeEventListener(`resize`,this.resize),this.canvas.removeEventListener(`pointerdown`,this.down),this.canvas.removeEventListener(`pointermove`,this.move),this.canvas.removeEventListener(`pointerup`,this.up),this.canvas.removeEventListener(`pointercancel`,this.cancel),this.canvas.removeEventListener(`wheel`,this.wheel);let e=new Set,t=new Set;this.scene.traverse(n=>{(n instanceof ui||n instanceof ki||n instanceof Ii)&&(e.add(n.geometry),(Array.isArray(n.material)?n.material:[n.material]).forEach(e=>t.add(e)))}),e.forEach(e=>e.dispose()),t.forEach(e=>e.dispose()),this.sprites.forEach(e=>e.dispose()),this.photograph.dispose(),this.macro.dispose(),this.renderer.dispose(),this.canvas.remove(),this.markers.forEach(e=>e.button.remove())}},_u=e((e=>{var t=Symbol.for(`react.transitional.element`);function n(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.jsx=n,e.jsxs=n})),$=e(((e,t)=>{t.exports=_u()}))(),vu=[`Living`,`Flow`,`Roots`,`Biology`,`Time-lapse`,`Equipment`],yu={Living:[`A small world. A living balance.`,`Plants, fish and microbes share the same water. Look closely; each quiet movement belongs to a larger system.`,`Drag to look around · Scroll to look closer · Click a fish`],Flow:[`The water connects everything.`,`The outlet carries dissolved gases and nutrients through the planting. Cyan paths show the upper current; gold paths return below. These are illustrative streamlines, not a fluid solver.`,`Change filter flow to compare circulation`],Roots:[`Life beneath the surface.`,`Roots take up nutrients and exchange gases with the substrate. Deeper layers generally contain less oxygen. This front-plane teaching cutaway shows representative roots, rather than scanned anatomy.`,`Increase time speed to see the root zone expand`],Biology:[`A world within the water.`,`A leaf becomes a landscape. Inspect a grazing shrimp, delicate veins and oxygen pearls in this photographic macro study.`,`Choose a process to trace its role`],"Time-lapse":[`Some changes take time.`,`Gases respond over hours. Waste and nutrients shift over days. Plant mass, roots and algae respond over weeks. Accelerate the ecosystem to reveal those differences.`,`Playback accelerates chemistry; fish stay at a comfortable viewing speed`],Equipment:[`Follow the water through.`,`Mechanical foam traps solids. Biological media supports nitrifiers. The impeller returns water to the aquarium; a separate regulator meters carbon dioxide.`,`Inspect the canister, media and carbon supply`]},bu={"Nitrogen cycle":[`Food → waste → ammonia → nitrite → nitrate → plants`,`Microbes mineralize organic material. Ammonia-oxidizing organisms and nitrite oxidizers then convert dissolved nitrogen in two oxygen-consuming steps. Plants assimilate nitrogen; water changes export it. Readings use mg nitrogen/L.`],Photosynthesis:[`Light + CO₂ + water → sugars + O₂`,`Photosynthesis stores light energy in organic carbon. Visible pearling depends on local gas saturation and nucleation; bubbles alone cannot measure plant health.`],Respiration:[`Sugars + O₂ → CO₂ + water`,`Fish, plants and microbes respire during both day and night. When the light goes out, photosynthetic oxygen production stops but respiration continues.`],"Root uptake":[`Water column ↔ substrate ↔ roots`,`Substrate retains nutrients and supports roots and biofilms. Aquatic plants can also absorb nutrients through submerged leaves, with gas exchange across their surfaces.`],"Gill exchange":[`Water → gill surfaces → blood`,`Oxygen diffuses across thin gill surfaces while carbon dioxide moves out. Gas exchange depends on concentration gradients and ventilation; low oxygen can change activity.`],"Algae diagnosis":[`Observe the system before changing it`,`This model shows generic algae pressure. Real green spot algae, diatoms, hair algae and cyanobacteria have different causes. Assess plant health, carbon delivery, organic waste and maintenance rather than diagnosing from nitrate alone.`]},xu={Intake:`Water enters through the intake strainer. Keep its openings clear so circulation can carry waste into the filter.`,"Mechanical foam":`Coarse and fine foam trap particles. Rinsing removes trapped solids; the foam also carries some biological growth.`,"Biological media":`Porous media provides wetted surfaces for biofilm. Nitrifying organisms consume oxygen while converting ammonia to nitrite and nitrate.`,"Impeller and outlet":`The impeller drives circulation. The lily pipe distributes returned water and shapes surface agitation.`,"CO₂ regulator":`The regulator reduces cylinder pressure; the metering valve and solenoid control delivery. The diffuser creates fine bubbles that dissolve into circulating water.`},Su=[[`light`,`Light intensity`,0,100,1,`%`],[`photoperiod`,`Photoperiod`,2,16,1,`h`],[`co2`,`CO₂ supply setting`,0,45,1,`mg/L eq.`],[`flow`,`Filter flow`,0,100,1,`%`],[`agitation`,`Surface agitation`,0,100,1,`%`],[`temperature`,`Heater target`,18,30,.5,`°C`],[`feed`,`Daily feeding`,0,4,.25,`×`],[`fertilizer`,`Nutrient dosing`,0,3,.25,`×`],[`kh`,`Carbonate hardness`,1,10,.5,`dKH`]];function Cu(){let e=(0,l.useRef)(null),t=(0,l.useRef)(null),n=(0,l.useRef)(ru()),r=(0,l.useRef)(nu()),i=(0,l.useRef)(1),a=(0,l.useRef)(!1),o=(0,l.useRef)(!1),s=(0,l.useRef)(null),c=(0,l.useRef)(null),u=(0,l.useRef)(20),[f,p]=(0,l.useState)(`Living`),[m,h]=(0,l.useState)(``),[g,_]=(0,l.useState)(!1),[v,y]=(0,l.useState)(!1),[b,x]=(0,l.useState)(ru()),[S,C]=(0,l.useState)(nu()),[w,T]=(0,l.useState)(iu[0]),[E,D]=(0,l.useState)(au(iu[0]).explanation),[O,ee]=(0,l.useState)(1),[k,A]=(0,l.useState)(!1),[j,te]=(0,l.useState)(!1),[ne,re]=(0,l.useState)(!1),[M,N]=(0,l.useState)(!1),[ie,ae]=(0,l.useState)(20),[oe,P]=(0,l.useState)(`High`),[se,F]=(0,l.useState)(`High`),[ce,le]=(0,l.useState)(0),[ue,de]=(0,l.useState)(null),[fe,pe]=(0,l.useState)(`Nitrogen cycle`),[me,he]=(0,l.useState)(`Biological media`),[ge,_e]=(0,l.useState)(``),[ve,ye]=(0,l.useState)(`Gallery`),[be,xe]=(0,l.useState)(!0),Se=e=>{if(e===`3D tetra`){Ce(`Living`),t.current?.focusPrototype(),ye(e);return}e===`Leaf macro`?Ce(`Biology`):(f===`Biology`&&Ce(`Living`),t.current?.selectFish(null),de(null),t.current?.cameraPreset(e),ye(e))},Ce=e=>{p(e),t.current?.setMode(e),de(null),ye(e===`Equipment`?`Equipment`:e===`Roots`?`Root zone`:e===`Biology`?`Leaf macro`:`Gallery`)},we=e=>{i.current=e,ee(e)},Te=(e,t)=>{r.current={...r.current,[e]:t},C({...r.current})},Ee=e=>{let t=au(e);n.current=t.state,r.current=t.environment,x({...t.state}),C({...t.environment}),T(e),D(t.explanation),we(e===iu[0]?1:3600)},De=e=>_e(e);(0,l.useEffect)(()=>{if(!ge)return;let e=setTimeout(()=>_e(``),4500);return()=>clearTimeout(e)},[ge]),(0,l.useEffect)(()=>{let l=matchMedia(`(prefers-reduced-motion: reduce)`).matches;o.current=l,te(l);let f=navigator.hardwareConcurrency<=4||innerWidth<700?`Performance`:`High`;F(f);let p=f;try{p=localStorage.getItem(`living-aquascape-quality`)||f}catch{}[`Performance`,`High`,`Ultra`,`Photography`].includes(p)||(p=f),P(p);let m=!0,g=null;try{e.current&&(g=new gu(e.current),t.current=g,g.setQuality(p),g.onSelectedFish=de,g.onInspect=e=>Ce(e===`equipment`?`Equipment`:e===`roots`?`Roots`:`Biology`),g.ready.then(()=>{m&&xe(!1)}).catch(()=>{m&&(xe(!1),h(`Some visual assets could not load. Reload to try again; the educational controls remain available.`))}))}catch{xe(!1),h(`This browser cannot start WebGL. The static gallery and ecosystem controls remain available.`)}p===`Photography`&&(a.current=!0,A(!0));let _=0,v=performance.now(),y=0,b=0,S=0,C=!1,w=e=>{let t=Math.max(0,(e-v)/1e3),l=d(e,v);v=e,a.current||cu(n.current,r.current,l*i.current/3600);let f=navigator.getGamepads?.()[0];if(f&&g){let e=Math.abs(f.axes[0]||0)>.15?f.axes[0]:0,t=Math.abs(f.axes[1]||0)>.15?f.axes[1]:0;g.nudge(e*l*200,-t*l*200),f.buttons[0]?.pressed&&!C&&(a.current=!a.current,A(a.current)),C=!!f.buttons[0]?.pressed}g?.update(l,n.current,r.current,o.current,a.current),c.current&&s.current&&c.current.gain.setTargetAtTime(r.current.flow/100*.035*(u.current/20),s.current.currentTime,.3),b++,S+=t,e-y>500&&(x({...n.current}),le(S/b*1e3),b=0,S=0,y=e),_=requestAnimationFrame(w)};_=requestAnimationFrame(w);let T=e=>{if(e.target.matches(`input,select,button,textarea`))return;e.key===`Escape`&&re(!1),e.key.toLowerCase()===`h`&&re(e=>!e),e.code===`Space`&&(e.preventDefault(),a.current=!a.current,A(a.current)),/^[1-6]$/.test(e.key)&&Ce(vu[Number(e.key)-1]);let t={ArrowLeft:[-35,0],ArrowRight:[35,0],ArrowUp:[0,35],ArrowDown:[0,-35]};t[e.key]&&(e.preventDefault(),g?.nudge(t[e.key][0],t[e.key][1])),(e.key===`+`||e.key===`=`)&&g?.zoom(g.camera.zoom*1.15),e.key===`-`&&g?.zoom(g.camera.zoom/1.15)};return window.addEventListener(`keydown`,T),()=>{m=!1,cancelAnimationFrame(_),window.removeEventListener(`keydown`,T),g?.dispose(),t.current=null,s.current?.close(),s.current=null}},[]),(0,l.useEffect)(()=>{let e=document.modelContext;if(!e?.registerTool)return;let t=new AbortController;try{Promise.resolve(e.registerTool({name:`load_aquascape_scenario`,description:`Reset the visible educational ecosystem to a named reproducible scenario.`,inputSchema:{type:`object`,properties:{scenario:{type:`string`,enum:[...iu]}},required:[`scenario`],additionalProperties:!1},annotations:{readOnlyHint:!1},execute:e=>{let t=e?.scenario;if(typeof t!=`string`||!iu.some(e=>e===t))throw Error(`Choose a listed aquarium scenario.`);return Ee(t),{scenario:t,state:{...n.current}}}},{signal:t.signal})).catch(()=>{})}catch{}return()=>t.abort()},[]);let Oe=e=>{P(e);try{localStorage.setItem(`living-aquascape-quality`,e)}catch{}t.current?.setQuality(e),e===`Photography`&&(a.current=!0,A(!0)),De(e===`Photography`?`Simulation paused. Frame your shot and save a PNG.`:e+` rendering selected.`)},ke=async()=>{try{if(M){await s.current?.suspend(),N(!1);return}if(!s.current){let e=new AudioContext;s.current=e;let t=e.createOscillator(),n=e.createGain(),r=e.createBiquadFilter();t.type=`sine`,t.frequency.value=60,n.gain.value=.012,r.type=`lowpass`,r.frequency.value=140;let i=e.createStereoPanner();i.pan.value=.5,t.connect(r).connect(n).connect(i).connect(e.destination),t.start();let a=e.createBuffer(1,e.sampleRate*2,e.sampleRate),o=a.getChannelData(0),l=237;for(let e=0;e<o.length;e++)l=l*1664525+1013904223>>>0,o[e]=(l/4294967296-.5)*.11;let u=e.createBufferSource(),d=e.createBiquadFilter();u.buffer=a,u.loop=!0,d.type=`lowpass`,d.frequency.value=450,u.connect(d).connect(n),u.start(),c.current=n}await s.current.resume(),N(!0)}catch{De(`Audio could not start in this browser.`)}},Ae=()=>{a.current=!a.current,A(a.current)},je=uu(b,S),Me=du(b,S),I=yu[f];return(0,$.jsxs)(`main`,{className:`exhibit `+(ne?`clean`:``),children:[(0,$.jsx)(`div`,{className:`tank`,ref:e}),be&&(0,$.jsxs)(`div`,{className:`loading-poster`,children:[(0,$.jsx)(`img`,{src:`./aquascape.png`,alt:`A planted aquarium in a dark gallery`}),(0,$.jsx)(`p`,{role:`status`,children:`Bringing the aquascape to life…`})]}),m&&(0,$.jsxs)(`div`,{className:`fallback`,children:[(0,$.jsx)(`img`,{src:`./aquascape.png`,alt:`Concept artwork of a planted aquarium in a dark gallery`}),(0,$.jsxs)(`p`,{children:[m,` Image: original photographic artwork.`]})]}),(0,$.jsxs)(`header`,{className:`chrome`,children:[(0,$.jsx)(`a`,{href:`../`,children:`← Demos`}),(0,$.jsx)(`h1`,{children:`THE LIVING AQUASCAPE`}),(0,$.jsxs)(`p`,{children:[(0,$.jsx)(`i`,{}),` `,k?`TIME SUSPENDED`:Me>=80?`A SMALL WORLD, IN BALANCE`:`A LIVING SYSTEM, IN TRANSITION`]})]}),(0,$.jsxs)(`div`,{className:`left-tools chrome`,children:[(0,$.jsx)(`button`,{"aria-expanded":g,onClick:()=>_(!g),children:`☷ Environment`}),(0,$.jsx)(`button`,{"aria-expanded":v,onClick:()=>y(!v),children:`◉ Chemistry`})]}),g&&(0,$.jsxs)(`aside`,{className:`drawer chrome`,"aria-label":`Environmental controls`,children:[(0,$.jsxs)(`div`,{className:`drawer-heading`,children:[(0,$.jsx)(`h2`,{children:`Environment`}),(0,$.jsx)(`button`,{"aria-label":`Close environmental controls`,onClick:()=>_(!1),children:`×`})]}),(0,$.jsxs)(`label`,{className:`field`,children:[`Guided scenario`,(0,$.jsx)(`select`,{value:w,onChange:e=>Ee(e.target.value),children:iu.map(e=>(0,$.jsx)(`option`,{children:e},e))})]}),(0,$.jsx)(`p`,{children:E}),Su.map(([e,t,n,r,i,a])=>(0,$.jsxs)(`label`,{className:`range`,children:[(0,$.jsxs)(`span`,{children:[t,(0,$.jsxs)(`output`,{children:[S[e],` `,a]})]}),(0,$.jsx)(`input`,{type:`range`,min:n,max:r,step:i,value:S[e],onChange:t=>Te(e,+t.target.value)})]},e)),(0,$.jsxs)(`div`,{className:`pair`,children:[(0,$.jsx)(`button`,{onClick:()=>{t.current?.feedAt(),n.current.waste+=.5,De(`Food added. Waste mineralizes gradually.`)},children:`Feed once`}),(0,$.jsx)(`button`,{onClick:()=>{lu(n.current),x({...n.current}),De(`30% of dissolved waste removed. Established algae remains.`)},children:`30% water change`}),(0,$.jsx)(`button`,{onClick:()=>{n.current.biomass*=.7,De(`Plants trimmed by 30%. Observe new growth over days.`)},children:`Trim plants`}),(0,$.jsx)(`button`,{onClick:()=>{n.current.algae*=.4,De(`Visible algae reduced by manual cleaning.`)},children:`Clean algae`})]}),(0,$.jsxs)(`label`,{className:`field`,children:[`Rendering `,(0,$.jsxs)(`small`,{children:[`Suggested: `,se]}),(0,$.jsx)(`select`,{value:oe,onChange:e=>Oe(e.target.value),children:[`Performance`,`High`,`Ultra`,`Photography`].map(e=>(0,$.jsx)(`option`,{children:e},e))})]}),(0,$.jsxs)(`label`,{className:`check`,children:[(0,$.jsx)(`input`,{type:`checkbox`,checked:j,onChange:e=>{te(e.target.checked),o.current=e.target.checked}}),` Reduced motion`]}),(0,$.jsx)(`button`,{onClick:()=>Ee(iu[0]),children:`Restore balanced aquarium`})]}),(0,$.jsxs)(`aside`,{className:`chemistry chrome`,"aria-label":`Live modeled readings`,children:[(0,$.jsxs)(`span`,{children:[`♨ `,(0,$.jsx)(`b`,{children:b.temperature.toFixed(1)}),` `,(0,$.jsx)(`small`,{children:`°C`})]}),(0,$.jsxs)(`span`,{children:[`pH `,(0,$.jsx)(`b`,{children:b.ph.toFixed(2)}),(0,$.jsx)(`small`,{children:` estimate`})]}),(0,$.jsxs)(`span`,{children:[`CO₂ `,(0,$.jsx)(`b`,{children:b.co2.toFixed(1)}),` `,(0,$.jsx)(`small`,{children:`mg/L`})]}),(0,$.jsxs)(`span`,{children:[`O₂ `,(0,$.jsx)(`b`,{children:b.oxygen.toFixed(1)}),` `,(0,$.jsx)(`small`,{children:`mg/L`})]}),(0,$.jsxs)(`button`,{className:`balance`,onClick:()=>y(!v),"aria-expanded":v,children:[`BALANCE `,(0,$.jsx)(`strong`,{children:Me}),(0,$.jsx)(`small`,{children:`/ 100`})]})]}),v&&(0,$.jsxs)(`aside`,{className:`chemistry-detail chrome`,children:[(0,$.jsxs)(`div`,{className:`drawer-heading`,children:[(0,$.jsx)(`h2`,{children:`Under the surface`}),(0,$.jsx)(`button`,{"aria-label":`Close chemistry details`,onClick:()=>y(!1),children:`×`})]}),(0,$.jsxs)(`p`,{children:[`Modeled water chemistry · 180 L`,(0,$.jsx)(`br`,{}),`Dissolved nitrogen in mg N/L`]}),(0,$.jsx)(`dl`,{children:[[`Ammonia-N`,b.ammonia.toFixed(3)],[`Nitrite-N`,b.nitrite.toFixed(3)],[`Nitrate-N`,b.nitrate.toFixed(2)],[`Plant biomass`,b.biomass.toFixed(2)+`×`],[`Algae cover`,(b.algae*100).toFixed(0)+`%`],[`Biofilter maturity`,(b.bacteria*100).toFixed(0)+`%`]].map(([e,t])=>(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`dt`,{children:e}),(0,$.jsx)(`dd`,{children:t})]},e))}),(0,$.jsx)(`p`,{children:`Balance factors`}),Object.entries(je).map(([e,t])=>(0,$.jsxs)(`label`,{className:`factor`,children:[e,(0,$.jsx)(`meter`,{min:`0`,max:`1`,value:t})]},e)),(0,$.jsx)(`small`,{children:`Carbonate-only pH estimate. Aquasoil, organic acids and non-carbonate buffers can invalidate this relationship in a real aquarium.`})]}),!g&&f!==`Equipment`&&(0,$.jsxs)(`section`,{className:`story chrome`,children:[(0,$.jsxs)(`p`,{className:`eyebrow`,children:[String(vu.indexOf(f)+1).padStart(2,`0`),` / `,f.toUpperCase()]}),(0,$.jsx)(`h2`,{children:I[0]}),(0,$.jsx)(`p`,{children:I[1]}),(0,$.jsx)(`small`,{children:I[2]}),(f===`Living`||f===`Flow`)&&(0,$.jsxs)(`div`,{className:`range current-control`,role:`group`,"aria-label":`Water movement`,children:[(0,$.jsxs)(`span`,{children:[`Water current`,(0,$.jsxs)(`output`,{children:[S.flow,`%`]})]}),(0,$.jsx)(`input`,{"aria-label":`Water current`,type:`range`,min:`0`,max:`100`,step:`1`,value:S.flow,onChange:e=>Te(`flow`,+e.target.value)}),(0,$.jsxs)(`span`,{children:[`Surface ripples`,(0,$.jsxs)(`output`,{children:[S.agitation,`%`]})]}),(0,$.jsx)(`input`,{"aria-label":`Surface ripples`,type:`range`,min:`0`,max:`100`,step:`1`,value:S.agitation,onChange:e=>Te(`agitation`,+e.target.value)}),(0,$.jsx)(`small`,{children:k?`Resume playback to see the plants sway.`:j?`Turn off Reduced motion in Environment to see the plants sway.`:`Watch the tall leaves bend; rooted bases stay still.`})]})]}),f===`Equipment`&&(0,$.jsxs)(`section`,{className:`equipment-card chrome`,children:[(0,$.jsx)(`p`,{className:`eyebrow`,children:`WATER, THROUGH THE SYSTEM`}),(0,$.jsx)(`h2`,{children:`Inside the filter`}),(0,$.jsx)(`div`,{className:`equipment-steps`,children:Object.keys(xu).map((e,t)=>(0,$.jsxs)(`button`,{"aria-pressed":me===e,onClick:()=>he(e),children:[(0,$.jsx)(`small`,{children:String(t+1).padStart(2,`0`)}),e,(0,$.jsx)(`span`,{"aria-hidden":`true`,children:`→`})]},e))}),(0,$.jsx)(`p`,{children:xu[me]}),(0,$.jsx)(`small`,{children:`Representative photographic equipment · functional inspection guide`})]}),f===`Biology`&&(0,$.jsxs)(`section`,{className:`lesson chrome`,children:[(0,$.jsxs)(`label`,{className:`field`,children:[`Look closer`,(0,$.jsx)(`select`,{value:fe,onChange:e=>pe(e.target.value),children:Object.keys(bu).map(e=>(0,$.jsx)(`option`,{children:e},e))})]}),(0,$.jsx)(`h2`,{children:bu[fe][0]}),(0,$.jsx)(`p`,{children:bu[fe][1]})]}),ue&&f===`Living`&&(0,$.jsxs)(`section`,{className:`inspector chrome`,children:[(0,$.jsx)(`button`,{"aria-label":`Close fish inspection`,onClick:()=>{t.current?.selectFish(null),de(null)},children:`×`}),(0,$.jsx)(`p`,{className:`eyebrow`,children:`LIVING COLLECTION`}),(0,$.jsx)(`h2`,{children:ue.species}),(0,$.jsxs)(`p`,{children:[ue.mood,` · `,ue.preferredDepth,(0,$.jsx)(`br`,{}),ue.reason?ue.reason:`Fish seek food, maintain distance and respond to their school.`]}),ue.energy!==void 0&&(0,$.jsxs)(`p`,{children:[`Appetite `,Math.round(ue.hunger*100),`% · Energy `,Math.round((ue.energy??0)*100),`%`,(0,$.jsx)(`br`,{}),(0,$.jsx)(`small`,{children:`Simulated needs`})]})]}),(0,$.jsxs)(`div`,{className:`view-tools chrome`,children:[(0,$.jsxs)(`label`,{children:[`Look closer`,(0,$.jsx)(`select`,{"aria-label":`Camera framing`,value:ve,onChange:e=>Se(e.target.value),children:[`Gallery`,`Aquascape`,`Open water`,`Root zone`,`Equipment`,`Leaf macro`,`3D tetra`].map(e=>(0,$.jsx)(`option`,{children:e},e))})]}),(0,$.jsx)(`button`,{className:`prototype-control`,onClick:()=>Se(`3D tetra`),children:`Inspect 3D tetra`}),(0,$.jsx)(`button`,{"aria-label":`Zoom out`,onClick:()=>t.current?.zoom((t.current?.camera.zoom||1)/1.2),children:`−`}),(0,$.jsx)(`button`,{"aria-label":`Zoom in`,onClick:()=>t.current?.zoom((t.current?.camera.zoom||1)*1.2),children:`+`}),(0,$.jsx)(`button`,{onClick:()=>{Ce(`Living`),_(!1),y(!1),de(null)},children:`Reset view`}),(0,$.jsx)(`button`,{onClick:()=>{t.current?.feedAt(),n.current.waste+=.5,a.current=!1,A(!1),De(j?`Food added. Turn off Reduced motion to watch feeding.`:`Food added — watch the school gather near the surface.`)},children:`Feed fish`})]}),(0,$.jsxs)(`div`,{className:`transport chrome`,children:[(0,$.jsx)(`button`,{onClick:Ae,"aria-label":k?`Resume simulation`:`Pause simulation`,children:k?`▶`:`Ⅱ`}),(0,$.jsxs)(`span`,{children:[`DAY `,Math.floor(b.hours/24)+1,` `,(0,$.jsxs)(`b`,{children:[String(Math.floor((12+b.hours)%24)).padStart(2,`0`),`:`,String(Math.floor(b.hours*60)%60).padStart(2,`0`)]})]}),(0,$.jsxs)(`select`,{"aria-label":`Ecosystem time speed`,value:O,onChange:e=>we(+e.target.value),children:[(0,$.jsx)(`option`,{value:1,children:`Real time`}),(0,$.jsx)(`option`,{value:3600,children:`1 hour / sec`}),(0,$.jsx)(`option`,{value:86400,children:`1 day / sec`})]}),f===`Time-lapse`&&(0,$.jsx)(`button`,{onClick:()=>{cu(n.current,r.current,24),x({...n.current})},children:`+1 day`})]}),(0,$.jsx)(`nav`,{className:`modes chrome`,"aria-label":`Exploration modes`,children:vu.map(e=>(0,$.jsx)(`button`,{"aria-pressed":f===e,onClick:()=>Ce(e),children:e},e))}),(0,$.jsxs)(`div`,{className:`photo-tools chrome`,children:[(0,$.jsxs)(`button`,{onClick:()=>re(!0),title:`Hide interface (H)`,children:[`◉ `,(0,$.jsx)(`span`,{children:`Photo mode`})]}),(0,$.jsx)(`button`,{onClick:()=>{t.current?(t.current.capture(),De(`Aquarium PNG saved.`)):De(`PNG capture requires the animated view.`)},children:`Save PNG`})]}),(0,$.jsxs)(`div`,{className:`audio-tools chrome`,children:[(0,$.jsx)(`button`,{"aria-pressed":M,onClick:ke,children:M?`Sound on`:`Sound off`}),M&&(0,$.jsxs)(`label`,{children:[`Volume`,(0,$.jsx)(`input`,{"aria-label":`Environment volume`,type:`range`,min:`0`,max:`100`,value:ie,onChange:e=>{let t=+e.target.value;ae(t),u.current=t}})]}),(0,$.jsxs)(`small`,{children:[ce.toFixed(1),` ms / frame`]})]}),ne&&(0,$.jsx)(`button`,{className:`restore`,onClick:()=>re(!1),children:`Show controls · H / Esc`}),ge&&(0,$.jsx)(`div`,{role:`status`,className:`toast`,children:ge}),(0,$.jsx)(`a`,{className:`model-note chrome`,href:`./about.html`,target:`_blank`,rel:`noopener`,children:`Educational model · Methods & limits ↗`})]})}var wu=document.getElementById(`root`);if(!wu)throw Error(`Aquarium Laboratory could not find its application mount.`);(0,u.createRoot)(wu).render((0,$.jsx)(l.StrictMode,{children:(0,$.jsx)(Cu,{})}));