...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Fs(){return new Ua({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ls(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Is(){return new Ua({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ls(),fragmentShader:`
	...
	`}var Rs=class extends sn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ji(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,ld=class{group=new Rn;meshes=[];phase=0;pectoralPhase=0;fins=new Map;originals=new Map;shaders=[];eyes=[];constructor(e,t=0,n=!0){this.phase=t,this.pectoralPhase=t*1.7;let r=new Ka({map:e,roughness:.43,metalness:.12,clearcoat:.35,clearcoatRoughness:.25}),i=r.clone();i.transparent=!0,i.opacity=.65,i.alphaTest=.12,i.side=2,i.depthWrite=!1,i.roughness=.55;let a=i.clone();a.map=null,a.color.set(12112584),a.opacity=.48,a.alphaTest=.01;let o=[[-.32,.025],[-.26,.041],[-.14,.073],[0,.106],[.14,.115],[.27,.101],[.37,.075],[.445,.038],[.49,.003]],s=[],c=[],l=[],u=n?65:33,d=n?32:16;for(let e=0;e<u;e++){let t=-.32+e/(u-1)*.81,n=0;for(;n<o.length-2&&o[n+1][0]<t;)n++;let r=o[n],i=o[n+1],a=Bt.smoothstep(t,r[0],i[0]),f=Bt.lerp(r[1],i[1],a);for(let n=0;n<=d;n++){let r=n/d*Math.PI*2,i=-.035+Math.cos(r)*f,a=Math.sin(r)*f*.52;if(s.push(t,i,a),c.push(t+.5,.5+i/.45),e<u-1&&n<d){let t=e*(d+1)+n;l.push(t,t+1,t+d+1,t+1,t+d+2,t+d+1)}}}for(let[e,t]of[[0,-.32],[u-1,.49]]){let n=s.length/3;s.push(t,-.035,0),c.push(t+.5,.5-.035/.45);for(let t=0;t<d;t++){let r=e*(d+1)+t,i=r+1;e===0?l.push(n,i,r):l.push(n,r,i)}}let f=new zr;f.setAttribute(`position`,new K(s,3)),f.setAttribute(`uv`,new K(c,2)),f.setIndex(l),f.computeVertexNormals(),this.add(f,r);let p=(e,t,n=1)=>{let r=[],o=[];for(let t=1;t<e.length-1;t++){let n=e[0],i=e[t],a=e[t+1],s=(e,t)=>{let s=1-e-t,c=n[0]*s+i[0]*e+a[0]*t,l=n[1]*s+i[1]*e+a[1]*t,u=(n[2]||0)*s+(i[2]||0)*e+(a[2]||0)*t;r.push(c,l,u),o.push(c+.5,.5+l/.45)};for(let e=0;e<7;e++)for(let t=0;t<7-e;t++)s(e/7,t/7),s((e+1)/7,t/7),s(e/7,(t+1)/7),e+t<6&&(s((e+1)/7,t/7),s((e+1)/7,(t+1)/7),s(e/7,(t+1)/7))}let s=new zr;s.setAttribute(`position`,new K(r,3)),s.setAttribute(`uv`,new K(o,2)),s.computeVertexNormals(),this.add(s,t===`pectoral`?a:i,t,n)};p([[-.3,-.035],[-.495,.12],[-.43,.015],[-.395,-.035],[-.43,-.09],[-.495,-.185]],`tail`),p([[-.1,.056],[-.065,.22],[.1,.07]],`dorsal`),p([[-.23,-.079],[-.12,-.21],[.005,-.141],[.12,-.13]],`anal`);for(let e of[-1,1])p([[.25,-.055,e*.049],[.05,-.17,e*.1],[.18,-.1,e*.022]],`pectoral`,e);let m=new Ka({color:6527370,roughness:.25,metalness:.3}),h=new Ka({color:132613,roughness:.16,clearcoat:1});for(let e of[-1,1]){let t=new q(new Ma(.027,16,12),m);t.scale.set(1,1,.45),t.position.set(.426,-.022,e*.034),this.group.add(t),this.eyes.push(t);let n=new q(new Ma(.018,16,12),h);n.scale.set(1,1,.3),n.position.set(.426,-.022,e*.047),this.group.add(n),this.eyes.push(n)}this.group.traverse(t=>{if(t instanceof q){t.renderOrder=3;let n=t.material;n.onBeforeCompile=t=>{t.uniforms.photograph={value:e},t.uniforms.flow={value:.65},t.uniforms.sceneTime={value:0},t.uniforms.depth={value:.55},t.uniforms.daylight={value:1},t.vertexShader=`varying vec2 sceneUv;
`+t.vertexShader,t.vertexShader=t.vertexShader.replace(`#include <project_vertex>`,`#include <project_vertex>
vec4 scenePosition=modelMatrix*vec4(transformed,1.0);sceneUv=vec2(scenePosition.x/1672.0+.5,scenePosition.y/941.0+.5);`),t.fragmentShader=`uniform sampler2D photograph;uniform float flow,sceneTime,depth,daylight;varying vec2 sceneUv;
#define time sceneTime
`+sd+cd+`
`+t.fragmentShader,t.fragmentShader=t.fragmentShader.replace(`#include <dithering_fragment>`,`gl_FragColor.rgb*=.35+.65*daylight;gl_FragColor.a*=1.0-sceneOcclusion(sceneUv+plantingOffset(sceneUv),depth);if(gl_FragColor.a<.08)discard;
#include <dithering_fragment>`),this.shaders.push(t)},n.customProgramCacheKey=()=>`tetra-depth-v1`}})}add(e,t,n=`body`,r=1){let i=new q(e,t);this.meshes.push(i),this.fins.set(i,{kind:n,side:r}),this.originals.set(e,new Float32Array(e.getAttribute(`position`).array)),this.group.add(i)}update(e,t,n,r,i,a,o,s=.35){this.phase=rd(this.phase,o,t),this.pectoralPhase+=o*(5+s*13);for(let e of this.meshes){let n=e.geometry.getAttribute(`position`),r=this.originals.get(e.geometry);for(let i=0;i<n.count;i++){let a=r[i*3],o=r[i*3+1],c=r[i*3+2],l=this.fins.get(e),u=od(a,o,c,this.phase,t,l.kind,l.side,this.pectoralPhase,s);n.setXYZ(i,...u)}n.needsUpdate=!0,e.geometry.computeVertexNormals()}for(let t of this.shaders)t.uniforms.photograph.value=n,t.uniforms.sceneTime.value=e,t.uniforms.flow.value=r,t.uniforms.depth.value=i,t.uniforms.daylight.value=a}dispose(){let e=new Set;this.group.traverse(t=>{t instanceof q&&(t.geometry.dispose(),e.add(t.material))}),e.forEach(e=>e.dispose())}},ud=e=>Math.max(0,Math.min(1,e));function dd(){return{hunger:.6,energy:.85,curiosity:.65,decisionIn:0,biteIn:0,seed:723,intent:{kind:`explore`,reason:`Exploring the planting.`},consumedFood:null,visited:[]}}var fd=e=>(e.seed=Math.imul(e.seed,1664525)+1013904223>>>0,e.seed/4294967296);function pd(e,t,n){e.visited.push({x:t,y:n,age:0}),e.visited.length>6&&e.visited.shift(),e.curiosity*=.35}function md(e,t,n,r,i,a,o=.65){let s=e=>Math.hypot(e.x-n,e.y-r,((e.z??o)-o)*180);if(t<=0)return e.intent;e.hunger=ud(e.hunger+t*.0015),e.energy=ud(e.energy+t*(i<2?.018:-.0015-i*18e-5)),e.curiosity=ud(e.curiosity+t*.006),e.visited.forEach(e=>e.age+=t),e.visited=e.visited.filter(e=>e.age<100),e.biteIn=Math.max(0,e.biteIn-t),e.decisionIn-=t;let c=a.food.filter(e=>s(e)<330).sort((e,t)=>s(e)-s(t))[0];c&&e.hunger>.18&&s(c)<22&&e.biteIn===0&&(e.consumedFood=c.id,e.hunger=ud(e.hunger-.23),e.energy=ud(e.energy+.08),e.biteIn=1.2,e.decisionIn=0);let l=a.neighbors.filter(e=>s(e)<26).sort((e,t)=>s(e)-s(t))[0];if(e.decisionIn>0&&!l&&!(c&&e.hunger>.35&&e.intent.kind!==`feed`)&&(e.intent.kind!==`feed`||c))return e.intent.kind===`feed`&&c&&(e.intent.target=c),e.intent;if(e.decisionIn=.7+fd(e)*.8,l)e.intent={kind:`space`,reason:`Giving a nearby fish more room.`,target:{id:-1,x:n+(n>=l.x?65:-65),y:r+(r>=l.y?22:-22),z:ud(o+(o>=(l.z??o)?.09:-.09))}};else if(c&&e.hunger>.18)e.intent={kind:`feed`,reason:`Food detected — approaching a flake.`,target:c};else if(e.energy<.28||e.intent.kind===`rest`&&e.energy<.62)e.intent={kind:`rest`,reason:`Resting and fanning its fins to hold position.`};else{let t=a.neighbors.filter(e=>s(e)<260&&s(e)>45);if((t.length>=2||a.schoolGoal)&&fd(e)<(a.schoolGoal?.88:.48)){let i=Math.max(1,t.length),s=a.schoolGoal,c=t.length?t.reduce((e,t)=>e+t.x,0)/i:n,l=t.length?t.reduce((e,t)=>e+t.y,0)/i:r,u=t.length?t.reduce((e,t)=>e+(t.z??o),0)/i:o,d=t.reduce((e,t)=>e+(t.vx??0),0)/i;e.intent={kind:`school`,reason:`Swimming with the tetra school.`,target:{id:-2,x:s?s.x:c+d*5,y:s?s.y:l,z:s?s.z??u:u,vx:s?.vx??d}},e.decisionIn=1.8+fd(e)*2}else e.intent={kind:`explore`,reason:e.curiosity>.6?`Looking for an unfamiliar leaf to inspect.`:`Exploring between the plants.`},e.decisionIn=4+fd(e)*4}return e.intent}var hd=.24,gd=(e,t,n)=>Math.max(t,Math.min(n,e)),_d=(e,t,n,r)=>e+(t-e)*(1-Math.exp(-r*n));function vd(e){return e.seed=Math.imul(e.seed,1664525)+1013904223>>>0,e.seed/4294967296}function yd(e=237){return{x:1110,y:330,vx:16,vy:0,yaw:0,pitch:0,speed:16,direction:1,sinceTurn:10,elapsed:0,behavior:`cruising`,remaining:2.6,targetX:1190,targetY:345,cruiseSpeed:16,effort:.7,pectoralEffort:.35,seed:e,wasFeeding:!1,turnRate:.8,depthTarget:445,depthRemaining:20,depthBand:2,z:.62,vz:0,targetZ:.18,depthHeading:0,depthTimer:0,brain:dd()}}function Q(e,t){e.behavior=t;let n=vd(e);if(t===`cruising`&&(e.remaining=3+n*5,e.cruiseSpeed=11+vd(e)*10,e.targetY=e.depthTarget),t===`burst`&&(e.remaining=.7+n*1.1,e.cruiseSpeed=24+vd(e)*7),t===`gliding`&&(e.remaining=1.8+n*2.6),t===`inspecting`&&(e.remaining=2.2+n*3.5,pd(e.brain,e.targetX,e.targetY)),t===`approaching`){let t=[[1170,380],[1090,397],[975,382],[890,327],[760,355],[690,340],[1180,480],[1060,465],[950,490],[810,465],[820,287],[990,275],[1150,290]],r=t.filter(([t,n])=>(t-e.x)*e.direction>25&&(t-e.x)*e.direction<250&&Math.abs(n-e.y)<85),i=r.length?r:t.filter(([,t])=>Math.abs(t-e.y)<85),a=i.filter(([t,n])=>!e.brain.visited.some(e=>Math.hypot(e.x-t,e.y-n)<55)),o=a.length?a:i,s=o[Math.floor(n*o.length)]||t[2];e.targetX=s[0],e.targetY=s[1]-12,e.remaining=20,e.sinceTurn>6&&Math.sign(e.targetX-e.x)!==e.direction&&(e.direction=e.direction===1?-1:1,e.sinceTurn=0,e.turnRate=.65+vd(e)*.2)}t===`foraging`&&(e.remaining=2+n*2,e.targetX=990+vd(e)*65,e.targetY=257+vd(e)*10)}function bd(e,t,n=!1,r=!1,i){let a=gd(Number.isFinite(t)?t:0,0,.1);if(!a)return;let o=i?md(e.brain,a,e.x,e.y,e.speed,i,e.z):null;if(o&&(n=o.kind===`feed`),e.elapsed+=a,e.sinceTurn+=a,e.remaining-=a,!n&&(e.depthRemaining-=a,e.depthRemaining<=0&&Math.abs(e.depthTarget-e.y)<24)){e.depthBand=(e.depthBand+1+ +(vd(e)<.25))%3;let t=[[267,305],[345,390],[440,485]][e.depthBand];e.depthTarget=t[0]+vd(e)*(t[1]-t[0]),e.depthRemaining=18+vd(e)*18}if(n&&!e.wasFeeding&&Q(e,`foraging`),!n&&e.wasFeeding&&Q(e,`gliding`),e.wasFeeding=n,e.remaining<=0){if(n)Q(e,`foraging`);else if(e.behavior===`burst`)Q(e,`gliding`);else if(e.behavior===`approaching`)Q(e,`inspecting`);else if(e.behavior===`inspecting`)Q(e,vd(e)<.6?`burst`:`cruising`);else{let t=vd(e);Q(e,t<.36&&Math.abs(e.depthTarget-e.y)<30?`approaching`:t<.7?`burst`:`cruising`)}}e.sinceTurn>6&&(e.direction===1&&e.x>1210||e.direction===-1&&e.x<660)&&(e.direction=e.direction===1?-1:1,e.sinceTurn=0,e.turnRate=.65+vd(e)*.2,n||Q(e,`cruising`)),n&&e.sinceTurn>6&&(e.targetX-e.x)*e.direction<-22&&(e.direction=e.direction===1?-1:1,e.sinceTurn=0),o?.target&&(e.targetX=gd(o.target.x,650,1220),e.targetY=gd(o.target.y,240,500),(o.kind===`school`||o.kind===`space`)&&(e.behavior=`cruising`,e.cruiseSpeed=o.kind===`space`?9:15,e.remaining=Math.max(1,e.remaining)),e.sinceTurn>6&&(e.targetX-e.x)*e.direction<-35&&(e.direction=e.direction===1?-1:1,e.sinceTurn=0));let s=e.direction===1?0:Math.PI,c=Math.abs(s-e.yaw)>.18,l=e.behavior===`inspecting`,u=l?(1+Math.sin(e.elapsed*1.1))*.045:0,d=s+(e.direction===1?u:-u);e.yaw+=gd(d-e.yaw,-a*e.turnRate,a*e.turnRate);let f=e.cruiseSpeed,p=e.cruiseSpeed/28,m=.35;if(e.behavior===`burst`&&(p=1+(e.cruiseSpeed-24)/20,m=.25),e.behavior===`gliding`&&(f=0,p=.025,m=.18),l&&(f=0,p=.02,m=.8+Math.sin(e.elapsed*1.7)*.12),(e.behavior===`approaching`||e.behavior===`foraging`)&&(f=gd(((e.targetX-e.x)*e.direction-5)*.55,0,e.behavior===`foraging`?23:15),Math.abs(e.targetY-e.y)>20&&(f=Math.max(f,7)),p=f/24,m=f<3?.8:.4,e.behavior===`approaching`&&Math.abs(e.targetX-e.x)<19&&Math.abs(e.targetY-e.y)<17&&(Q(e,`inspecting`),f=0,p=.02,m=.9)),o?.kind===`school`&&(f=gd(Math.abs(o.target?.vx??12)*.8+Math.abs(e.targetX-e.x)*.025,13,23),p=f/28),o?.kind===`rest`&&(f=0,p=.015,m=.85,e.behavior=`gliding`,e.remaining=2),c&&(f=Math.min(f,8),p=.3,m=.7),r&&(f=Math.min(f,11),p=Math.min(p,.55)),i)for(let t of i.neighbors){let n=t.x-e.x,r=t.y-e.y,i=((t.z??e.z)-e.z)*180,a=Math.hypot(n,r,i),o=n*e.direction>0,s=(e.vx-(t.vx??0))*n+(e.vy-(t.vy??0))*r;o&&s>0&&a<90&&Math.abs(r)<38&&Math.abs(i)<45&&(f=Math.min(f,Math.max(8,(a-55)*.35)),m=Math.max(m,.85),p=Math.min(p,.18))}e.speed=_d(e.speed,f,e.behavior===`gliding`?.65:1.65,a),e.effort=_d(e.effort,p,3,a),e.pectoralEffort=_d(e.pectoralEffort,m,3,a);let h=e.behavior===`inspecting`||o?.kind===`rest`,g=o?.target||e.behavior===`approaching`||e.behavior===`foraging`?e.targetY:e.depthTarget,_=Math.min(5,Math.max(1,e.speed)*Math.tan(hd)),v=c||h?0:gd((g-e.y)*.16,-_,_);e.vy=_d(e.vy,v,2,a),e.vx=e.speed*Math.cos(e.yaw),e.x+=e.vx*a,e.y+=e.vy*a;let y=c?0:h?Math.sin(e.elapsed*.9)*.025:gd(Math.atan2(-e.vy,Math.max(1,e.speed)),-.24,hd);e.depthTimer-=a,Math.abs(e.z-e.targetZ)<.045&&e.depthTimer<=0&&(e.targetZ=e.targetZ<.5?.72+vd(e)*.2:.08+vd(e)*.22,e.depthTimer=8+vd(e)*10);let b=o?.target?.z??(n?.65:e.targetZ),x=h||c?0:gd((b-e.z)*.15,-e.speed*.65/180,e.speed*.65/180);e.vz=_d(e.vz,x,1.6,a),e.z=gd(e.z+e.vz*a,.06,.94);let S=c?0:Math.atan2(-e.vz*180,Math.max(2,e.speed))*e.direction;e.depthHeading+=gd(S-e.depthHeading,-.25*a,.25*a),e.pitch+=gd((y-e.pitch)*(1-Math.exp(-a*2)),-.25*a,.25*a)}function xd(e){return e.brain.intent.kind===`rest`?`Resting`:e.brain.intent.kind===`school`?`Following the school`:e.brain.intent.kind===`space`?`Making space`:{cruising:`Exploring`,burst:`Short swimming burst`,gliding:`Gliding`,approaching:`Approaching a leaf`,inspecting:`Inspecting the planting`,foraging:`Looking for food`}[e.behavior]}var Sd=`
...
`,Cd=()=>({light:65,co2:24,flow:65,agitation:35,temperature:24,photoperiod:8,feed:1,fertilizer:1,kh:4}),wd=()=>({hours:0,co2:24,oxygen:8.1,temperature:24,ammonia:.015,nitrite:.01,nitrate:4.5,waste:.3,algae:.04,biomass:1,bacteria:.95,ph:6.7}),Td=[`Balanced mature aquarium`,`Newly cycled aquarium`,`CO₂ turned off`,`Excessive light`,`Overfeeding event`,`Clogged filter`,`Missed water changes`,`Post-trim recovery`,`Algae bloom and correction`,`Day to night`];function Ed(e){let t=wd(),n=Cd(),r=`A mature biological filter, moderate light and distributed carbon support steady growth. Try 1 day per second to observe several light cycles.`;switch(e){case Td[1]:t.bacteria=.35,t.ammonia=.15,t.nitrite=.1,r=`Recently cycled filters have less reserve capacity. Watch bacterial capacity develop over days; additional food can still overwhelm it.`;break;case Td[2]:n.co2=0,r=`Dissolved carbon declines over hours. Plant growth slows; under the same light, algae pressure builds over days. Restore carbon and allow recovery time.`;break;case Td[3]:n.light=100,n.photoperiod=14,r=`Long, intense light increases demand for carbon and nutrients. Algae pressure accumulates if demand outpaces supply. Shorten the photoperiod to recover.`;break;case Td[4]:t.waste=5,r=`Uneaten food becomes organic waste. Mineralization releases ammonia; nitrification consumes oxygen and produces nitrite, then nitrate.`;break;case Td[5]:n.flow=8,r=`Restricted circulation reduces delivery to the filter and plants. Organic waste accumulates. Restore flow and watch gases recover before slower biology.`;break;case Td[6]:t.nitrate=18,t.waste=3,r=`Accumulated nitrogen and organic material reflect missed maintenance. A water change dilutes dissolved waste; it does not instantly erase algae.`;break;case Td[7]:t.biomass=.55,r=`Trimming reduces photosynthetic area immediately. Biomass and roots recover gradually as light reaches lower growth points.`;break;case Td[8]:t.algae=.7,n.light=45,n.photoperiod=6,r=`The bloom begins with corrected conditions. Established algae declines gradually; remove some manually, restore carbon and keep maintenance consistent.`;break;case Td[9]:t.hours=5.8,r=`The photoperiod ends at 18:00. Photosynthesis stops, while plants, fish and microbes keep respiring. Surface gas exchange becomes especially important.`}return{state:t,environment:n,explanation:r}}var Dd=(e,t,n)=>Math.max(t,Math.min(n,e));function Od(e,t){let n=(12+e.hours)%24,r=14-t.photoperiod/2,i=14+t.photoperiod/2;return Dd(Math.min((n-r)*2,(i-n)*2),0,1)*t.light/65}function kd(e,t,n){let r=Math.max(0,n);for(;r>1e-9;){let n=Math.min(r,1/60);r-=n;let i=Od(e,t),a=t.flow/100,o=.1+t.agitation/65+a*.25,s=e.co2/(e.co2+8),c=e.nitrate/(e.nitrate+1),l=.25+.75*a,u=i*s*c*l*e.biomass,d=.18+.1*e.biomass+.035*e.waste;e.co2+=((i>0?t.co2:0)*.13+d*1.35-(e.co2-.6)*o*.12-u*.48)*n;let f=Math.min(e.waste/n,e.waste*.075);e.waste+=(t.feed*.032-f)*n;let p=Math.min(e.ammonia/n,e.ammonia*(.2+a)*e.bacteria*Dd(e.oxygen/5,0,1)),m=Math.min(e.nitrite/n,e.nitrite*(.18+a)*e.bacteria*Dd(e.oxygen/5,0,1));e.ammonia+=(f*.18-p)*n,e.nitrite+=(p-m)*n,e.nitrate=Math.max(0,e.nitrate+(m+t.fertilizer*.014-u*.025)*n);let h=8.4-(e.temperature-24)*.16;e.oxygen=Dd(e.oxygen+((h-e.oxygen)*o*.42+u*.9-d-p*3.43-m*1.14)*n,.2,14),e.co2=Dd(e.co2,.1,100),e.temperature+=(t.temperature-e.temperature)*Math.min(1,n/3);let g=Math.max(0,i-s*c*l*1.8)+.08*e.waste;e.algae=Dd(e.algae+(g*.011-e.algae*.006)*n,0,1),e.biomass=Dd(e.biomass+(u*.0028-e.biomass*4e-4-e.algae*3e-4)*n,.15,2),e.bacteria=Dd(e.bacteria+(.0025*(1-e.bacteria)-Math.max(0,3-e.oxygen)*.001*e.bacteria)*n,.05,1),e.ph=7-Math.log10(e.co2/(3*t.kh)),e.hours+=n}return e}function Ad(e,t=.3){for(let n of[`ammonia`,`nitrite`,`nitrate`,`waste`])e[n]*=1-t}function jd(e,t){return{oxygen:Dd((e.oxygen-2)/5,0,1),nitrogen:Dd(1-(e.ammonia+e.nitrite)*2,0,1),circulation:t.flow/100,algae:1-e.algae}}function Md(e,t){let n=jd(e,t);return Math.round(100*(n.oxygen*.35+n.nitrogen*.35+n.circulation*.15+n.algae*.15))}var $=1672,Nd=941,Pd=`varying vec2 vUv; void main(){vUv=uv;gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0);}`,Fd=`precision highp float;
...
void main(){
 ...
 #include <colorspace_fragment>
}`,Id=class{host;canvas;renderer;scene=new Kn;camera=new No(-836,$/2,Nd/2,-941/2,-300,400);ready;onSelectedFish=null;onInspect=null;background;fish=[];schoolRoute=$u();tetras=new Map;sprites=[];photograph;macro;flow=new Rn;roots=new Rn;bubbles=new Rn;food=new Rn;bubbleData=[];arrows=[];markers=[];dust;time=0;mode=`Living`;destroyed=!1;seed=237;quality=`High`;zoomTarget=1;zoomCurrent=1;centerX=0;centerY=0;targetX=0;targetY=0;pointer=null;pointers=new Map;pinch=0;pinchZoom=1;flowPhase=0;selected=null;feeding=0;lastReport=0;macroBlend=0;constructor(e){this.host=e,this.renderer=new Su({antialias:!0,alpha:!1,preserveDrawingBuffer:!0,powerPreference:`high-performance`}),this.renderer.setClearColor(329992),this.renderer.outputColorSpace=Ze,this.canvas=this.renderer.domElement,this.canvas.tabIndex=0,this.canvas.setAttribute(`aria-label`,`Living aquascape. Drag to look around, scroll or pinch to zoom. Arrow keys pan; plus and minus zoom. Select a fish for details.`),this.canvas.style.touchAction=`none`,e.appendChild(this.canvas);let t=new go;this.photograph=new rn,this.macro=new rn,this.background=new q(new Aa($,Nd),new Ua({vertexShader:Pd,fragmentShader:Fd,uniforms:{photograph:{value:this.photograph},macroPhoto:{value:this.macro},time:{value:0},flow:{value:.65},agitation:{value:.4},day:{value:1},algae:{value:.04},biomass:{value:1},macroBlend:{value:0}},depthTest:!1})),this.background.position.z=-10,this.background.renderOrder=-10,this.scene.add(this.background,this.flow,this.roots,this.bubbles,this.food);let n=new vo(14413823,2313269,2.2),r=new Fo(15398399,2.1);r.position.set(-100,500,350),this.scene.add(n,r);let i=t.loadAsync(`./aquascape.png`).then(e=>{if(this.destroyed){e.dispose();return}e.colorSpace=Ze,e.anisotropy=this.renderer.capabilities.getMaxAnisotropy(),this.photograph.dispose(),this.photograph=e,this.background.material.uniforms.photograph.value=e}),a=t.loadAsync(`./leaf-macro.png`).then(e=>{if(this.destroyed){e.dispose();return}e.colorSpace=Ze,this.macro.dispose(),this.macro=e,this.background.material.uniforms.macroPhoto.value=e});this.ready=Promise.all([i,a,this.loadFish()]).then(()=>{}),this.buildFlow(),this.buildRoots();let o=[];for(let e=0;e<80;e++)o.push(320+this.random()*980-$/2,Nd/2-(205+this.random()*410),1);let s=new zr;s.setAttribute(`position`,new K(o,3)),this.dust=new Ki(s,new Vi({size:1.1,color:13096902,transparent:!0,opacity:.18,depthWrite:!1})),this.scene.add(this.dust);let c=new ja(.65,1.15,10),l=new Xr({color:14020323,transparent:!0,opacity:.45,side:2,depthWrite:!1});for(let e=0;e<62;e++){let t=e<30,n=t?1252+this.random()*12:520+this.random()*665,r=t?602:465+this.random()*150,i=new q(c,l);i.position.copy(this.pos(n,r,3)),i.scale.setScalar(t?.7:1),this.bubbles.add(i),this.bubbleData.push({mesh:i,x:n,y:205+this.random()*(r-205),originX:n,originY:r,speed:t?10+this.random()*6:14+this.random()*12,phase:this.random()*6,co2:t})}for(let[t,n,r,i]of[[`Plant`,458,351,`plants`],[`Roots`,1e3,609,`roots`],[`Filter`,1463,437,`equipment`]]){let a=document.createElement(`button`);a.className=`scene-hotspot`,a.textContent=`+ `+t,a.setAttribute(`aria-label`,`Inspect `+t.toLowerCase()),a.onclick=()=>this.onInspect?.(i),e.appendChild(a),this.markers.push({button:a,x:n,y:r,mode:i})}this.setMode(`Living`),this.resize(),window.addEventListener(`resize`,this.resize),this.canvas.addEventListener(`pointerdown`,this.down),this.canvas.addEventListener(`pointermove`,this.move),this.canvas.addEventListener(`pointerup`,this.up),this.canvas.addEventListener(`pointercancel`,this.cancel),this.canvas.addEventListener(`wheel`,this.wheel,{passive:!1})}random(){return this.seed=1664525*this.seed+1013904223>>>0,this.seed/4294967296}pos(e,t,n=2){return new H(e-$/2,Nd/2-t,n)}async loadFish(){let e=new Image;if(e.src=`./living-species.png`,await e.decode(),!this.destroyed){for(let t=0;t<4;t++){let n=e.width/2,r=e.height/2,i=document.createElement(`canvas`);i.width=n,i.height=r;let a=i.getContext(`2d`);a.drawImage(e,t%2*n,Math.floor(t/2)*r,n,r,0,0,n,r);let o=a.getImageData(0,0,n,r),s=n,c=r,l=0,u=0;for(let e=0;e<r;e++)for(let t=0;t<n;t++)o.data[(e*n+t)*4+3]>32&&(s=Math.min(s,t),l=Math.max(l,t),c=Math.min(c,e),u=Math.max(u,e));if(l<=s||u<=c)throw Error(`Fish artwork has no visible pixels`);let d=document.createElement(`canvas`);d.width=l-s+1,d.height=u-c+1,d.getContext(`2d`).drawImage(i,s,c,d.width,d.height,0,0,d.width,d.height);let f=new Yi(d);f.colorSpace=Ze,f.anisotropy=4,this.sprites.push(f)}for(let e=0;e<25;e++){let t=e<16?0:e<22?1:e===22?2:3,n=t===2?105:t===3?38:30+this.random()*11,r=this.sprites[t],i=r.image,a=i.height/i.width,o=new Ua({transparent:!0,depthWrite:!1,uniforms:{map:{value:r},time:{value:this.random()*30},activity:{value:1},light:{value:1},opacity:{value:.96},photograph:{value:this.photograph},depth:{value:1},flow:{value:.65},sceneTime:{value:0}},vertexShader:`uniform float time,activity;varying vec2 vUv;varying vec2 sceneUv;void main(){vUv=uv;vec3 p=position;float tail=pow(1.0-uv.x,3.0);p.y+=sin(time*9.0-uv.x*8.0)*tail*1.2*activity;p.y+=sin(time*5.0)*sin(uv.y*3.14159)*.12;vec4 world=modelMatrix*vec4(p,1.0);sceneUv=vec2(world.x/1672.0+.5,world.y/941.0+.5);gl_Position=projectionMatrix*viewMatrix*world;}`,fragmentShader:`uniform sampler2D map,photograph;uniform float light,opacity,depth,flow,sceneTime;varying vec2 vUv;varying vec2 sceneUv;
#define time sceneTime
${sd}
${cd}
...
#include <colorspace_fragment>
}`}),s=new q(new Aa(n,n*a,24,6),o);o.side=2,s.renderOrder=3;let c=t===3?640+this.random()*560:610+this.random()*610,l=t===3?580+this.random()*30:t===2?420:280+this.random()*235,u={mesh:s,x:c,y:l,vx:(this.random()>.5?1:-1)*18,vy:0,targetX:c,targetY:l,size:n,phase:this.random()*30,depth:t===3?1:.18+this.random()*.65,species:t,turn:0};if(this.fish.push(u),this.scene.add(s),t===0){let t=new ld(r,e*.83,e===0),n=yd(237+e*7919);u.size=e===0?48:36+this.random()*8,u.x=860+e%4*65,u.y=315+Math.floor(e/4)*38,u.depth=.3+e%3*.17,Object.assign(n,{x:u.x,y:u.y,z:u.depth,elapsed:e*.7,remaining:2+e*.23}),n.brain.seed=723+e*3571,n.brain.energy=.72+this.random()*.22,n.brain.hunger=.4+this.random()*.25,this.tetras.set(e,{model:t,swim:n}),this.scene.add(t.group)}}}}buildFlow(){for(let e=0;e<9;e++){let t=e*6,n=new fa([this.pos(1265,228+t),this.pos(1080,268+t),this.pos(770,282+t),this.pos(385,350+t),this.pos(520,553+t),this.pos(1060,565+t),this.pos(1260,463+t),this.pos(1265,228+t)]),r=new Ii(new zr().setFromPoints(n.getPoints(100)),new Oi({color:e%2?13026977:10997974,transparent:!0,opacity:.28,depthTest:!1}));r.renderOrder=6,this.flow.add(r);for(let t=0;t<5;t++){let r=new q(new na(1.6,6,3),new Xr({color:e%2?14865575:12905969,transparent:!0,opacity:.7,depthTest:!1}));r.renderOrder=7,this.flow.add(r),this.arrows.push({mesh:r,path:n,phase:t/5+e*.03})}}}buildRoots(){let e=new q(new Aa(600,100),new Xr({color:1448204,transparent:!0,opacity:.74,depthTest:!1}));e.position.copy(this.pos(955,623,3)),e.renderOrder=5,this.roots.add(e);for(let e=0;e<30;e++){let e=680+this.random()*540,t=578+this.random()*12,n=[this.pos(e,t,5)],r=e,i=t;for(let e=0;e<12;e++)if(r+=(this.random()-.5)*13,i+=5+this.random()*3,n.push(this.pos(r,i,5)),e%3==1){let e=[this.pos(r,i,5),this.pos(r+(this.random()-.5)*35,i+17,5)],t=new Ii(new zr().setFromPoints(e),new Oi({color:11246443,transparent:!0,opacity:.58,depthTest:!1}));t.renderOrder=8,this.roots.add(t)}let a=new Ii(new zr().setFromPoints(n),new Oi({color:14535073,transparent:!0,opacity:.82,depthTest:!1}));a.renderOrder=8,this.roots.add(a)}}setMode(e){this.mode=e,this.flow.visible=e===`Flow`,this.roots.visible=e===`Roots`,this.selected=null,this.onSelectedFish?.(null),this.cameraPreset(e===`Equipment`?`Equipment`:e===`Roots`?`Root zone`:e===`Biology`?`Leaf macro`:`Gallery`)}cameraPreset(e){let t={Gallery:[0,0,1],Aquascape:[-15,30,1.35],"Open water":[235,100,1.8],"Root zone":[115,-125,1.75],Equipment:[590,25,2],"Leaf macro":[0,0,1]},n=t[e]||t.Gallery;[this.targetX,this.targetY,this.zoomTarget]=n,this.clampCamera()}focusPrototype(){this.setMode(`Living`),this.selected=0;let e=this.fish[0];e&&(this.targetX=e.x-$/2,this.targetY=Nd/2-e.y,this.zoomTarget=2.4,this.clampCamera(),this.report(e,0))}zoom(e){this.zoomTarget=Bt.clamp(e,1,2.4),this.clampCamera()}nudge(e,t){this.targetX+=e,this.targetY+=t,this.clampCamera()}clampCamera(){let e=this.host.clientWidth/Math.max(1,this.host.clientHeight),t=e>$/Nd?$/e:Nd,n=t*e/this.zoomTarget/2,r=t/this.zoomTarget/2;this.targetX=Bt.clamp(this.targetX,-Math.max(0,$/2-n),Math.max(0,$/2-n)),this.targetY=Bt.clamp(this.targetY,-Math.max(0,Nd/2-r),Math.max(0,Nd/2-r))}setQuality(e){this.quality=e,this.resize()}selectFish(e){this.selected=e,e===null&&this.onSelectedFish?.(null)}feedAt(){this.feeding=30;for(let e=0;e<16;e++){let e=new q(new ea(1.1,5),new Xr({color:10190402,transparent:!0,opacity:.85}));e.position.copy(this.pos(1e3+(this.random()-.5)*180,220+this.random()*25,3)),this.food.add(e)}}update(e,t,n,r,i){e=Number.isFinite(e)?Math.max(0,Math.min(e,.1)):0;let a=r||i?0:e;this.time+=a,this.flowPhase+=a*.015*n.flow/65,this.feeding=Math.max(0,this.feeding-a),this.selected===0&&this.fish[0]&&(this.targetX=this.fish[0].x-$/2,this.targetY=Nd/2-this.fish[0].y,this.clampCamera());let o=r?1:Math.min(1,e*3.2);this.zoomCurrent+=(this.zoomTarget-this.zoomCurrent)*o,this.centerX+=(this.targetX-this.centerX)*o,this.centerY+=(this.targetY-this.centerY)*o,this.camera.zoom=this.zoomCurrent,this.camera.position.set(this.centerX,this.centerY,250),this.camera.updateProjectionMatrix(),this.macroBlend+=(+(this.mode===`Biology`)-this.macroBlend)*o;let s=this.background.material.uniforms;s.time.value=this.time,s.flow.value+=(n.flow/100-s.flow.value)*(1-Math.exp(-e*4)),s.agitation.value+=(n.agitation/100-s.agitation.value)*(1-Math.exp(-e*4)),s.day.value=Math.min(1,Od(t,n)),s.algae.value=t.algae,s.biomass.value=t.biomass,s.macroBlend.value=this.macroBlend,this.dust.visible=this.mode!==`Biology`,this.bubbles.visible=this.mode!==`Biology`,this.food.visible=this.mode!==`Biology`;let c=this.dust.geometry.getAttribute(`position`);if(a){for(let e=0;e<c.count;e++){let t=c.getX(e),r=c.getY(e);t+=a*(r>50?-1:1)*(2+n.flow*.08),r+=Math.sin(this.time*.4+e)*a*.65,t<320-$/2&&(t=1280-$/2),t>1280-$/2&&(t=320-$/2),c.setXY(e,t,r)}c.needsUpdate=!0}this.roots.scale.y=.7+t.biomass*.3,this.roots.position.y=(Nd/2-578)*(1-this.roots.scale.y);let l=this.fish.map((e,t)=>({id:t,x:e.x,y:e.y,z:e.depth,vx:e.vx,vy:e.vy,radius:e.size*.68})).filter(e=>this.tetras.has(e.id)),u=ed(this.schoolRoute,a,l);for(let[e,n]of this.tetras){let r=this.fish[e];if(n){let i=n.swim;bd(i,a,this.feeding>0,t.oxygen<4,{food:this.food.children.map(e=>({id:e.id,z:.65,x:e.position.x+$/2,y:Nd/2-e.position.y})),neighbors:l.filter(t=>t.id!==e),schoolGoal:td(u,e)});let o=this.food.children.find(e=>e.id===i.brain.consumedFood);o instanceof q&&(this.food.remove(o),o.geometry.dispose(),o.material.dispose()),i.brain.consumedFood=null,r.x=i.x,r.y=i.y,r.vx=i.vx,r.vy=i.vy,r.turn=i.yaw,r.depth=i.z}}if(a){let e=[...this.tetras].map(([e])=>{let t=this.fish[e];return{id:e,x:t.x,y:t.y,z:t.depth,radius:t.size*.68}});nd(e);for(let t of e){let e=this.fish[t.id],n=this.tetras.get(t.id).swim;e.x=n.x=t.x,e.y=n.y=t.y,e.depth=n.z=t.z}}for(let e=0;e<this.fish.length;e++){let n=this.fish[e],r=n.species===3,i=this.tetras.get(e);if(n.mesh.visible=this.mode!==`Biology`&&!i,a>0&&!i){let i=r?[430,1280,563,619]:[350,1290,240,565];(Math.hypot(n.targetX-n.x,n.targetY-n.y)<45||Math.sin(this.time*.22+n.phase)>.997)&&(n.targetX=i[0]+this.random()*(i[1]-i[0]),n.targetY=i[2]+this.random()*(i[3]-i[2])),this.feeding&&!r&&(n.targetX=1e3+Math.sin(n.phase)*80,n.targetY=246+Math.sin(n.phase*2)*20);let o=!this.feeding&&Math.sin(this.time*.33+n.phase)>.88,s=(n.targetX-n.x)*.028,c=(n.targetY-n.y)*.028;o&&(n.vx*=Math.exp(-a*1.8),n.vy*=Math.exp(-a*1.8),s*=.12,c*=.12);for(let e of this.fish){if(n===e)continue;let t=e.x-n.x,i=e.y-n.y,a=Math.hypot(t,i);a<28&&a>0?(s-=t*.12,c-=i*.12):a<140&&n.species===e.species&&!r&&(s+=t*8e-4+(e.vx-n.vx)*.016,c+=i*7e-4+(e.vy-n.vy)*.016)}let l=r?1.1:n.species===2?this.feeding?17:9:(t.oxygen<4?9:18)*(this.feeding?1.5:1);n.vx+=s*a,n.vy+=c*a;let u=Math.hypot(n.vx,n.vy);u>l&&(n.vx*=l/u,n.vy*=l/u);let d=e===0?Math.max(0,Math.cos(n.turn)*(n.vx>=0?1:-1)):1;n.x=Bt.clamp(n.x+n.vx*a*d,i[0],i[1]),n.y=Bt.clamp(n.y+n.vy*a*(e===0?.25+.75*d:1),i[2],i[3])}if(!i){let e=n.vx>=0?0:Math.PI;n.turn+=(e-n.turn)*(1-Math.exp(-a*2.4))}n.mesh.position.copy(this.pos(n.x,n.y+Math.sin(this.time*1.1+n.phase)*.6,1+n.depth*180)),n.mesh.rotation.y=n.turn,n.mesh.scale.setScalar(.82+n.depth*.18),n.mesh.rotation.z=Bt.clamp(-n.vy*.008,-.15,.15)*(n.vx>0?1:-1);let o=n.mesh.material.uniforms;if(o.time.value=this.time+n.phase,o.sceneTime.value=this.time,o.flow.value=s.flow.value,o.photograph.value=this.photograph,o.depth.value=n.depth,o.light.value=s.day.value,o.activity.value=r?.08:Math.max(.22,Math.hypot(n.vx,n.vy)/18),i){let{model:e,swim:t}=i;e.group.visible=this.mode!==`Biology`,e.group.position.copy(this.pos(n.x,n.y,1+n.depth*180)),e.group.rotation.set(0,t.yaw+t.depthHeading,t.pitch,`YXZ`),e.group.scale.setScalar(n.size*(.72+n.depth*.48)),e.update(this.time,t.effort,this.photograph,s.flow.value,n.depth,s.day.value,a,t.pectoralEffort)}}for(let e=0;e<this.bubbleData.length;e++){let r=this.bubbleData[e];r.mesh.visible=e<(this.quality===`Performance`?24:62)&&(r.co2?n.co2>0&&s.day.value>.1:t.oxygen>8.35),a&&(r.y-=r.speed*a*(r.co2?Math.max(.2,n.co2/24):Math.max(.2,t.oxygen/8)),r.y<200&&(r.y=r.originY,r.x=r.originX));let i=(r.originY-r.y)/Math.max(1,r.originY-200),o=r.co2?Math.max(.12,.75*(1-i)):1+i*.1;r.mesh.scale.setScalar(o),r.mesh.position.copy(this.pos(r.x+Math.sin(this.time*.6+r.phase)*2+i*n.flow*.13,r.y,4))}for(let e of this.arrows){let t=Bt.euclideanModulo(this.flowPhase+e.phase,1);e.mesh.position.copy(e.path.getPointAt(t)),e.mesh.quaternion.setFromUnitVectors(new H(0,1,0),e.path.getTangentAt(t))}if(this.food.children.forEach(e=>{e.position.y-=a*4}),this.food.children.length)for(let e of this.food.children.filter(e=>Nd/2-e.position.y>560))e.geometry.dispose(),e.material.dispose(),this.food.remove(e);if(this.selected!==null&&this.time-this.lastReport>.5){this.lastReport=this.time;let e=this.fish[this.selected];e&&this.report(e,this.selected)}for(let e of this.markers){let t=this.pos(e.x,e.y,0).project(this.camera);e.button.style.left=(t.x+1)*.5*this.host.clientWidth+`px`,e.button.style.top=(1-t.y)*.5*this.host.clientHeight+`px`,e.button.hidden=this.mode!==`Living`||Math.abs(t.x)>.92||Math.abs(t.y)>.84}this.renderer.render(this.scene,this.camera)}report(e,t){let n=this.tetras.get(t)?.swim;this.onSelectedFish?.({id:t,species:[`Cardinal tetra · 3D school`,`Harlequin rasbora`,`Pearl gourami`,`Amano shrimp`][e.species],size:e.size,speed:Math.hypot(e.vx,e.vy),hunger:n?n.brain.hunger:0,energy:n?n.brain.energy:void 0,reason:n?n.brain.intent.reason:void 0,mood:n?xd(n):this.feeding?`Foraging`:e.species===3?`Grazing`:`Exploring`,preferredDepth:n?(e.y<310?`Upper water`:e.y>420?`Lower planting`:`Midwater`)+` / `+(e.depth>.68?`Near front glass`:e.depth<.32?`Back planting`:`Tank interior`):e.species===3?`Planted foreground`:`Midwater`})}world(e,t){let n=this.canvas.getBoundingClientRect(),r=new H((e-n.left)/n.width*2-1,-(t-n.top)/n.height*2+1,0);return r.unproject(this.camera),{x:r.x+$/2,y:Nd/2-r.y}}down=e=>{if(this.canvas.setPointerCapture(e.pointerId),this.pointers.set(e.pointerId,{x:e.clientX,y:e.clientY}),this.pointer={startX:e.clientX,startY:e.clientY,cx:this.targetX,cy:this.targetY,distance:0},this.pointers.size===2){let e=[...this.pointers.values()];this.pinch=Math.hypot(e[0].x-e[1].x,e[0].y-e[1].y),this.pinchZoom=this.zoomTarget}};move=e=>{if(!this.pointers.has(e.pointerId))return;if(this.pointers.set(e.pointerId,{x:e.clientX,y:e.clientY}),this.pointers.size===2){let e=[...this.pointers.values()];this.zoom(this.pinchZoom*Math.hypot(e[0].x-e[1].x,e[0].y-e[1].y)/Math.max(1,this.pinch)),this.pointer&&(this.pointer.distance=100);return}if(!this.pointer)return;let t=e.clientX-this.pointer.startX,n=e.clientY-this.pointer.startY;this.pointer.distance=Math.hypot(t,n);let r=(this.camera.right-this.camera.left)/(this.host.clientWidth*this.zoomCurrent);this.targetX=this.pointer.cx-t*r,this.targetY=this.pointer.cy+n*r,this.clampCamera()};up=e=>{if(this.pointer&&this.pointer.distance<8){let t=this.world(e.clientX,e.clientY),n=-1,r=1/0;this.fish.forEach((e,i)=>{let a=Math.hypot(t.x-e.x,t.y-e.y);a<Math.max(18,e.size*.5)&&a<r&&(n=i,r=a)}),n>=0?(this.selected=n,this.report(this.fish[n],n)):t.x>1340&&t.x<1540&&t.y>280&&t.y<720&&this.onInspect?.(`equipment`)}this.cancel(e)};cancel=e=>{this.pointers.delete(e.pointerId),this.pointer=null,this.canvas.hasPointerCapture(e.pointerId)&&this.canvas.releasePointerCapture(e.pointerId)};wheel=e=>{e.preventDefault(),this.zoom(this.zoomTarget*Math.exp(-e.deltaY*.001))};resize=()=>{let e=Math.max(1,this.host.clientWidth),t=Math.max(1,this.host.clientHeight),n=e/t,r=n>$/Nd?$/n:Nd;this.camera.left=-r*n/2,this.camera.right=r*n/2,this.camera.top=r/2,this.camera.bottom=-r/2,this.camera.updateProjectionMatrix(),this.renderer.setPixelRatio(Math.min(devicePixelRatio,this.quality===`Performance`?1:this.quality===`High`?1.5:2)),this.renderer.setSize(e,t),this.clampCamera()};capture(){this.renderer.render(this.scene,this.camera);let e=document.createElement(`a`);e.download=`living-aquascape.png`,e.href=this.canvas.toDataURL(`image/png`),e.click()}dispose(){this.destroyed=!0,window.removeEventListener(`resize`,this.resize),this.canvas.removeEventListener(`pointerdown`,this.down),this.canvas.removeEventListener(`pointermove`,this.move),this.canvas.removeEventListener(`pointerup`,this.up),this.canvas.removeEventListener(`pointercancel`,this.cancel),this.canvas.removeEventListener(`wheel`,this.wheel);let e=new Set,t=new Set;this.scene.traverse(n=>{(n instanceof q||n instanceof Ii||n instanceof Ki)&&(e.add(n.geometry),(Array.isArray(n.material)?n.material:[n.material]).forEach(e=>t.add(e)))}),e.forEach(e=>e.dispose()),t.forEach(e=>e.dispose()),this.sprites.forEach(e=>e.dispose()),this.photograph.dispose(),this.macro.dispose(),this.renderer.dispose(),this.canvas.remove(),this.markers.forEach(e=>e.button.remove())}},Ld=[`Living`,`Flow`,`Roots`,`Biology`,`Time-lapse`,`Equipment`],Rd={Living:[`A small world. A living balance.`,`Plants, fish and microbes share the same water. Look closely; each quiet movement belongs to a larger system.`,`Drag to look around · Scroll to look closer · Click a fish`],Flow:[`The water connects everything.`,`The outlet carries dissolved gases and nutrients through the planting. Cyan paths show the upper current; gold paths return below. These are illustrative streamlines, not a fluid solver.`,`Change filter flow to compare circulation`],Roots:[`Life beneath the surface.`,`Roots take up nutrients and exchange gases with the substrate. Deeper layers generally contain less oxygen. This front-plane teaching cutaway shows representative roots, rather than scanned anatomy.`,`Increase time speed to see the root zone expand`],Biology:[`A world within the water.`,`A leaf becomes a landscape. Inspect a grazing shrimp, delicate veins and oxygen pearls in this photographic macro study.`,`Choose a process to trace its role`],"Time-lapse":[`Some changes take time.`,`Gases respond over hours. Waste and nutrients shift over days. Plant mass, roots and algae respond over weeks. Accelerate the ecosystem to reveal those differences.`,`Playback accelerates chemistry; fish stay at a comfortable viewing speed`],Equipment:[`Follow the water through.`,`Mechanical foam traps solids. Biological media supports nitrifiers. The impeller returns water to the aquarium; a separate regulator meters carbon dioxide.`,`Inspect the canister, media and carbon supply`]},zd={"Nitrogen cycle":[`Food → waste → ammonia → nitrite → nitrate → plants`,`Microbes mineralize organic material. Ammonia-oxidizing organisms and nitrite oxidizers then convert dissolved nitrogen in two oxygen-consuming steps. Plants assimilate nitrogen; water changes export it. Readings use mg nitrogen/L.`],Photosynthesis:[`Light + CO₂ + water → sugars + O₂`,`Photosynthesis stores light energy in organic carbon. Visible pearling depends on local gas saturation and nucleation; bubbles alone cannot measure plant health.`],Respiration:[`Sugars + O₂ → CO₂ + water`,`Fish, plants and microbes respire during both day and night. When the light goes out, photosynthetic oxygen production stops but respiration continues.`],"Root uptake":[`Water column ↔ substrate ↔ roots`,`Substrate retains nutrients and supports roots and biofilms. Aquatic plants can also absorb nutrients through submerged leaves, with gas exchange across their surfaces.`],"Gill exchange":[`Water → gill surfaces → blood`,`Oxygen diffuses across thin gill surfaces while carbon dioxide moves out. Gas exchange depends on concentration gradients and ventilation; low oxygen can change activity.`],"Algae diagnosis":[`Observe the system before changing it`,`This model shows generic algae pressure. Real green spot algae, diatoms, hair algae and cyanobacteria have different causes. Assess plant health, carbon delivery, organic waste and maintenance rather than diagnosing from nitrate alone.`]},Bd={Intake:`Water enters through the intake strainer. Keep its openings clear so circulation can carry waste into the filter.`,"Mechanical foam":`Coarse and fine foam trap particles. Rinsing removes trapped solids; the foam also carries some biological growth.`,"Biological media":`Porous media provides wetted surfaces for biofilm. Nitrifying organisms consume oxygen while converting ammonia to nitrite and nitrate.`,"Impeller and outlet":`The impeller drives circulation. The lily pipe distributes returned water and shapes surface agitation.`,"CO₂ regulator":`The regulator reduces cylinder pressure; the metering valve and solenoid control delivery. The diffuser creates fine bubbles that dissolve into circulating water.`},Vd=[[`light`,`Light intensity`,0,100,1,`%`],[`photoperiod`,`Photoperiod`,2,16,1,`h`],[`co2`,`CO₂ supply setting`,0,45,1,`mg/L eq.`],[`flow`,`Filter flow`,0,100,1,`%`],[`agitation`,`Surface agitation`,0,100,1,`%`],[`temperature`,`Heater target`,18,30,.5,`°C`],[`feed`,`Daily feeding`,0,4,.25,`×`],[`fertilizer`,`Nutrient dosing`,0,3,.25,`×`],[`kh`,`Carbonate hardness`,1,10,.5,`dKH`]];function Hd(){let[e,t]=(0,l.useState)(!1),n=(0,l.useRef)(!1),r=()=>{n.current=!0,t(!0)},i=()=>{n.current=!1,t(!1)},a=(0,l.useRef)(null),o=(0,l.useRef)(null),s=(0,l.useRef)(wd()),c=(0,l.useRef)(Cd()),u=(0,l.useRef)(1),d=(0,l.useRef)(!1),f=(0,l.useRef)(!1),p=(0,l.useRef)(null),m=(0,l.useRef)(null),h=(0,l.useRef)(20),[g,_]=(0,l.useState)(`Living`),[v,y]=(0,l.useState)(``),[b,x]=(0,l.useState)(!1),[S,C]=(0,l.useState)(!1),[w,T]=(0,l.useState)(wd()),[E,D]=(0,l.useState)(Cd()),[O,k]=(0,l.useState)(Td[0]),[ee,te]=(0,l.useState)(Ed(Td[0]).explanation),[ne,A]=(0,l.useState)(1),[re,ie]=(0,l.useState)(!1),[j,M]=(0,l.useState)(!1),[ae,oe]=(0,l.useState)(!1),[se,ce]=(0,l.useState)(!1),[N,le]=(0,l.useState)(20),[ue,de]=(0,l.useState)(`High`),[fe,pe]=(0,l.useState)(`High`),[me,he]=(0,l.useState)(0),[ge,_e]=(0,l.useState)(null),[ve,ye]=(0,l.useState)(`Nitrogen cycle`),[be,xe]=(0,l.useState)(`Biological media`),[Se,Ce]=(0,l.useState)(``),[we,Te]=(0,l.useState)(`Gallery`),[Ee,De]=(0,l.useState)(!0),Oe=e=>{if(e===`3D tetra`){ke(`Living`),o.current?.focusPrototype(),Te(e);return}e===`Leaf macro`?ke(`Biology`):(g===`Biology`&&ke(`Living`),o.current?.selectFish(null),_e(null),o.current?.cameraPreset(e),Te(e))},ke=e=>{_(e),o.current?.setMode(e),_e(null),Te(e===`Equipment`?`Equipment`:e===`Roots`?`Root zone`:e===`Biology`?`Leaf macro`:`Gallery`)},Ae=e=>{u.current=e,A(e)},je=(e,t)=>{c.current={...c.current,[e]:t},D({...c.current})},Me=e=>{let t=Ed(e);s.current=t.state,c.current=t.environment,T({...t.state}),D({...t.environment}),k(e),te(t.explanation),Ae(e===Td[0]?1:3600)},Ne=e=>Ce(e);(0,l.useEffect)(()=>{if(!Se)return;let e=setTimeout(()=>Ce(``),4500);return()=>clearTimeout(e)},[Se]),(0,l.useEffect)(()=>{let e=matchMedia(`(prefers-reduced-motion: reduce)`).matches;f.current=e,M(e);let t=navigator.hardwareConcurrency<=4||innerWidth<700?`Performance`:`High`;pe(t);let i=t;try{i=localStorage.getItem(`living-aquascape-quality`)||t}catch{}[`Performance`,`High`,`Ultra`,`Photography`].includes(i)||(i=t),de(i);let l=!0,g=null;try{a.current&&(g=new Id(a.current),o.current=g,g.setQuality(i),g.onSelectedFish=_e,g.onInspect=e=>{e===`equipment`?r():ke(e===`roots`?`Roots`:`Biology`)},g.ready.then(()=>{l&&De(!1)}).catch(()=>{l&&(De(!1),y(`Some visual assets could not load. Reload to try again; the educational controls remain available.`))}))}catch{De(!1),y(`This browser cannot start WebGL. The static gallery and ecosystem controls remain available.`)}i===`Photography`&&(d.current=!0,ie(!0));let _=0,v=performance.now(),b=0,x=0,S=0,C=!1,w=e=>{let t=Math.max(0,(e-v)/1e3),r=Qu(e,v);if(v=e,n.current){_=requestAnimationFrame(w);return}d.current||kd(s.current,c.current,r*u.current/3600);let i=navigator.getGamepads?.()[0];if(i&&g){let e=Math.abs(i.axes[0]||0)>.15?i.axes[0]:0,t=Math.abs(i.axes[1]||0)>.15?i.axes[1]:0;g.nudge(e*r*200,-t*r*200),i.buttons[0]?.pressed&&!C&&(d.current=!d.current,ie(d.current)),C=!!i.buttons[0]?.pressed}g?.update(r,s.current,c.current,f.current,d.current),m.current&&p.current&&m.current.gain.setTargetAtTime(c.current.flow/100*.035*(h.current/20),p.current.currentTime,.3),x++,S+=t,e-b>500&&(T({...s.current}),he(S/x*1e3),x=0,S=0,b=e),_=requestAnimationFrame(w)};_=requestAnimationFrame(w);let E=e=>{if(n.current||e.target.matches(`input,select,button,textarea`))return;e.key===`Escape`&&oe(!1),e.key.toLowerCase()===`h`&&oe(e=>!e),e.code===`Space`&&(e.preventDefault(),d.current=!d.current,ie(d.current)),/^[1-6]$/.test(e.key)&&ke(Ld[Number(e.key)-1]);let t={ArrowLeft:[-35,0],ArrowRight:[35,0],ArrowUp:[0,35],ArrowDown:[0,-35]};t[e.key]&&(e.preventDefault(),g?.nudge(t[e.key][0],t[e.key][1])),(e.key===`+`||e.key===`=`)&&g?.zoom(g.camera.zoom*1.15),e.key===`-`&&g?.zoom(g.camera.zoom/1.15)};return window.addEventListener(`keydown`,E),()=>{l=!1,cancelAnimationFrame(_),window.removeEventListener(`keydown`,E),g?.dispose(),o.current=null,p.current?.close(),p.current=null}},[]),(0,l.useEffect)(()=>{let e=document.modelContext;if(!e?.registerTool)return;let t=new AbortController;try{Promise.resolve(e.registerTool({name:`load_aquascape_scenario`,description:`Reset the visible educational ecosystem to a named reproducible scenario.`,inputSchema:{type:`object`,properties:{scenario:{type:`string`,enum:[...Td]}},required:[`scenario`],additionalProperties:!1},annotations:{readOnlyHint:!1},execute:e=>{let t=e?.scenario;if(typeof t!=`string`||!Td.some(e=>e===t))throw Error(`Choose a listed aquarium scenario.`);return Me(t),{scenario:t,state:{...s.current}}}},{signal:t.signal})).catch(()=>{})}catch{}return()=>t.abort()},[]);let Pe=e=>{de(e);try{localStorage.setItem(`living-aquascape-quality`,e)}catch{}o.current?.setQuality(e),e===`Photography`&&(d.current=!0,ie(!0)),Ne(e===`Photography`?`Simulation paused. Frame your shot and save a PNG.`:e+` rendering selected.`)},P=async()=>{try{if(se){await p.current?.suspend(),ce(!1);return}if(!p.current){let e=new AudioContext;p.current=e;let t=e.createOscillator(),n=e.createGain(),r=e.createBiquadFilter();t.type=`sine`,t.frequency.value=60,n.gain.value=.012,r.type=`lowpass`,r.frequency.value=140;let i=e.createStereoPanner();i.pan.value=.5,t.connect(r).connect(n).connect(i).connect(e.destination),t.start();let a=e.createBuffer(1,e.sampleRate*2,e.sampleRate),o=a.getChannelData(0),s=237;for(let e=0;e<o.length;e++)s=s*1664525+1013904223>>>0,o[e]=(s/4294967296-.5)*.11;let c=e.createBufferSource(),l=e.createBiquadFilter();c.buffer=a,c.loop=!0,l.type=`lowpass`,l.frequency.value=450,c.connect(l).connect(n),c.start(),m.current=n}await p.current.resume(),ce(!0)}catch{Ne(`Audio could not start in this browser.`)}},Fe=()=>{d.current=!d.current,ie(d.current)},Ie=jd(w,E),Le=Md(w,E),F=Rd[g];return(0,Z.jsxs)(`main`,{className:`exhibit `+(ae?`clean`:``),children:[(0,Z.jsx)(`div`,{className:`tank`,ref:a}),Ee&&(0,Z.jsxs)(`div`,{className:`loading-poster`,children:[(0,Z.jsx)(`img`,{src:`./aquascape.png`,alt:`A planted aquarium in a dark gallery`}),(0,Z.jsx)(`p`,{role:`status`,children:`Bringing the aquascape to life…`})]}),v&&(0,Z.jsxs)(`div`,{className:`fallback`,children:[(0,Z.jsx)(`img`,{src:`./aquascape.png`,alt:`Concept artwork of a planted aquarium in a dark gallery`}),(0,Z.jsxs)(`p`,{children:[v,` Image: original photographic artwork.`]})]}),(0,Z.jsxs)(`header`,{className:`chrome`,children:[(0,Z.jsx)(`a`,{href:`../`,children:`← Demos`}),(0,Z.jsx)(`h1`,{children:`THE LIVING AQUASCAPE`}),(0,Z.jsxs)(`p`,{children:[(0,Z.jsx)(`i`,{}),` `,re?`TIME SUSPENDED`:Le>=80?`A SMALL WORLD, IN BALANCE`:`A LIVING SYSTEM, IN TRANSITION`]})]}),(0,Z.jsxs)(`div`,{className:`left-tools chrome`,children:[(0,Z.jsx)(`button`,{"aria-expanded":b,onClick:()=>x(!b),children:`☷ Environment`}),(0,Z.jsx)(`button`,{"aria-expanded":S,onClick:()=>C(!S),children:`◉ Chemistry`})]}),b&&(0,Z.jsxs)(`aside`,{className:`drawer chrome`,"aria-label":`Environmental controls`,children:[(0,Z.jsxs)(`div`,{className:`drawer-heading`,children:[(0,Z.jsx)(`h2`,{children:`Environment`}),(0,Z.jsx)(`button`,{"aria-label":`Close environmental controls`,onClick:()=>x(!1),children:`×`})]}),(0,Z.jsxs)(`label`,{className:`field`,children:[`Guided scenario`,(0,Z.jsx)(`select`,{value:O,onChange:e=>Me(e.target.value),children:Td.map(e=>(0,Z.jsx)(`option`,{children:e},e))})]}),(0,Z.jsx)(`p`,{children:ee}),Vd.map(([e,t,n,r,i,a])=>(0,Z.jsxs)(`label`,{className:`range`,children:[(0,Z.jsxs)(`span`,{children:[t,(0,Z.jsxs)(`output`,{children:[E[e],` `,a]})]}),(0,Z.jsx)(`input`,{type:`range`,min:n,max:r,step:i,value:E[e],onChange:t=>je(e,+t.target.value)})]},e)),(0,Z.jsxs)(`div`,{className:`pair`,children:[(0,Z.jsx)(`button`,{onClick:()=>{o.current?.feedAt(),s.current.waste+=.5,Ne(`Food added. Waste mineralizes gradually.`)},children:`Feed once`}),(0,Z.jsx)(`button`,{onClick:()=>{Ad(s.current),T({...s.current}),Ne(`30% of dissolved waste removed. Established algae remains.`)},children:`30% water change`}),(0,Z.jsx)(`button`,{onClick:()=>{s.current.biomass*=.7,Ne(`Plants trimmed by 30%. Observe new growth over days.`)},children:`Trim plants`}),(0,Z.jsx)(`button`,{onClick:()=>{s.current.algae*=.4,Ne(`Visible algae reduced by manual cleaning.`)},children:`Clean algae`})]}),(0,Z.jsxs)(`label`,{className:`field`,children:[`Rendering `,(0,Z.jsxs)(`small`,{children:[`Suggested: `,fe]}),(0,Z.jsx)(`select`,{value:ue,onChange:e=>Pe(e.target.value),children:[`Performance`,`High`,`Ultra`,`Photography`].map(e=>(0,Z.jsx)(`option`,{children:e},e))})]}),(0,Z.jsxs)(`label`,{className:`check`,children:[(0,Z.jsx)(`input`,{type:`checkbox`,checked:j,onChange:e=>{M(e.target.checked),f.current=e.target.checked}}),` Reduced motion`]}),(0,Z.jsx)(`button`,{onClick:()=>Me(Td[0]),children:`Restore balanced aquarium`})]}),(0,Z.jsxs)(`aside`,{className:`chemistry chrome`,"aria-label":`Live modeled readings`,children:[(0,Z.jsxs)(`span`,{children:[`♨ `,(0,Z.jsx)(`b`,{children:w.temperature.toFixed(1)}),` `,(0,Z.jsx)(`small`,{children:`°C`})]}),(0,Z.jsxs)(`span`,{children:[`pH `,(0,Z.jsx)(`b`,{children:w.ph.toFixed(2)}),(0,Z.jsx)(`small`,{children:` estimate`})]}),(0,Z.jsxs)(`span`,{children:[`CO₂ `,(0,Z.jsx)(`b`,{children:w.co2.toFixed(1)}),` `,(0,Z.jsx)(`small`,{children:`mg/L`})]}),(0,Z.jsxs)(`span`,{children:[`O₂ `,(0,Z.jsx)(`b`,{children:w.oxygen.toFixed(1)}),` `,(0,Z.jsx)(`small`,{children:`mg/L`})]}),(0,Z.jsxs)(`button`,{className:`balance`,onClick:()=>C(!S),"aria-expanded":S,children:[`BALANCE `,(0,Z.jsx)(`strong`,{children:Le}),(0,Z.jsx)(`small`,{children:`/ 100`})]})]}),S&&(0,Z.jsxs)(`aside`,{className:`chemistry-detail chrome`,children:[(0,Z.jsxs)(`div`,{className:`drawer-heading`,children:[(0,Z.jsx)(`h2`,{children:`Under the surface`}),(0,Z.jsx)(`button`,{"aria-label":`Close chemistry details`,onClick:()=>C(!1),children:`×`})]}),(0,Z.jsxs)(`p`,{children:[`Modeled water chemistry · 180 L`,(0,Z.jsx)(`br`,{}),`Dissolved nitrogen in mg N/L`]}),(0,Z.jsx)(`dl`,{children:[[`Ammonia-N`,w.ammonia.toFixed(3)],[`Nitrite-N`,w.nitrite.toFixed(3)],[`Nitrate-N`,w.nitrate.toFixed(2)],[`Plant biomass`,w.biomass.toFixed(2)+`×`],[`Algae cover`,(w.algae*100).toFixed(0)+`%`],[`Biofilter maturity`,(w.bacteria*100).toFixed(0)+`%`]].map(([e,t])=>(0,Z.jsxs)(`div`,{children:[(0,Z.jsx)(`dt`,{children:e}),(0,Z.jsx)(`dd`,{children:t})]},e))}),(0,Z.jsx)(`p`,{children:`Balance factors`}),Object.entries(Ie).map(([e,t])=>(0,Z.jsxs)(`label`,{className:`factor`,children:[e,(0,Z.jsx)(`meter`,{min:`0`,max:`1`,value:t})]},e)),(0,Z.jsx)(`small`,{children:`Carbonate-only pH estimate. Aquasoil, organic acids and non-carbonate buffers can invalidate this relationship in a real aquarium.`})]}),!b&&g!==`Equipment`&&(0,Z.jsxs)(`section`,{className:`story chrome`,children:[(0,Z.jsxs)(`p`,{className:`eyebrow`,children:[String(Ld.indexOf(g)+1).padStart(2,`0`),` / `,g.toUpperCase()]}),(0,Z.jsx)(`h2`,{children:F[0]}),(0,Z.jsx)(`p`,{children:F[1]}),(0,Z.jsx)(`small`,{children:F[2]}),(g===`Living`||g===`Flow`)&&(0,Z.jsxs)(`div`,{className:`range current-control`,role:`group`,"aria-label":`Water movement`,children:[(0,Z.jsxs)(`span`,{children:[`Water current`,(0,Z.jsxs)(`output`,{children:[E.flow,`%`]})]}),(0,Z.jsx)(`input`,{"aria-label":`Water current`,type:`range`,min:`0`,max:`100`,step:`1`,value:E.flow,onChange:e=>je(`flow`,+e.target.value)}),(0,Z.jsxs)(`span`,{children:[`Surface ripples`,(0,Z.jsxs)(`output`,{children:[E.agitation,`%`]})]}),(0,Z.jsx)(`input`,{"aria-label":`Surface ripples`,type:`range`,min:`0`,max:`100`,step:`1`,value:E.agitation,onChange:e=>je(`agitation`,+e.target.value)}),(0,Z.jsx)(`small`,{children:re?`Resume playback to see the plants sway.`:j?`Turn off Reduced motion in Environment to see the plants sway.`:`Watch the tall leaves bend; rooted bases stay still.`})]})]}),g===`Equipment`&&(0,Z.jsxs)(`section`,{className:`equipment-card chrome`,children:[(0,Z.jsx)(`p`,{className:`eyebrow`,children:`WATER, THROUGH THE SYSTEM`}),(0,Z.jsx)(`h2`,{children:`Inside the filter`}),(0,Z.jsx)(`button`,{onClick:r,children:`Open 3D filter breakdown ↗`}),(0,Z.jsx)(`div`,{className:`equipment-steps`,children:Object.keys(Bd).map((e,t)=>(0,Z.jsxs)(`button`,{"aria-pressed":be===e,onClick:()=>xe(e),children:[(0,Z.jsx)(`small`,{children:String(t+1).padStart(2,`0`)}),e,(0,Z.jsx)(`span`,{"aria-hidden":`true`,children:`→`})]},e))}),(0,Z.jsx)(`p`,{children:Bd[be]}),(0,Z.jsx)(`small`,{children:`Representative photographic equipment · functional inspection guide`})]}),g===`Biology`&&(0,Z.jsxs)(`section`,{className:`lesson chrome`,children:[(0,Z.jsxs)(`label`,{className:`field`,children:[`Look closer`,(0,Z.jsx)(`select`,{value:ve,onChange:e=>ye(e.target.value),children:Object.keys(zd).map(e=>(0,Z.jsx)(`option`,{children:e},e))})]}),(0,Z.jsx)(`h2`,{children:zd[ve][0]}),(0,Z.jsx)(`p`,{children:zd[ve][1]})]}),e&&(0,Z.jsx)(Zu,{onClose:i,reduced:j}),ge&&g===`Living`&&(0,Z.jsxs)(`section`,{className:`inspector chrome`,children:[(0,Z.jsx)(`button`,{"aria-label":`Close fish inspection`,onClick:()=>{o.current?.selectFish(null),_e(null)},children:`×`}),(0,Z.jsx)(`p`,{className:`eyebrow`,children:`LIVING COLLECTION`}),(0,Z.jsx)(`h2`,{children:ge.species}),(0,Z.jsxs)(`p`,{children:[ge.mood,` · `,ge.preferredDepth,(0,Z.jsx)(`br`,{}),ge.reason?ge.reason:`Fish seek food, maintain distance and respond to their school.`]}),ge.energy!==void 0&&(0,Z.jsxs)(`p`,{children:[`Appetite `,Math.round(ge.hunger*100),`% · Energy `,Math.round((ge.energy??0)*100),`%`,(0,Z.jsx)(`br`,{}),(0,Z.jsx)(`small`,{children:`Simulated needs`})]})]}),(0,Z.jsxs)(`div`,{className:`view-tools chrome`,children:[(0,Z.jsxs)(`label`,{children:[`Look closer`,(0,Z.jsx)(`select`,{"aria-label":`Camera framing`,value:we,onChange:e=>Oe(e.target.value),children:[`Gallery`,`Aquascape`,`Open water`,`Root zone`,`Equipment`,`Leaf macro`,`3D tetra`].map(e=>(0,Z.jsx)(`option`,{children:e},e))})]}),(0,Z.jsx)(`button`,{className:`prototype-control`,onClick:()=>Oe(`3D tetra`),children:`Inspect 3D tetra`}),(0,Z.jsx)(`button`,{"aria-label":`Zoom out`,onClick:()=>o.current?.zoom((o.current?.camera.zoom||1)/1.2),children:`−`}),(0,Z.jsx)(`button`,{"aria-label":`Zoom in`,onClick:()=>o.current?.zoom((o.current?.camera.zoom||1)*1.2),children:`+`}),(0,Z.jsx)(`button`,{onClick:()=>{ke(`Living`),x(!1),C(!1),_e(null)},children:`Reset view`}),(0,Z.jsx)(`button`,{onClick:()=>{o.current?.feedAt(),s.current.waste+=.5,d.current=!1,ie(!1),Ne(j?`Food added. Turn off Reduced motion to watch feeding.`:`Food added — watch the school gather near the surface.`)},children:`Feed fish`})]}),(0,Z.jsxs)(`div`,{className:`transport chrome`,children:[(0,Z.jsx)(`button`,{onClick:Fe,"aria-label":re?`Resume simulation`:`Pause simulation`,children:re?`▶`:`Ⅱ`}),(0,Z.jsxs)(`span`,{children:[`DAY `,Math.floor(w.hours/24)+1,` `,(0,Z.jsxs)(`b`,{children:[String(Math.floor((12+w.hours)%24)).padStart(2,`0`),`:`,String(Math.floor(w.hours*60)%60).padStart(2,`0`)]})]}),(0,Z.jsxs)(`select`,{"aria-label":`Ecosystem time speed`,value:ne,onChange:e=>Ae(+e.target.value),children:[(0,Z.jsx)(`option`,{value:1,children:`Real time`}),(0,Z.jsx)(`option`,{value:3600,children:`1 hour / sec`}),(0,Z.jsx)(`option`,{value:86400,children:`1 day / sec`})]}),g===`Time-lapse`&&(0,Z.jsx)(`button`,{onClick:()=>{kd(s.current,c.current,24),T({...s.current})},children:`+1 day`})]}),(0,Z.jsx)(`nav`,{className:`modes chrome`,"aria-label":`Exploration modes`,children:Ld.map(e=>(0,Z.jsx)(`button`,{"aria-pressed":g===e,onClick:()=>ke(e),children:e},e))}),(0,Z.jsxs)(`div`,{className:`photo-tools chrome`,children:[(0,Z.jsxs)(`button`,{onClick:()=>oe(!0),title:`Hide interface (H)`,children:[`◉ `,(0,Z.jsx)(`span`,{children:`Photo mode`})]}),(0,Z.jsx)(`button`,{onClick:()=>{o.current?(o.current.capture(),Ne(`Aquarium PNG saved.`)):Ne(`PNG capture requires the animated view.`)},children:`Save PNG`})]}),(0,Z.jsxs)(`div`,{className:`audio-tools chrome`,children:[(0,Z.jsx)(`button`,{"aria-pressed":se,onClick:P,children:se?`Sound on`:`Sound off`}),se&&(0,Z.jsxs)(`label`,{children:[`Volume`,(0,Z.jsx)(`input`,{"aria-label":`Environment volume`,type:`range`,min:`0`,max:`100`,value:N,onChange:e=>{let t=+e.target.value;le(t),h.current=t}})]}),(0,Z.jsxs)(`small`,{children:[me.toFixed(1),` ms / frame`]})]}),ae&&(0,Z.jsx)(`button`,{className:`restore`,onClick:()=>oe(!1),children:`Show controls · H / Esc`}),Se&&(0,Z.jsx)(`div`,{role:`status`,className:`toast`,children:Se}),(0,Z.jsx)(`a`,{className:`model-note chrome`,href:`./about.html`,target:`_blank`,rel:`noopener`,children:`Educational model · Methods & limits ↗`})]})}var Ud=document.getElementById(`root`);if(!Ud)throw Error(`Aquarium Laboratory could not find its application mount.`);(0,u.createRoot)(Ud).render((0,Z.jsx)(l.StrictMode,{children:(0,Z.jsx)(Hd,{})}));