...
window.NETMAP_DATA = {
  ...
  "nodes": [
    ...
    { "id": "router", "type": "router", "label": "Gateway", "tier": 1, "ip": "192.168.1.1", "linkMbps": 1000, "notes": "Default gateway; DHCP/client telemetry source" },

    { "id": "poe-switch", "type": "switch", "label": "PoE Switch", "tier": 2, "cluster": "core", "uplink": "router", "media": "ethernet", "linkMbps": 1000, "ip": "192.168.1.69", "notes": "PoE switch; exact downstream ports not exposed by router" },
    { "id": "managed-switch", "type": "switch", "label": "Managed Switch", "tier": 2, "cluster": "core", "uplink": "router", "media": "ethernet", "linkMbps": 1000, "ip": "192.168.1.24", "notes": "Identified from scan clues; downstream ports inferred" },
    { "id": "net-admin", "type": "switch", "label": "Network Admin Device", "tier": 2, "cluster": "core", "uplink": "router", "media": "ethernet", "linkMbps": 1000, "ip": "192.168.1.149", "notes": "Local web/admin page; role likely switch/infrastructure" },
    { "id": "extender", "type": "ap", "label": "Wi-Fi Extender", "tier": 2, "cluster": "mobile", "uplink": "router", "media": "ethernet", "linkMbps": 1000, "ip": "192.168.1.79", "notes": "Extender telemetry also reports extenderIp 192.168.1.199; current scan sees 192.168.1.79" },
    ...
    { "id": "s25-ultra", "type": "phone", "label": "jeff-s-S25-Ultra", "cluster": "mobile", "uplink": "extender", "media": "wifi", "linkMbps": 816, "profile": "phone", "ip": "192.168.1.108", "notes": "Extender client, 5 GHz Wi-Fi" },
    ...
    { "id": "geovision-cams", "type": "camera", "label": "GeoVision cameras x5", "cluster": "iot", "uplink": "poe-switch", "media": "ethernet", "linkMbps": 1000, "profile": "camera", "ip": "192.168.1.103", "notes": "Grouped wired GeoVision devices: .103, .104, .105, .112, .223" },
    { "id": "ring-devices", "type": "camera", "label": "Ring devices x9", "cluster": "iot", "uplink": "extender", "media": "wifi", "linkMbps": 130, "profile": "camera", "ip": "192.168.1.9", "notes": "Grouped Ring doorbell/cameras/chime; some associate through extender, some through router" },
    ...
    { "id": "amazon-iot", "type": "speaker", "label": "Amazon/Echo devices x5", "cluster": "iot", "uplink": "extender", "media": "wifi", "linkMbps": 130, "profile": "speaker", "ip": "192.168.1.35", "notes": "AmazonPlug26MR, Echo Show, AmazonAQM, and other Amazon smart-home/media clients" },
    ...
    { "id": "myq", "type": "plug", "label": "Chamberlain myQ", "cluster": "iot", "uplink": "extender", "media": "wifi", "linkMbps": 72, "profile": "iot-sensor", "ip": "192.168.1.147", "notes": "Garage door opener/controller; extender cache also shows .157" },
    ...
    { "id": "tesla-wall", "type": "plug", "label": "Tesla Wall Connector", "cluster": "iot", "uplink": "extender", "media": "wifi", "linkMbps": 54, "profile": "iot-sensor", "ip": "192.168.1.84", "notes": "EV charger, extender client" },
    { "id": "govee-devices", "type": "plug", "label": "Govee devices x3", "cluster": "iot", "uplink": "extender", "media": "wifi", "linkMbps": 72, "profile": "iot-sensor", "ip": "192.168.1.217", "notes": "Grouped Govee / Intellirocks smart-home devices observed around .217, .220, .250/.253" },
    ...
    { "id": "brother-printer", "type": "printer", "label": "Brother network printer", "cluster": "iot", "uplink": "extender", "media": "wifi", "linkMbps": 72, "profile": "printer", "ip": "192.168.1.184", "notes": "2.4 GHz Wi-Fi; extender cache also shows .193" },
