(function() {
  ...
  const showroomStyle=document.createElement('link');showroomStyle.rel='stylesheet';showroomStyle.href=new URL('showroom.css?v=primary-toolbar-1',reefAssetBase);document.head.append(showroomStyle);
