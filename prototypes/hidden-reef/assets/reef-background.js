(function() {
  ...
  const showroomStyle=document.createElement('link');showroomStyle.rel='stylesheet';showroomStyle.href=new URL('showroom.css?v=reef-motion-2',reefAssetBase);document.head.append(showroomStyle);
