/**
* ChannelStreamer is an AbstractTicker2 to be used to render additional data streams (e.g. internal
...
*/
/*
* note: The old Wiz based impl has been replaced with a new impl. The API is mostly backward compatible
