...
export const skyColors={night:{value:0},skyHorizon:{value:new T.Color(.66,.77,.86)},skyZenith:{value:new T.Color(.16,.36,.72)},sun:{value:new T.Vector3(0,1,0)},sunColor:{value:new T.Color(1,.9,.7)},fogColor:{value:new T.Color(.7,.78,.84)},fogDensity:{value:.0016}};
