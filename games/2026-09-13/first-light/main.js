...
function galleryShow(id,t){gal.id=id;gal.t=t;gal.lake=null;const L=lengthForSlider(SPECIES[id],t);setStudio(L,id);galleryUI.setActive(id);galleryUI.setSlider(t);galleryUI.setCard(galleryCard(id,L,journal));}
