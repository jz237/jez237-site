...
- **The body** (`fish-body.js`): a procedural bass for now (lofted body, fins, eyes, hinged jaw, olive back to white belly, the broken lateral band, wet sheen, spine-wave swimming). The Blender hero model replaces it in the next milestone.
