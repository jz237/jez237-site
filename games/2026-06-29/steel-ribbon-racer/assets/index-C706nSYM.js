...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function rf(n,e,t){const i=new Float32Array(Qn),r=new I(0,1,0);return new Pn({name:"SphericalGaussianBlur",defines:{n:Qn,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:Fr(),fragmentShader:`
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function oo(){return new Pn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Fr(),fragmentShader:`
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function co(){return new Pn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Fr(),fragmentShader:`
	...
	`}function sf(n){let e=new WeakMap,t=null;function i(o){if(o&&o.isTexture){const l=o.mapping,c=l===Ts||l===ws,u=l===Ti||l===wi;if(c||u){let h=e.get(o);const f=h!==void 0?h.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==f)return t===null&&(t=new so(n)),h=c?t.fromEquirectangular(o,h):t.fromCubemap(o,h),h.texture.pmremVersion=o.pmremVersion,e.set(o,h),h.texture;if(h!==void 0)return h.texture;{const p=o.image;return c&&p&&p.height>0||u&&p&&r(p)?(t===null&&(t=new so(n)),h=c?t.fromEquirectangular(o):t.fromCubemap(o),h.texture.pmremVersion=o.pmremVersion,e.set(o,h),o.addEventListener("dispose",s),h.texture):null}}}return o}function r(o){let l=0;const c=6;for(let u=0;u<c;u++)o[u]!==void 0&&l++;return l===c}function s(o){const l=o.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:i,dispose:a}}function af(n){const e={};function t(i){if(e[i]!==void 0)return e[i];const r=n.getExtension(i);return e[i]=r,r}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const r=t(i);return r===null&&Yi("WebGLRenderer: "+i+" extension not supported."),r}}}function of(n,e,t,i){const r={},s=new WeakMap;function a(h){const f=h.target;f.index!==null&&e.remove(f.index);for(const x in f.attributes)e.remove(f.attributes[x]);f.removeEventListener("dispose",a),delete r[f.id];const p=s.get(f);p&&(e.remove(p),s.delete(f)),i.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function o(h,f){return r[f.id]===!0||(f.addEventListener("dispose",a),r[f.id]=!0,t.memory.geometries++),f}function l(h){const f=h.attributes;for(const p in f)e.update(f[p],n.ARRAY_BUFFER)}function c(h){const f=[],p=h.index,x=h.attributes.position;let S=0;if(p!==null){const b=p.array;S=p.version;for(let y=0,T=b.length;y<T;y+=3){const R=b[y+0],E=b[y+1],P=b[y+2];f.push(R,E,E,P,P,R)}}else if(x!==void 0){const b=x.array;S=x.version;for(let y=0,T=b.length/3-1;y<T;y+=3){const R=y+0,E=y+1,P=y+2;f.push(R,E,E,P,P,R)}}else return;const m=new($o(f)?Qo:Jo)(f,1);m.version=S;const d=s.get(h);d&&e.remove(d),s.set(h,m)}function u(h){const f=s.get(h);if(f){const p=h.index;p!==null&&f.version<p.version&&c(h)}else c(h);return s.get(h)}return{get:o,update:l,getWireframeAttribute:u}}function cf(n,e,t){let i;function r(f){i=f}let s,a;function o(f){s=f.type,a=f.bytesPerElement}function l(f,p){n.drawElements(i,p,s,f*a),t.update(p,i,1)}function c(f,p,x){x!==0&&(n.drawElementsInstanced(i,p,s,f*a,x),t.update(p,i,x))}function u(f,p,x){if(x===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,p,0,s,f,0,x);let m=0;for(let d=0;d<x;d++)m+=p[d];t.update(m,i,1)}function h(f,p,x,S){if(x===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let d=0;d<f.length;d++)c(f[d]/a,p[d],S[d]);else{m.multiDrawElementsInstancedWEBGL(i,p,0,s,f,0,S,0,x);let d=0;for(let b=0;b<x;b++)d+=p[b]*S[b];t.update(d,i,1)}}this.setMode=r,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function lf(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,a,o){switch(t.calls++,a){case n.TRIANGLES:t.triangles+=o*(s/3);break;case n.LINES:t.lines+=o*(s/2);break;case n.LINE_STRIP:t.lines+=o*(s-1);break;case n.LINE_LOOP:t.lines+=o*s;break;case n.POINTS:t.points+=o*s;break;default:vt("WebGLInfo: Unknown draw mode:",a);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:i}}function df(n,e,t){const i=new WeakMap,r=new _t;function s(a,o,l){const c=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,h=u!==void 0?u.length:0;let f=i.get(o);if(f===void 0||f.count!==h){let g=function(){D.dispose(),i.delete(o),o.removeEventListener("dispose",g)};var p=g;f!==void 0&&f.texture.dispose();const x=o.morphAttributes.position!==void 0,S=o.morphAttributes.normal!==void 0,m=o.morphAttributes.color!==void 0,d=o.morphAttributes.position||[],b=o.morphAttributes.normal||[],y=o.morphAttributes.color||[];let T=0;x===!0&&(T=1),S===!0&&(T=2),m===!0&&(T=3);let R=o.attributes.position.count*T,E=1;R>e.maxTextureSize&&(E=Math.ceil(R/e.maxTextureSize),R=e.maxTextureSize);const P=new Float32Array(R*E*4*h),D=new Ko(P,R,E,h);D.type=Tn,D.needsUpdate=!0;const M=T*4;for(let C=0;C<h;C++){const F=d[C],G=b[C],q=y[C],X=R*E*4*C;for(let k=0;k<F.count;k++){const Z=k*M;x===!0&&(r.fromBufferAttribute(F,k),P[X+Z+0]=r.x,P[X+Z+1]=r.y,P[X+Z+2]=r.z,P[X+Z+3]=0),S===!0&&(r.fromBufferAttribute(G,k),P[X+Z+4]=r.x,P[X+Z+5]=r.y,P[X+Z+6]=r.z,P[X+Z+7]=0),m===!0&&(r.fromBufferAttribute(q,k),P[X+Z+8]=r.x,P[X+Z+9]=r.y,P[X+Z+10]=r.z,P[X+Z+11]=q.itemSize===4?r.w:1)}}f={count:h,texture:D,size:new $e(R,E)},i.set(o,f),o.addEventListener("dispose",g)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(n,"morphTexture",a.morphTexture,t);else{let x=0;for(let m=0;m<c.length;m++)x+=c[m];const S=o.morphTargetsRelative?1:1-x;l.getUniforms().setValue(n,"morphTargetBaseInfluence",S),l.getUniforms().setValue(n,"morphTargetInfluences",c)}l.getUniforms().setValue(n,"morphTargetsTexture",f.texture,t),l.getUniforms().setValue(n,"morphTargetsTextureSize",f.size)}return{update:s}}function uf(n,e,t,i){let r=new WeakMap;function s(l){const c=i.render.frame,u=l.geometry,h=e.get(l,u);if(r.get(h)!==c&&(e.update(h),r.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),r.get(l)!==c&&(t.update(l.instanceMatrix,n.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,n.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const f=l.skeleton;r.get(f)!==c&&(f.update(),r.set(f,c))}return h}function a(){r=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:a}}const cc=new Lt,lo=new ic(1,1),lc=new Ko,dc=new Ul,uc=new nc,uo=[],ho=[],fo=new Float32Array(16),po=new Float32Array(9),mo=new Float32Array(4);function Li(n,e,t){const i=n[0];if(i<=0||i>0)return n;const r=e*t;let s=uo[r];if(s===void 0&&(s=new Float32Array(r),uo[r]=s),e!==0){i.toArray(s,0);for(let a=1,o=0;a!==e;++a)o+=t,n[a].toArray(s,o)}return s}function yt(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function Et(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function Or(n,e){let t=ho[e];t===void 0&&(t=new Int32Array(e),ho[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function hf(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function ff(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(yt(t,e))return;n.uniform2fv(this.addr,e),Et(t,e)}}function pf(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(yt(t,e))return;n.uniform3fv(this.addr,e),Et(t,e)}}function mf(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(yt(t,e))return;n.uniform4fv(this.addr,e),Et(t,e)}}function xf(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(yt(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),Et(t,e)}else{if(yt(t,i))return;mo.set(i),n.uniformMatrix2fv(this.addr,!1,mo),Et(t,i)}}function gf(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(yt(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),Et(t,e)}else{if(yt(t,i))return;po.set(i),n.uniformMatrix3fv(this.addr,!1,po),Et(t,i)}}function _f(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(yt(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),Et(t,e)}else{if(yt(t,i))return;fo.set(i),n.uniformMatrix4fv(this.addr,!1,fo),Et(t,i)}}function vf(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function Mf(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(yt(t,e))return;n.uniform2iv(this.addr,e),Et(t,e)}}function Sf(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(yt(t,e))return;n.uniform3iv(this.addr,e),Et(t,e)}}function bf(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(yt(t,e))return;n.uniform4iv(this.addr,e),Et(t,e)}}function yf(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function Ef(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(yt(t,e))return;n.uniform2uiv(this.addr,e),Et(t,e)}}function Tf(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(yt(t,e))return;n.uniform3uiv(this.addr,e),Et(t,e)}}function wf(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(yt(t,e))return;n.uniform4uiv(this.addr,e),Et(t,e)}}function Af(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r);let s;this.type===n.SAMPLER_2D_SHADOW?(lo.compareFunction=Yo,s=lo):s=cc,t.setTexture2D(e||s,r)}function Rf(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture3D(e||dc,r)}function Cf(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTextureCube(e||uc,r)}function Pf(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture2DArray(e||lc,r)}function Df(n){switch(n){case 5126:return hf;case 35664:return ff;case 35665:return pf;case 35666:return mf;case 35674:return xf;case 35675:return gf;case 35676:return _f;case 5124:case 35670:return vf;case 35667:case 35671:return Mf;case 35668:case 35672:return Sf;case 35669:case 35673:return bf;case 5125:return yf;case 36294:return Ef;case 36295:return Tf;case 36296:return wf;case 35678:case 36198:case 36298:case 36306:case 35682:return Af;case 35679:case 36299:case 36307:return Rf;case 35680:case 36300:case 36308:case 36293:return Cf;case 36289:case 36303:case 36311:case 36292:return Pf}}function Lf(n,e){n.uniform1fv(this.addr,e)}function Uf(n,e){const t=Li(e,this.size,2);n.uniform2fv(this.addr,t)}function If(n,e){const t=Li(e,this.size,3);n.uniform3fv(this.addr,t)}function Nf(n,e){const t=Li(e,this.size,4);n.uniform4fv(this.addr,t)}function Ff(n,e){const t=Li(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function Of(n,e){const t=Li(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function Bf(n,e){const t=Li(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function Vf(n,e){n.uniform1iv(this.addr,e)}function zf(n,e){n.uniform2iv(this.addr,e)}function Gf(n,e){n.uniform3iv(this.addr,e)}function kf(n,e){n.uniform4iv(this.addr,e)}function Hf(n,e){n.uniform1uiv(this.addr,e)}function Wf(n,e){n.uniform2uiv(this.addr,e)}function Xf(n,e){n.uniform3uiv(this.addr,e)}function qf(n,e){n.uniform4uiv(this.addr,e)}function Yf(n,e,t){const i=this.cache,r=e.length,s=Or(t,r);yt(i,s)||(n.uniform1iv(this.addr,s),Et(i,s));for(let a=0;a!==r;++a)t.setTexture2D(e[a]||cc,s[a])}function $f(n,e,t){const i=this.cache,r=e.length,s=Or(t,r);yt(i,s)||(n.uniform1iv(this.addr,s),Et(i,s));for(let a=0;a!==r;++a)t.setTexture3D(e[a]||dc,s[a])}function Kf(n,e,t){const i=this.cache,r=e.length,s=Or(t,r);yt(i,s)||(n.uniform1iv(this.addr,s),Et(i,s));for(let a=0;a!==r;++a)t.setTextureCube(e[a]||uc,s[a])}function Zf(n,e,t){const i=this.cache,r=e.length,s=Or(t,r);yt(i,s)||(n.uniform1iv(this.addr,s),Et(i,s));for(let a=0;a!==r;++a)t.setTexture2DArray(e[a]||lc,s[a])}function jf(n){switch(n){case 5126:return Lf;case 35664:return Uf;case 35665:return If;case 35666:return Nf;case 35674:return Ff;case 35675:return Of;case 35676:return Bf;case 5124:case 35670:return Vf;case 35667:case 35671:return zf;case 35668:case 35672:return Gf;case 35669:case 35673:return kf;case 5125:return Hf;case 36294:return Wf;case 36295:return Xf;case 36296:return qf;case 35678:case 36198:case 36298:case 36306:case 35682:return Yf;case 35679:case 36299:case 36307:return $f;case 35680:case 36300:case 36308:case 36293:return Kf;case 36289:case 36303:case 36311:case 36292:return Zf}}class Jf{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=Df(t.type)}}class Qf{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=jf(t.type)}}class ep{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(e,t[o.id],i)}}}const ps=/(\w+)(\])?(\[|\.)?/g;function xo(n,e){n.seq.push(e),n.map[e.id]=e}function tp(n,e,t){const i=n.name,r=i.length;for(ps.lastIndex=0;;){const s=ps.exec(i),a=ps.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===r){xo(t,c===void 0?new Jf(o,n,e):new Qf(o,n,e));break}else{let h=t.map[o];h===void 0&&(h=new ep(o),xo(t,h)),t=h}}}class Rr{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<i;++r){const s=e.getActiveUniform(t,r),a=e.getUniformLocation(t,s.name);tp(s,a,this)}}setValue(e,t,i,r){const s=this.map[t];s!==void 0&&s.setValue(e,i,r)}setOptional(e,t,i){const r=t[i];r!==void 0&&this.setValue(e,i,r)}static upload(e,t,i,r){for(let s=0,a=t.length;s!==a;++s){const o=t[s],l=i[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,r)}}static seqWithValue(e,t){const i=[];for(let r=0,s=e.length;r!==s;++r){const a=e[r];a.id in t&&i.push(a)}return i}}function go(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const np=37297;let ip=0;function rp(n,e){const t=n.split(`
`),i=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let a=r;a<s;a++){const o=a+1;i.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return i.join(`
`)}const _o=new Oe;function sp(n){Je._getMatrix(_o,Je.workingColorSpace,n);const e=`mat3( ${_o.elements.map(t=>t.toFixed(4))} )`;switch(Je.getTransfer(n)){case Dr:return[e,"LinearTransferOETF"];case nt:return[e,"sRGBTransferOETF"];default:return Ne("WebGLProgram: Unsupported color space: ",n),[e,"LinearTransferOETF"]}}function vo(n,e,t){const i=n.getShaderParameter(e,n.COMPILE_STATUS),s=(n.getShaderInfoLog(e)||"").trim();if(i&&s==="")return"";const a=/ERROR: 0:(\d+)/.exec(s);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`
...
`)}function op(n,e){let t;switch(e){case Yc:t="Linear";break;case $c:t="Reinhard";break;case Kc:t="Cineon";break;case Oo:t="ACESFilmic";break;case jc:t="AgX";break;case Jc:t="Neutral";break;case Zc:t="Custom";break;default:Ne("WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Mr=new I;function cp(){Je.getLuminanceCoefficients(Mr);const n=Mr.x.toFixed(4),e=Mr.y.toFixed(4),t=Mr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function lp(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Vi).join(`
`)}function dp(n){const e=[];for(const t in n){const i=n[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function up(n,e){const t={},i=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let r=0;r<i;r++){const s=n.getActiveAttrib(e,r),a=s.name;let o=1;s.type===n.FLOAT_MAT2&&(o=2),s.type===n.FLOAT_MAT3&&(o=3),s.type===n.FLOAT_MAT4&&(o=4),t[a]={type:s.type,location:n.getAttribLocation(e,a),locationSize:o}}return t}function Vi(n){return n!==""}function Mo(n,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function So(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const hp=/^[ \t]*#include +<([\w\d./]+)>/gm;function na(n){return n.replace(hp,pp)}const fp=new Map;function pp(n,e){let t=Be[e];if(t===void 0){const i=fp.get(e);if(i!==void 0)t=Be[i],Ne('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return na(t)}const mp=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function bo(n){return n.replace(mp,xp)}function xp(n,e,t,i){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=i.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function yo(n){let e=`precision ${n.precision} float;
...
#define LOW_PRECISION`),e}function gp(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===Io?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===No?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===yn&&(e="SHADOWMAP_TYPE_VSM"),e}function _p(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Ti:case wi:e="ENVMAP_TYPE_CUBE";break;case Nr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function vp(n){let e="ENVMAP_MODE_REFLECTION";return n.envMap&&n.envMapMode===wi&&(e="ENVMAP_MODE_REFRACTION"),e}function Mp(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case Fo:e="ENVMAP_BLENDING_MULTIPLY";break;case Xc:e="ENVMAP_BLENDING_MIX";break;case qc:e="ENVMAP_BLENDING_ADD";break}return e}function Sp(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function bp(n,e,t,i){const r=n.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=gp(t),c=_p(t),u=vp(t),h=Mp(t),f=Sp(t),p=lp(t),x=dp(s),S=r.createProgram();let m,d,b=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
  ...
  `,ze.result.classList.remove("hidden")}function Do(n="Craned back to the ribbon"){const e=bt(A.lastSafeS);A.s=A.lastSafeS,A.totalDistance=A.lastSafeDistance,A.lateral=0,A.lateralVel=0,A.y=e.p.y+2.1,A.yVel=0,A.speed=Math.max(16,A.speed*.32),A.grounded=!0,A.cameraShake=1.2,A.message=n,A.messageTimer=1.4,A.recoveries+=1}function M0(n){if(A.mode!=="race")return;A.time+=n;const e=Math.max(gt.has("KeyW")||gt.has("ArrowUp")?1:0,je.throttle),t=Math.max(gt.has("KeyS")||gt.has("ArrowDown")?1:0,je.brake),i=on.clamp((gt.has("KeyD")||gt.has("ArrowRight")?1:0)-(gt.has("KeyA")||gt.has("ArrowLeft")?1:0)+je.steer,-1,1),r=e>.03,s=(gt.has("ShiftLeft")||gt.has("ShiftRight"))&&A.boost>.02&&r&&A.grounded,a=bt(A.s),o=a.p.y+2.1;e>.03&&(A.speed+=(s?52:31)*e*n),t>.03&&(A.speed-=58*t*n),A.speed-=(.015*A.speed*A.speed+(A.grounded?2.4:.4))*n,A.speed=on.clamp(A.speed,0,156-A.damage*.42),s?(A.boost=Math.max(0,A.boost-n*.21),A.score+=28*n):A.boost=Math.min(1,A.boost+n*(A.grounded?.045:.018)),A.lateralVel+=i*A.speed*.52*n,A.lateralVel-=A.lateralVel*(A.grounded?2.8:.55)*n,A.lateral+=A.lateralVel*n;const l=Ir(A.s),c=Math.abs(A.lateral)<ce.width*.52,u=!l&&c;if(A.grounded&&(!u||Math.abs(A.lateral)>ce.width*.5)&&(A.grounded=!1,A.yVel=a.grade>0?Math.max(7,A.speed*Math.sin(a.grade)*.55):2,c||(A.message="Edge slip")),A.grounded){const p=Math.sin(A.time*18)*Math.min(.22,A.speed/700);A.y=on.lerp(A.y,o+p,.5),A.yVel=0,A.lastSafeS=A.s,A.lastSafeDistance=A.totalDistance,A.score+=A.speed*n*.34,Math.abs(A.lateral)>ce.width*.42&&(A.damage+=n*(1.2+A.speed*.035),A.cameraShake=Math.max(A.cameraShake,.24),A.nearMisses+=n*.8,Math.random()<n*5&&Po(a.p.clone().addScaledVector(a.side,Math.sign(A.lateral)*ce.width*.55).addScaledVector(jt,1.2),4))}else{A.yVel-=31*n,A.y+=A.yVel*n,A.airtime+=n,A.score+=n*11;const p=bt(A.s),x=p.p.y+2.1;if(!Ir(A.s)&&Math.abs(A.lateral)<ce.width*.55&&A.y<=x&&A.yVel<0){const m=-A.yVel,d=Math.abs(A.lateral)<ce.width*.34&&m<30;A.y=x,A.grounded=!0,A.yVel=0,A.lastSafeS=A.s,A.lastSafeDistance=A.totalDistance,A.damage+=Math.max(0,m-17)*.82+Math.max(0,Math.abs(A.lateral)-ce.width*.36)*1.8,A.score+=d?260+A.airtime*85:Math.max(30,120-m),A.cameraShake=Math.max(A.cameraShake,m/34),A.message=d?"Clean landing":"Hard landing",A.messageTimer=.9,d?A.cleanLandings+=1:A.hardLandings+=1,g0(m),Po(p.p.clone().addScaledVector(p.side,A.lateral).addScaledVector(jt,.7),d?7:24),A.airtime=0}A.y<-55&&(A.damage+=28,Do("Track crew recovery"))}const h=A.totalDistance;A.totalDistance+=A.speed*n,A.s=(A.totalDistance%ce.length+ce.length)%ce.length;const f=Math.floor(A.totalDistance/ce.length)+1;if(f>A.lap){const p=A.time-A.lapStartTime;A.splitTimes.push(p),A.bestLap=Math.min(A.bestLap,p),A.lapStartTime=A.time,A.lap=f,A.score+=1200,A.message=A.lap<=ce.laps?`Lap ${A.lap}`:"Season race complete",A.messageTimer=1.4,!A.practice&&A.lap>ce.laps&&Pr(A.totalDistance>=A.rivalDistance?"You took the chequered gantry.":"You finished behind Crowther."),A.practice&&A.lap>1&&Pr("Practice complete.")}for(const p of ce.gaps)n0(h,A.totalDistance,p.start)&&(A.message=p.name,A.messageTimer=1.1,A.grounded&&(A.grounded=!1,A.yVel=Math.max(12,A.speed*.18)));A.damage=on.clamp(A.damage,0,100),A.damage>=100&&Pr("The chassis gave up."),gt.has("KeyR")&&(A.damage=Math.min(99,A.damage+8),Do("Manual reset"),gt.delete("KeyR"))}function S0(n){const e=A.practice?0:Math.sin(A.time*.7)*8+4;A.mode==="race"&&!A.practice&&(A.rivalDistance+=(A.rivalSpeed+e)*n,A.rivalDistance>=ce.length*ce.laps&&A.lap<=ce.laps&&Pr("Crowther reached the gantry first.")),A.rivalS=(A.rivalDistance%ce.length+ce.length)%ce.length;const t=bt(A.rivalS),i=t.p.clone().addScaledVector(jt,1.4).addScaledVector(t.side,Math.sin(A.rivalS*.02)*1.4);ms.position.copy(i);const r=new ut().makeBasis(t.side,jt,t.tangent);ms.quaternion.setFromRotationMatrix(r);const s=Math.abs(A.rivalDistance-A.totalDistance)<26;ms.visible=(A.mode==="race"||A.mode==="paused")&&!A.practice&&!s}function pc(n){const e=bt(A.s),t=e.side.clone().multiplyScalar(A.lateral),i=e.p.clone().add(t);i.y=A.y;const r=A.cameraShake;r>.01&&(i.x+=(Math.random()-.5)*r*.8,i.y+=(Math.random()-.5)*r*.45),Ft.position.copy(i);const s=68+Math.min(10,A.speed*.055)+(gt.has("ShiftLeft")||gt.has("ShiftRight")?3:0);Math.abs(Ft.fov-s)>.02&&(Ft.fov+=(s-Ft.fov)*(1-Math.pow(.004,n)),Ft.updateProjectionMatrix());const a=bt(A.s+34+A.speed*.16),o=a.p.clone().addScaledVector(a.side,A.lateral*.45);o.y+=1.7+Math.sin(A.time*8)*Math.min(.2,A.speed/680),vi.position.copy(Ft.position),vi.lookAt(o),vi.rotateY(Math.PI),vi.rotateZ(-e.bank*.72-A.lateralVel*.006),vi.rotateX(e.grade*.18+(A.grounded?0:on.clamp(A.yVel,-30,30)*-.006)),Ft.quaternion.slerp(vi.quaternion,1-Math.pow(8e-4,n)),A.cameraShake=Math.max(0,A.cameraShake-n*1.9);const l=t0.set(0,0,-1).applyQuaternion(Ft.quaternion).normalize();window.__steelRibbonTelemetry={mode:A.mode,s:A.s,totalDistance:A.totalDistance,rivalDistance:A.rivalDistance,speed:A.speed,lap:A.lap,score:A.score,damage:A.damage,input:{steer:je.steer,throttle:je.throttle,brake:je.brake},forwardWorld:{x:e.tangent.x,y:e.tangent.y,z:e.tangent.z},cameraWorld:{x:l.x,y:l.y,z:l.z}}}function mc(){const n=Ro(A.practice?A.totalDistance%ce.length:A.totalDistance),e=A.practice?0:Ro(A.rivalDistance),t=A.practice?"SOLO":A.totalDistance>=A.rivalDistance?"P1":"P2";t!==A.leadState&&A.mode==="race"&&(A.leadState=t,A.practice||(A.message=t==="P1"?"You took the lead":"Crowther ahead",A.messageTimer=.95)),ze.speed.textContent=String(Math.round(A.speed*2.25)).padStart(3,"0"),ze.boost.style.width=`${Math.round(A.boost*100)}%`,ze.damage.style.width=`${Math.round(A.damage)}%`,ze.lap.textContent=`${Math.min(A.lap,ce.laps)}/${ce.laps}`,ze.timer.textContent=ra(A.time),ze.score.textContent=`Score ${Math.round(A.score)}`,ze.position.textContent=A.practice?"PRACTICE":`${t} DIV 4`,ze.hud.style.display=A.mode==="race"||A.mode==="paused"?"flex":"none",ze.raceStrip.style.display=A.mode==="race"||A.mode==="paused"?"grid":"none",ze.touchControls.style.display=A.mode==="race"||A.mode==="paused"?"":"none",ze.playerProgress.style.width=`${Math.round(n*100)}%`,ze.rivalProgress.style.width=`${Math.round(e*100)}%`,ze.needle.style.transform=`rotate(${on.lerp(-68,68,Math.min(1,A.speed/150))}deg)`,ze.speedFx.style.opacity=Math.max(0,Math.min(.18,(A.speed-44)/150)),ze.damageFx.style.opacity=A.damage<18?0:Math.min(.72,(A.damage-18)/82),A.mode==="paused"?(ze.centerMessage.textContent="Paused",ze.centerMessage.classList.remove("hidden")):A.messageTimer>0?(ze.centerMessage.textContent=A.message,ze.centerMessage.classList.remove("hidden")):ze.centerMessage.classList.add("hidden")}function ra(n){const e=Math.floor(n/60),t=n-e*60;return`${String(e).padStart(2,"0")}:${t.toFixed(1).padStart(4,"0")}`}function xc(){const n=e0.getDelta(),e=Math.min(.033,n);A.messageTimer>0&&(A.messageTimer-=e),M0(e),S0(e),pc(e),_0(e),mc(),v0(e),cn.render(rt,Ft),requestAnimationFrame(xc)}window.addEventListener("keydown",n=>{gt.add(n.code),["ArrowUp","ArrowDown","ArrowLeft","ArrowRight","Space"].includes(n.code)&&n.preventDefault(),n.code==="KeyP"&&A.mode==="race"?(A.mode="paused",gt.clear(),sa()):n.code==="KeyP"&&A.mode==="paused"?A.mode="race":n.code==="Escape"&&(A.mode==="race"||A.mode==="paused")&&(A.mode="menu",sa(),ze.menu.classList.remove("hidden"))});window.addEventListener("keyup",n=>gt.delete(n.code));window.addEventListener("resize",()=>{Ft.aspect=window.innerWidth/window.innerHeight,Ft.updateProjectionMatrix(),cn.setSize(window.innerWidth,window.innerHeight)});ze.startBtn.addEventListener("click",()=>va(!1));ze.practiceBtn.addEventListener("click",()=>va(!0));ze.againBtn.addEventListener("click",()=>va(!1));function gc(n){n&&(n.classList.remove("active"),n.style.setProperty("--stick-x","0px"),n.style.setProperty("--stick-y","0px"))}function sa(){je.steer=0,je.throttle=0,je.brake=0,je.steerPointer=null,je.drivePointer=null;for(const n of ze.touchControls.querySelectorAll(".touch-stick"))gc(n)}function yr(n,e){const t=n.getBoundingClientRect(),i=Math.min(t.width,t.height)*.36,r=on.clamp(e.clientX-(t.left+t.width/2),-i,i),s=on.clamp(e.clientY-(t.top+t.height/2),-i,i),a=n.dataset.stick;if(n.classList.add("active"),a==="steer")je.steer=on.clamp(r/i,-1,1),n.style.setProperty("--stick-x",`${Math.round(je.steer*i)}px`),n.style.setProperty("--stick-y","0px");else{const o=on.clamp(-s/i,-1,1);je.throttle=Math.max(0,o),je.brake=Math.max(0,-o),n.style.setProperty("--stick-x","0px"),n.style.setProperty("--stick-y",`${Math.round(-o*i)}px`)}}function Lo(n,e){return Array.from(n.changedTouches).find(t=>t.identifier===e)}function Uo(n,e){e==="steer"?(je.steer=0,je.steerPointer=null):(je.throttle=0,je.brake=0,je.drivePointer=null),gc(n)}for(const n of ze.touchControls.querySelectorAll(".touch-stick")){const e=n.dataset.stick;n.addEventListener("pointerdown",r=>{r.preventDefault(),ia(),A.mode==="paused"&&(A.mode="race"),e==="steer"&&(je.steerPointer=r.pointerId),e==="drive"&&(je.drivePointer=r.pointerId),yr(n,r)},{passive:!1}),n.addEventListener("pointermove",r=>{(e==="steer"?je.steerPointer:je.drivePointer)===r.pointerId&&(r.preventDefault(),yr(n,r))},{passive:!1});const t=r=>{(e==="steer"?je.steerPointer:je.drivePointer)===r.pointerId&&Uo(n,e)};n.addEventListener("pointerup",t),n.addEventListener("pointercancel",t),n.addEventListener("touchstart",r=>{r.preventDefault(),ia(),A.mode==="paused"&&(A.mode="race");const s=r.changedTouches[0];s&&(e==="steer"&&(je.steerPointer=s.identifier),e==="drive"&&(je.drivePointer=s.identifier),yr(n,s))},{passive:!1}),n.addEventListener("touchmove",r=>{const s=e==="steer"?je.steerPointer:je.drivePointer,a=Lo(r,s);a&&(r.preventDefault(),yr(n,a))},{passive:!1});const i=r=>{const s=e==="steer"?je.steerPointer:je.drivePointer;Lo(r,s)&&(r.preventDefault(),Uo(n,e))};n.addEventListener("touchend",i,{passive:!1}),n.addEventListener("touchcancel",i,{passive:!1})}for(const n of ze.touchControls.querySelectorAll("button")){const e=n.dataset.code;n.addEventListener("pointerdown",i=>{i.preventDefault(),ia(),gt.add(e),n.setPointerCapture(i.pointerId)});const t=()=>gt.delete(e);n.addEventListener("pointerup",t),n.addEventListener("pointercancel",t),n.addEventListener("lostpointercapture",t)}const b0=bt(A.s);A.y=b0.p.y+2.1;A.lastSafeS=A.s;A.lastSafeDistance=A.totalDistance;pc(.016);mc();xc();
