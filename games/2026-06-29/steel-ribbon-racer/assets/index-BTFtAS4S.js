...
`)}function lp(n,e){let t;switch(e){case Kc:t="Linear";break;case Zc:t="Reinhard";break;case jc:t="Cineon";break;case Bo:t="ACESFilmic";break;case Qc:t="AgX";break;case el:t="Neutral";break;case Jc:t="Custom";break;default:Ne("WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Mr=new I;function dp(){Je.getLuminanceCoefficients(Mr);const n=Mr.x.toFixed(4),e=Mr.y.toFixed(4),t=Mr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}function vp(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===No?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===Fo?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===yn&&(e="SHADOWMAP_TYPE_VSM"),e}function Mp(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Ti:case wi:e="ENVMAP_TYPE_CUBE";break;case Nr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Sp(n){let e="ENVMAP_MODE_REFLECTION";return n.envMap&&n.envMapMode===wi&&(e="ENVMAP_MODE_REFRACTION"),e}function bp(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case Oo:e="ENVMAP_BLENDING_MULTIPLY";break;case Yc:e="ENVMAP_BLENDING_MIX";break;case $c:e="ENVMAP_BLENDING_ADD";break}return e}function yp(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function Ep(n,e,t,i){const r=n.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=vp(t),c=Mp(t),u=Sp(t),h=bp(t),f=yp(t),p=up(t),x=hp(s),S=r.createProgram();let m,d,b=t.glslVersion?"#version "+t.glslVersion+`
