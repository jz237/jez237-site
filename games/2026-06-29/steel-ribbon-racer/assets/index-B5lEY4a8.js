...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Mn,depthTest:!1,depthWrite:!1})}function Ho(){return new It({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:is(),fragmentShader:`
		...
		`,blending:Mn,depthTest:!1,depthWrite:!1})}function Wo(){return new It({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:is(),fragmentShader:`
...
`)}function Jp(i,e){let t;switch(e){case yc:t="Linear";break;case Ec:t="Reinhard";break;case Tc:t="Cineon";break;case Ua:t="ACESFilmic";break;case Ac:t="AgX";break;case Cc:t="Neutral";break;case wc:t="Custom";break;default:Oe("WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Fr=new U;function Qp(){Ke.getLuminanceCoefficients(Fr);const i=Fr.x.toFixed(4),e=Fr.y.toFixed(4),t=Fr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function n0(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),a=s.name;let o=1;s.type===i.FLOAT_MAT2&&(o=2),s.type===i.FLOAT_MAT3&&(o=3),s.type===i.FLOAT_MAT4&&(o=4),t[a]={type:s.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function Ji(i){return i!==""}function tc(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function nc(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const i0=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ca(i){return i.replace(i0,s0)}const r0=new Map;function s0(i,e){let t=Ve[e];if(t===void 0){const n=r0.get(e);if(n!==void 0)t=Ve[n],Oe('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Ca(t)}const a0=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function ic(i){return i.replace(a0,o0)}function o0(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function rc(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function c0(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Sc?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===bc?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Rn&&(e="SHADOWMAP_TYPE_VSM"),e}function l0(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Pi:case Di:e="ENVMAP_TYPE_CUBE";break;case ns:e="ENVMAP_TYPE_CUBE_UV";break}return e}function d0(i){let e="ENVMAP_MODE_REFLECTION";return i.envMap&&i.envMapMode===Di&&(e="ENVMAP_MODE_REFRACTION"),e}function h0(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Ia:e="ENVMAP_BLENDING_MULTIPLY";break;case kl:e="ENVMAP_BLENDING_MIX";break;case Gl:e="ENVMAP_BLENDING_ADD";break}return e}function u0(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function f0(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=c0(t),c=l0(t),h=d0(t),u=h0(t),f=u0(t),p=e0(t),x=t0(s),b=r.createProgram();let m,d,E=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
  ...
  `,Fe.result.classList.remove("hidden")}function xc(i="Craned back to the ribbon"){const e=gt(S.lastSafeS);S.s=S.lastSafeS,S.totalDistance=S.lastSafeDistance,S.lateral=0,S.lateralVel=0,S.y=e.p.y+2.1,S.yVel=0,S.speed=Math.max(16,S.speed*.32),S.grounded=!0,S.cameraShake=1.2,S.message=i,S.messageTimer=1.4,S.recoveries+=1}function Ja(i,e){return St.clamp(e*i.tangent.y,-48,48)}function wm(i=94){return j.gaps.map(e=>{const t=gt(e.start),n=gt(e.end+3),r=(e.end-e.start)/Math.max(1,i),s=Ja(t,i),a=t.p.y+2.1+s*r-.5*31*r*r,o=n.p.y+2.1;return{name:e.name,start:e.start,end:e.end,length:e.end-e.start,lipGradeDeg:Math.round(St.radToDeg(t.grade)*10)/10,launchYVel:Math.round(s*10)/10,projectedClearance:Math.round((a-o)*10)/10}})}function gc(i,e){S.grounded=!1,S.yVel=Ja(i,S.speed),S.airtime=0,e&&(S.message=e)}window.__steelRibbonDebug={launchVelocityAt(i,e){return Ja(gt(i),e)},gapJumpReport(i){return wm(i)},sceneryClearanceReport(){return um()},setSpeed(i){return S.speed=St.clamp(i,-14,156-S.damage*.42),ir(),S.speed},setTrackPosition(i,e=S.speed){const t=gt(i);return S.totalDistance=i,S.s=t.s,S.lastSafeS=t.s,S.lastSafeDistance=i,S.lateral=0,S.lateralVel=0,S.y=t.p.y+2.1,S.yVel=0,S.grounded=!0,S.speed=St.clamp(e,-14,156-S.damage*.42),ir(),{s:S.s,totalDistance:S.totalDistance,speed:S.speed,y:S.y}},setDamage(i){return S.damage=St.clamp(i,0,99),ir(),S.damage},setCourse(i){return ja(i)},listCourses(){return Ni.map((i,e)=>({index:e,name:i.name,length:i.length,width:i.width,laps:i.laps,gaps:i.gaps.length}))},courseInfo(){return{index:Kr,name:j.name,length:j.length,width:j.width,laps:j.laps}}};function Am(i){if(S.mode!=="race")return;S.time+=i,S.freeRun&&(S.damage=0);const e=S.breakdownTimer>0;e&&(S.breakdownTimer-=i,S.breakdownTimer<=0&&(S.damage=55,S.message="Patched up — back on it",S.messageTimer=1.2));const t=Math.max(ft.has("KeyW")||ft.has("ArrowUp")?1:0,Qe.throttle),n=Math.max(ft.has("KeyS")||ft.has("ArrowDown")?1:0,Qe.brake),r=St.clamp((ft.has("KeyD")||ft.has("ArrowRight")?1:0)-(ft.has("KeyA")||ft.has("ArrowLeft")?1:0)+Qe.steer,-1,1),s=t>.03&&!e,a=(ft.has("ShiftLeft")||ft.has("ShiftRight"))&&S.boost>.02&&s&&S.grounded,o=gt(S.s),l=o.p.y+2.1,c=Math.abs(S.speed);if(s){const d=S.speed<0?40:0;S.speed+=((a?60:34)+d)*t*i}if(n>.03){const d=S.speed>1.2?70:26;S.speed-=d*n*i}const h=S.grounded?.0024:.0011;S.speed-=h*S.speed*c*i,c>.08?S.speed-=Math.sign(S.speed)*(S.grounded?2.2:.3)*i:t<=.03&&n<=.03&&(S.speed=0),S.speed=St.clamp(S.speed,-16,156-S.damage*.8),e&&(S.speed=Math.min(S.speed,14)),a?(S.boost=Math.max(0,S.boost-i*.21),S.score+=28*i):S.boost=Math.min(1,S.boost+i*(S.grounded?.045:.018));const u=14+c*.12;S.lateralVel+=r*u*i,S.lateralVel-=S.lateralVel*(S.grounded?3.4:.7)*i,S.lateral+=S.lateralVel*i;const f=ts(S.s),p=Math.abs(S.lateral)<j.width*.52,x=!f&&p;if(S.grounded&&(!x||Math.abs(S.lateral)>j.width*.5)&&gc(o,p?"":"Edge slip"),S.grounded){const d=Math.sin(S.time*18)*Math.min(.22,Math.abs(S.speed)/700);S.y=St.lerp(S.y,l+d,.5),S.yVel=0,S.lastSafeS=S.s,S.lastSafeDistance=S.totalDistance,S.score+=Math.max(0,S.speed)*i*.34,Math.abs(S.lateral)>j.width*.42&&(S.damage+=i*(1.2+Math.abs(S.speed)*.035),S.cameraShake=Math.max(S.cameraShake,.24),S.nearMisses+=i*.8,Math.random()<i*5&&mc(o.p.clone().addScaledVector(o.side,Math.sign(S.lateral)*j.width*.55).addScaledVector(Qt,1.2),4))}else{S.yVel-=31*i,S.y+=S.yVel*i,S.airtime+=i,S.score+=i*11;const d=gt(S.s),E=d.p.y+2.1;if(!ts(S.s)&&Math.abs(S.lateral)<j.width*.55&&S.y<=E&&S.yVel<0){const T=-S.yVel,C=Math.abs(S.lateral)<j.width*.34&&T<30;S.y=E,S.grounded=!0,S.yVel=0,S.lastSafeS=S.s,S.lastSafeDistance=S.totalDistance,S.damage+=Math.max(0,T-17)*.82+Math.max(0,Math.abs(S.lateral)-j.width*.36)*1.8,S.score+=C?260+S.airtime*85:Math.max(30,120-T),S.cameraShake=Math.max(S.cameraShake,T/34),S.message=C?"Clean landing":"Hard landing",S.messageTimer=.9,C?S.cleanLandings+=1:S.hardLandings+=1,pc(T),mc(d.p.clone().addScaledVector(d.side,S.lateral).addScaledVector(Qt,.7),C?7:24),S.airtime=0}S.y<-55&&(S.damage+=28,xc("Track crew recovery"))}const b=S.totalDistance;S.totalDistance+=S.speed*i,S.s=(S.totalDistance%j.length+j.length)%j.length;const m=Math.floor(S.totalDistance/j.length)+1;if(m>S.lap){const d=S.time-S.lapStartTime;S.splitTimes.push(d),S.bestLap=Math.min(S.bestLap,d),S.lapStartTime=S.time,S.lap=m,S.score+=1200,S.message=S.practice?`Lap ${S.lap}`:S.lap<=j.laps?`Lap ${S.lap}`:"Season race complete",S.messageTimer=1.4,!S.practice&&S.lap>j.laps&&dl(S.totalDistance>=S.rivalDistance?"You took the chequered gantry.":"You finished behind Crowther.")}for(const d of j.gaps)am(b,S.totalDistance,d.start)&&(S.message=d.name,S.messageTimer=1.1,S.grounded&&gc(gt(d.start),d.name));S.damage=St.clamp(S.damage,0,100),!S.freeRun&&S.damage>=90&&S.breakdownTimer<=0&&(S.breakdownTimer=2.6,S.message="Chassis cracked — limping to repair",S.messageTimer=1.6,S.cameraShake=Math.max(S.cameraShake,.8),pc(40),S.damage=90),ft.has("KeyR")&&(S.damage=Math.min(99,S.damage+8),xc("Manual reset"),ft.delete("KeyR"))}function Cm(i){if(S.mode==="race"&&!S.practice){const s=S.totalDistance-S.rivalDistance,a=St.clamp(s*.06,-12,16),o=Math.sin(S.time*.6)*5;S.rivalSpeed=St.clamp(92+a+o,70,120),S.rivalDistance+=S.rivalSpeed*i,S.rivalDistance>=j.length*j.laps&&S.lap<=j.laps&&dl("Crowther reached the gantry first.")}S.rivalS=(S.rivalDistance%j.length+j.length)%j.length;const e=gt(S.rivalS),t=e.p.clone().addScaledVector(Qt,1.4).addScaledVector(e.side,Math.sin(S.rivalS*.02)*1.4);zs.position.copy(t);const n=new st().makeBasis(e.side,Qt,e.tangent);zs.quaternion.setFromRotationMatrix(n);const r=Math.abs(S.rivalDistance-S.totalDistance)<26;zs.visible=(S.mode==="race"||S.mode==="paused")&&!S.practice&&!r}function hl(i){const e=gt(S.s),t=e.side.clone().multiplyScalar(S.lateral),n=e.p.clone().add(t);n.y=S.y;const r=S.cameraShake;r>.01&&(n.x+=(Math.random()-.5)*r*.8,n.y+=(Math.random()-.5)*r*.45),zt.position.copy(n);const s=Math.abs(S.speed),a=68+Math.min(10,s*.055)+(ft.has("ShiftLeft")||ft.has("ShiftRight")?3:0);Math.abs(zt.fov-a)>.02&&(zt.fov+=(a-zt.fov)*(1-Math.pow(.004,i)),zt.updateProjectionMatrix());const o=gt(S.s+34+S.speed*.16),l=o.p.clone().addScaledVector(o.side,S.lateral*.45);l.y+=1.7+Math.sin(S.time*8)*Math.min(.2,s/680),Ei.position.copy(zt.position),Ei.lookAt(l),Ei.rotateY(Math.PI),Ei.rotateZ(-e.bank*.72-S.lateralVel*.006),Ei.rotateX(e.grade*.18+(S.grounded?0:St.clamp(S.yVel,-30,30)*-.006)),zt.quaternion.slerp(Ei.quaternion,1-Math.pow(8e-4,i)),S.cameraShake=Math.max(0,S.cameraShake-i*1.9);const c=tm.set(0,0,-1).applyQuaternion(zt.quaternion).normalize();window.__steelRibbonTelemetry={mode:S.mode,s:S.s,totalDistance:S.totalDistance,rivalDistance:S.rivalDistance,speed:S.speed,lap:S.lap,score:S.score,damage:S.damage,y:S.y,yVel:S.yVel,grounded:S.grounded,input:{steer:Qe.steer,throttle:Qe.throttle,brake:Qe.brake},forwardWorld:{x:e.tangent.x,y:e.tangent.y,z:e.tangent.z},cameraWorld:{x:c.x,y:c.y,z:c.z}}}const ii={idle:900,shift:7400,redline:7500,max:9e3,postShift:2900},ji=[28,54,82,110,134,156];function Rm(){const i=Math.abs(S.speed);let e=1;for(let o=0;o<ji.length;o++)i>ji[o]&&(e=o+2);e=Math.min(e,ji.length);const t=e===1?0:ji[e-2],n=ji[e-1],r=n>t?St.clamp((i-t)/(n-t),0,1):0,s=e===1?ii.idle:ii.postShift;let a=s+r*(ii.shift-s);return i<.4&&(a=ii.idle),{gear:e,rpm:a}}let _c=performance.now();function Pm(i,e){const t=Fe.tach;if(!t)return;const n=t.getContext("2d"),r=Math.min(2,window.devicePixelRatio||1),s=t.clientWidth||160,a=t.clientHeight||70;(t.width!==Math.round(s*r)||t.height!==Math.round(a*r))&&(t.width=Math.round(s*r),t.height=Math.round(a*r)),n.setTransform(r,0,0,r,0,0),n.clearRect(0,0,s,a);const o=s/2,l=a-a*.14,c=Math.min(s*.46,a*.9),h=ii.max,u=y=>Math.PI-y*Math.PI,f=(y,T)=>[o+Math.cos(y)*T,l-Math.sin(y)*T];n.lineCap="round",n.lineWidth=Math.max(2,c*.07),n.strokeStyle="rgba(120, 205, 255, 0.32)",n.beginPath(),n.arc(o,l,c,u(1),u(0)),n.stroke();const p=ii.redline/h;n.strokeStyle="#ff3b30",n.beginPath(),n.arc(o,l,c,u(1),u(p)),n.stroke(),n.font=`700 ${Math.max(7,c*.17)}px "Courier New", monospace`,n.textAlign="center",n.textBaseline="middle";for(let y=0;y<=9;y++){const T=y/9,C=u(T),w=y*1e3>=ii.redline;n.strokeStyle=w?"#ff6155":"rgba(180, 230, 255, 0.9)",n.lineWidth=Math.max(1.4,c*.035);const D=f(C,c-c*.02),P=f(C,c-c*.18);n.beginPath(),n.moveTo(D[0],D[1]),n.lineTo(P[0],P[1]),n.stroke();const v=f(C,c-c*.34);if(n.fillStyle=w?"#ff8077":"#cfeeff",n.fillText(String(y),v[0],v[1]),y<9){const g=u((y+.5)/9),R=f(g,c-c*.02),N=f(g,c-c*.1);n.strokeStyle="rgba(150, 210, 255, 0.5)",n.lineWidth=Math.max(1,c*.02),n.beginPath(),n.moveTo(R[0],R[1]),n.lineTo(N[0],N[1]),n.stroke()}}const x=St.clamp(i/h,0,1),b=u(x),m=f(b,c-c*.06),d=f(b+Math.PI,c*.14);n.strokeStyle="#ffdd48",n.shadowColor="rgba(255, 200, 60, 0.9)",n.shadowBlur=c*.18,n.lineWidth=Math.max(1.8,c*.05),n.beginPath(),n.moveTo(d[0],d[1]),n.lineTo(m[0],m[1]),n.stroke(),n.shadowBlur=0,n.fillStyle="#13303d",n.strokeStyle="#6ec7ff",n.lineWidth=Math.max(1,c*.03),n.beginPath(),n.arc(o,l,c*.1,0,Math.PI*2),n.fill(),n.stroke(),n.fillStyle="rgba(135, 223, 255, 0.85)",n.font=`700 ${Math.max(6,c*.12)}px "Courier New", monospace`,n.textBaseline="alphabetic",n.fillText("x1000 r/min",o,l-c*.26);const E=S.speed<-.5?"R":String(e);n.fillStyle="#f2f8ff",n.font=`800 ${Math.max(9,c*.22)}px "Courier New", monospace`,n.fillText(E,o,l+c*.02)}function ir(){j.length*j.laps;const i=lc(S.practice?S.totalDistance%j.length:S.totalDistance),e=S.practice?0:lc(S.rivalDistance),t=S.practice?"SOLO":S.totalDistance>=S.rivalDistance?"P1":"P2";t!==S.leadState&&S.mode==="race"&&(S.leadState=t,S.practice||(S.message=t==="P1"?"You took the lead":"Crowther ahead",S.messageTimer=.95)),Fe.speed.textContent=`${S.speed<-.5?"-":""}${String(Math.round(Math.abs(S.speed)*2.25)).padStart(3,"0")}`,Fe.boost.style.width=`${Math.round(S.boost*100)}%`,Fe.damage.style.width=`${Math.round(S.damage)}%`,Fe.lap.textContent=S.practice?`LAP ${S.lap}`:`${Math.min(S.lap,j.laps)}/${j.laps}`,Fe.timer.textContent=Pa(S.time),Fe.score.textContent=`Score ${Math.round(S.score)}`,Fe.position.textContent=S.freeRun?"FREE RUN":S.practice?"PRACTICE":`${t} DIV 4`,Fe.hud.style.display=S.mode==="race"||S.mode==="paused"?"flex":"none",Fe.raceStrip.style.display=S.mode==="race"||S.mode==="paused"?"grid":"none",Fe.touchControls.style.display=S.mode==="race"||S.mode==="paused"?"":"none",Fe.playerProgress.style.width=`${Math.round(i*100)}%`,Fe.rivalProgress.style.width=`${Math.round(e*100)}%`;const n=Rm();S.gear=n.gear;const r=performance.now(),s=Math.min(.05,(r-_c)/1e3);_c=r;const a=1-Math.exp(-s*(n.rpm>S.tachRpm?10:6));S.tachRpm+=(n.rpm-S.tachRpm)*a,Pm(S.tachRpm,n.gear),Fe.speedFx.style.opacity=Math.max(0,Math.min(.18,(Math.abs(S.speed)-44)/150)),Fe.damageFx.style.opacity=S.damage<18?0:Math.min(.72,(S.damage-18)/82),S.mode==="paused"?(Fe.centerMessage.textContent="Paused",Fe.centerMessage.classList.remove("hidden")):S.messageTimer>0?(Fe.centerMessage.textContent=S.message,Fe.centerMessage.classList.remove("hidden")):Fe.centerMessage.classList.add("hidden")}function Pa(i){const e=Math.floor(i/60),t=i-e*60;return`${String(e).padStart(2,"0")}:${t.toFixed(1).padStart(4,"0")}`}function ul(){const i=em.getDelta(),e=Math.min(.033,i);S.messageTimer>0&&(S.messageTimer-=e),Am(e),Cm(e),hl(e),Em(e),ir(),Tm(e),Qi.uniforms.uTime.value+=e,Qi.uniforms.uSpeed.value=Math.min(1,Math.abs(S.speed)/150);const t=(ft.has("ShiftLeft")||ft.has("ShiftRight"))&&S.boost>.02&&S.mode==="race";Qi.uniforms.uBoost.value+=((t?1:0)-Qi.uniforms.uBoost.value)*Math.min(1,e*6),ki.render(),requestAnimationFrame(ul)}window.addEventListener("keydown",i=>{ft.add(i.code),["ArrowUp","ArrowDown","ArrowLeft","ArrowRight","Space"].includes(i.code)&&i.preventDefault(),i.code==="KeyP"&&S.mode==="race"?(S.mode="paused",ft.clear(),Da()):i.code==="KeyP"&&S.mode==="paused"?S.mode="race":i.code==="Escape"&&(S.mode==="race"||S.mode==="paused")&&(S.mode="menu",Da(),Fe.menu.classList.remove("hidden"))});window.addEventListener("keyup",i=>ft.delete(i.code));window.addEventListener("resize",()=>{zt.aspect=window.innerWidth/window.innerHeight,zt.updateProjectionMatrix(),tn.setSize(window.innerWidth,window.innerHeight),ki.setSize(window.innerWidth,window.innerHeight),cl.setSize(window.innerWidth,window.innerHeight)});Fe.startBtn.addEventListener("click",()=>ss(!1));Fe.practiceBtn.addEventListener("click",()=>ss(!0));Fe.freeRunBtn.addEventListener("click",()=>ss(!0,!0));Fe.againBtn.addEventListener("click",()=>ss(!1));Fe.courseButtons.forEach(i=>{i.addEventListener("click",()=>ja(Number(i.dataset.course)))});function fl(i){i&&(i.classList.remove("active"),i.style.setProperty("--stick-x","0px"),i.style.setProperty("--stick-y","0px"))}function Da(){Qe.steer=0,Qe.throttle=0,Qe.brake=0,Qe.steerPointer=null,Qe.drivePointer=null;for(const i of Fe.touchControls.querySelectorAll(".touch-stick"))fl(i)}function Gr(i,e){const t=i.getBoundingClientRect(),n=Math.min(t.width,t.height)*.36,r=St.clamp(e.clientX-(t.left+t.width/2),-n,n),s=St.clamp(e.clientY-(t.top+t.height/2),-n,n),a=i.dataset.stick;if(i.classList.add("active"),a==="steer")Qe.steer=St.clamp(r/n,-1,1),i.style.setProperty("--stick-x",`${Math.round(Qe.steer*n)}px`),i.style.setProperty("--stick-y","0px");else{const o=St.clamp(-s/n,-1,1);Qe.throttle=Math.max(0,o),Qe.brake=Math.max(0,-o),i.style.setProperty("--stick-x","0px"),i.style.setProperty("--stick-y",`${Math.round(-o*n)}px`)}}function vc(i,e){return Array.from(i.changedTouches).find(t=>t.identifier===e)}function Mc(i,e){e==="steer"?(Qe.steer=0,Qe.steerPointer=null):(Qe.throttle=0,Qe.brake=0,Qe.drivePointer=null),fl(i)}for(const i of Fe.touchControls.querySelectorAll(".touch-stick")){const e=i.dataset.stick;i.addEventListener("pointerdown",r=>{r.preventDefault(),Ra(),S.mode==="paused"&&(S.mode="race"),e==="steer"&&(Qe.steerPointer=r.pointerId),e==="drive"&&(Qe.drivePointer=r.pointerId),Gr(i,r)},{passive:!1}),i.addEventListener("pointermove",r=>{(e==="steer"?Qe.steerPointer:Qe.drivePointer)===r.pointerId&&(r.preventDefault(),Gr(i,r))},{passive:!1});const t=r=>{(e==="steer"?Qe.steerPointer:Qe.drivePointer)===r.pointerId&&Mc(i,e)};i.addEventListener("pointerup",t),i.addEventListener("pointercancel",t),i.addEventListener("touchstart",r=>{r.preventDefault(),Ra(),S.mode==="paused"&&(S.mode="race");const s=r.changedTouches[0];s&&(e==="steer"&&(Qe.steerPointer=s.identifier),e==="drive"&&(Qe.drivePointer=s.identifier),Gr(i,s))},{passive:!1}),i.addEventListener("touchmove",r=>{const s=e==="steer"?Qe.steerPointer:Qe.drivePointer,a=vc(r,s);a&&(r.preventDefault(),Gr(i,a))},{passive:!1});const n=r=>{const s=e==="steer"?Qe.steerPointer:Qe.drivePointer;vc(r,s)&&(r.preventDefault(),Mc(i,e))};i.addEventListener("touchend",n,{passive:!1}),i.addEventListener("touchcancel",n,{passive:!1})}for(const i of Fe.touchControls.querySelectorAll("button")){const e=i.dataset.code;i.addEventListener("pointerdown",n=>{n.preventDefault(),Ra(),ft.add(e),i.setPointerCapture(n.pointerId)});const t=()=>ft.delete(e);i.addEventListener("pointerup",t),i.addEventListener("pointercancel",t),i.addEventListener("lostpointercapture",t)}const Dm=gt(S.s);S.y=Dm.p.y+2.1;S.lastSafeS=S.s;S.lastSafeDistance=S.totalDistance;hl(.016);ir();ul();
