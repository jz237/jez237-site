...
try {
  ...
  assert.equal(title.version.text, 'VERSION 2.2');
  ...
  assert.equal(title.engineVersion, '2.2-schoolyard');
  ...
  assert.equal(controlledReload.version, '2.2-schoolyard');
  ...
  assert.equal(offlineBoot.version, '2.2-schoolyard');
  ...
  assert.equal(landscape.version.text, 'VERSION 2.2');
