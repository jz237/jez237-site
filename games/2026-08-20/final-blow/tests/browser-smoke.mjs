...
try {
  ...
  assert.match(title.build, /3\.3/);
  assert.equal(title.version.text, 'VERSION 3.3');
  ...
  assert.equal(title.engineVersion, '3.3-fresh');
  ...
  assert.match(offlineCache.name, /final-blow-shell-3\.3/);
  ...
  assert.match(controlledReload.build, /3\.3/);
  assert.equal(controlledReload.version, '3.3-fresh');
  ...
  assert.match(offlineBoot.build, /3\.3/);
  assert.equal(offlineBoot.version, '3.3-fresh');
  ...
  assert.equal(landscape.version.text, 'VERSION 3.3');
