...
try {
  ...
  assert.match(title.build, /4\.1/);
  assert.equal(title.version.text, 'VERSION 4.1');
  ...
  assert.equal(title.engineVersion, '4.1-footwork');
  ...
  assert.match(offlineCache.name, /final-blow-shell-4\.1/);
  ...
  assert.match(controlledReload.build, /4\.1/);
  assert.equal(controlledReload.version, '4.1-footwork');
  ...
  assert.match(offlineBoot.build, /4\.1/);
  assert.equal(offlineBoot.version, '4.1-footwork');
  ...
  assert.equal(landscape.version.text, 'VERSION 4.1');
