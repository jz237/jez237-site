...
try {
  ...
  assert.match(title.build, /2\.9/);
  assert.equal(title.version.text, 'VERSION 2.9');
  ...
  assert.equal(title.engineVersion, '2.9-flow');
  ...
  assert.match(offlineCache.name, /final-blow-shell-2\.9/);
  ...
  assert.match(controlledReload.build, /2\.9/);
  assert.equal(controlledReload.version, '2.9-flow');
  ...
  assert.match(offlineBoot.build, /2\.9/);
  assert.equal(offlineBoot.version, '2.9-flow');
  ...
  assert.equal(landscape.version.text, 'VERSION 2.9');
