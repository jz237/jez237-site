...
try {
  ...
  assert.match(title.build, /4\.5/);
  assert.equal(title.version.text, 'VERSION 4.5');
  ...
  assert.equal(title.engineVersion, '4.5-rearm');
  ...
  assert.match(offlineCache.name, /final-blow-shell-4\.5/);
  ...
  assert.match(controlledReload.build, /4\.5/);
  assert.equal(controlledReload.version, '4.5-rearm');
  ...
  assert.match(offlineBoot.build, /4\.5/);
  assert.equal(offlineBoot.version, '4.5-rearm');
  ...
  assert.equal(landscape.version.text, 'VERSION 4.5');
