...
try {
  ...
  assert.match(title.build, /4\.2/);
  assert.equal(title.version.text, 'VERSION 4.2');
  ...
  assert.equal(title.engineVersion, '4.2-fullcard');
  ...
  assert.match(offlineCache.name, /final-blow-shell-4\.2/);
  ...
  assert.match(controlledReload.build, /4\.2/);
  assert.equal(controlledReload.version, '4.2-fullcard');
  ...
  assert.match(offlineBoot.build, /4\.2/);
  assert.equal(offlineBoot.version, '4.2-fullcard');
  ...
  assert.equal(landscape.version.text, 'VERSION 4.2');
