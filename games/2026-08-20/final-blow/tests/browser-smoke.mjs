...
try {
  ...
  assert.match(title.build, /2\.8/);
  assert.equal(title.version.text, 'VERSION 2.8');
  ...
  assert.equal(title.engineVersion, '2.8-carnage');
  ...
  assert.match(offlineCache.name, /final-blow-shell-2\.8/);
  ...
  assert.match(controlledReload.build, /2\.8/);
  assert.equal(controlledReload.version, '2.8-carnage');
  ...
  assert.match(offlineBoot.build, /2\.8/);
  assert.equal(offlineBoot.version, '2.8-carnage');
  ...
  assert.equal(landscape.version.text, 'VERSION 2.8');
