...
try {
  ...
  assert.equal(title.version.text, 'VERSION 2.3');
  ...
  assert.equal(title.engineVersion, '2.3-family');
  ...
  assert.equal(controlledReload.version, '2.3-family');
  ...
  assert.equal(offlineBoot.version, '2.3-family');
  ...
  assert.equal(landscape.version.text, 'VERSION 2.3');
