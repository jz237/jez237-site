...
try {
  ...
  assert.match(title.build, /4\.7/);
  assert.equal(title.version.text, 'VERSION 4.7');
  ...
  assert.equal(title.engineVersion, '4.7-crowdwork');
  ...
  assert.match(offlineCache.name, /final-blow-shell-4\.7/);
  ...
  assert.match(controlledReload.build, /4\.7/);
  assert.equal(controlledReload.version, '4.7-crowdwork');
  ...
  assert.match(offlineBoot.build, /4\.7/);
  assert.equal(offlineBoot.version, '4.7-crowdwork');
  ...
  assert.equal(landscape.version.text, 'VERSION 4.7');
