...
try {
  ...
  assert.match(title.build, /4\.8/);
  assert.equal(title.version.text, 'VERSION 4.8');
  ...
  assert.equal(title.engineVersion, '4.8-frontrow');
  ...
  assert.match(offlineCache.name, /final-blow-shell-4\.8/);
  ...
  assert.match(controlledReload.build, /4\.8/);
  assert.equal(controlledReload.version, '4.8-frontrow');
  ...
  assert.match(offlineBoot.build, /4\.8/);
  assert.equal(offlineBoot.version, '4.8-frontrow');
  ...
  assert.equal(landscape.version.text, 'VERSION 4.8');
