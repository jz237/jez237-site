...
try {
  ...
  assert.match(title.build, /4\.6/);
  assert.equal(title.version.text, 'VERSION 4.6');
  ...
  assert.equal(title.engineVersion, '4.6-flatout');
  ...
  assert.match(offlineCache.name, /final-blow-shell-4\.6/);
  ...
  assert.match(controlledReload.build, /4\.6/);
  assert.equal(controlledReload.version, '4.6-flatout');
  ...
  assert.match(offlineBoot.build, /4\.6/);
  assert.equal(offlineBoot.version, '4.6-flatout');
  ...
  assert.equal(landscape.version.text, 'VERSION 4.6');
