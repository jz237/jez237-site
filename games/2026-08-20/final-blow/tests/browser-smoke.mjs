...
try {
  ...
  assert.match(title.build, /3\.0/);
  assert.equal(title.version.text, 'VERSION 3.0');
  ...
  assert.equal(title.engineVersion, '3.0-onevoice');
  ...
  assert.match(offlineCache.name, /final-blow-shell-3\.0/);
  ...
  assert.match(controlledReload.build, /3\.0/);
  assert.equal(controlledReload.version, '3.0-onevoice');
  ...
  assert.match(offlineBoot.build, /3\.0/);
  assert.equal(offlineBoot.version, '3.0-onevoice');
  ...
  assert.equal(landscape.version.text, 'VERSION 3.0');
