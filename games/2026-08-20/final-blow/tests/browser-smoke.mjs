...
try {
  ...
  assert.match(title.build, /3\.1/);
  assert.equal(title.version.text, 'VERSION 3.1');
  ...
  assert.equal(title.engineVersion, '3.1-bones');
  ...
  assert.match(offlineCache.name, /final-blow-shell-3\.1/);
  ...
  assert.match(controlledReload.build, /3\.1/);
  assert.equal(controlledReload.version, '3.1-bones');
  ...
  assert.match(offlineBoot.build, /3\.1/);
  assert.equal(offlineBoot.version, '3.1-bones');
  ...
  assert.equal(landscape.version.text, 'VERSION 3.1');
