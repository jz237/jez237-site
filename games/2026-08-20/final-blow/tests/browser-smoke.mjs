...
try {
  ...
  assert.match(title.build, /3\.2/);
  assert.equal(title.version.text, 'VERSION 3.2');
  ...
  assert.equal(title.engineVersion, '3.2-tape');
  ...
  assert.match(offlineCache.name, /final-blow-shell-3\.2/);
  ...
  assert.match(controlledReload.build, /3\.2/);
  assert.equal(controlledReload.version, '3.2-tape');
  ...
  assert.match(offlineBoot.build, /3\.2/);
  assert.equal(offlineBoot.version, '3.2-tape');
  ...
  assert.equal(landscape.version.text, 'VERSION 3.2');
