...
// 5.7.14: companions across the complete painted movement libraries of all ten fighters.
const CACHE_NAME = "final-blow-shell-5.7.14-recovery";
...
const SHELL = [
  ...
  "./engine/full-registration.mjs",
  "./engine/smooth-registration.mjs",
  "./engine/inbetweens.mjs",
  "./engine/inbetween-scale.mjs",
  ...
  "./engine/ai-defense.mjs",
  "./engine/ai-feints.mjs",
  ...
  "./engine/strike-anchors.mjs",
  "./engine/move-viewer.mjs",
  "./engine/arcade.mjs",
  "./engine/controls.mjs",
  "./engine/training.mjs",
  "./engine/polish.mjs",
