...
export const REPAIRED_CELLS = {"jez": {"unified-ext2": [7], "unified-ext3": [1, 3, 5, 7, 9, 11, 14, 15], "unified-ext4": [3, 12, 15], "unified-ext5": [1, 9, 11, 12], "specials": [1, 2, 5, 9, 10, 14, 15]}, "benny": {"unified": [15], "unified-ext2": [12, 13, 14, 15], "unified-ext3": [0, 3, 5, 8, 9, 13, 14, 15], "unified-ext4": [1, 3, 12, 15], "unified-ext5": [0, 8, 9, 11, 12, 15], "specials": [9, 10, 12, 15]}};
