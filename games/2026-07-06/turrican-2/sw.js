 ...
 */
const CACHE = 'turrican2-v1.4.0';
const CORE = [
  './',
  'manifest.json',
  'assets/data.js?v=1.4.0',
  'assets/engine.js?v=1.4.0',
  'assets/render.js?v=1.4.0',
  'assets/audio.js?v=1.4.0',
  'assets/input.js?v=1.4.0',
  'assets/game.js?v=1.4.0',
];
