...
const AUDIO = (() => {
  ...
  function sfx(name){
    ...
    switch (name){
      ...
      case 'gold':   tone(740, t, 0.08, 'triangle', 0.32); tone(1180, t + 0.055, 0.11, 'triangle', 0.28); noise(t, 0.05, 0.08, 3200, 900); break;
      case 'goldhi': tone(990, t, 0.07, 'triangle', 0.3); tone(1480, t + 0.05, 0.1, 'triangle', 0.3); tone(1980, t + 0.1, 0.12, 'sine', 0.2); noise(t + 0.03, 0.08, 0.08, 4200, 1200); break;
      case 'life':   [523, 659, 784, 1047, 1568].forEach((f, i) => tone(f, t + i * 0.055, 0.22, 'triangle', 0.25)); tone(196, t, 0.45, 'sine', 0.12); break;
      ...
      case 'alert':  tone(880, t, 0.055, 'square', 0.14); tone(1175, t + 0.045, 0.08, 'triangle', 0.13); break;
      ...
      case 'cave':   slide(150, 55, t, 0.55, 'sawtooth', 0.32); noise(t, 0.65, 0.45, 500, 70); tone(82, t + 0.08, 0.52, 'sine', 0.22); break;
      case 'refill': slide(140, 65, t, 0.28, 'triangle', 0.24); noise(t, 0.22, 0.34, 600, 90); break;
      case 'boom':   slide(260, 28, t, 0.58, 'sawtooth', 0.46); noise(t, 0.52, 0.68, 1400); noise(t + 0.04, 0.55, 0.42, 260); tone(58, t + 0.02, 0.45, 'sine', 0.2); break;
      case 'cart':   noise(t, 0.36, 0.28, 2600, 400); slide(330, 620, t, 0.28, 'square', 0.18); [392, 523, 659].forEach((f, i) => tone(f, t + .16 + i * .055, .22, 'triangle', .16)); break;
