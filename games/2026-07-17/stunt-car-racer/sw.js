...
var CACHE_NAME = 'scr-v139';
var ASSETS = [
  'source.html',
  'source.js?v=139',
  'source.wasm?v=139',
  'controls.js?v=139',
  'driver-controls.js?v=139',
  'profile.js?v=139',
  'track-access.js?v=139',
  'hotseat.js?v=139',
  'link-championship.js?v=139',
  'backup.js?v=139',
  'multiplayer.js?v=139',
  'game.js?v=139',
  'game.css?v=139',
  'hd-graphics.js?v=139',
  'hd-audio.js?v=139',
  'audio/engine-idle.mp3?v=139',
  'audio/engine-high.mp3?v=139',
  'audio/boost.mp3?v=139',
  'audio/air.mp3?v=139',
  'audio/crash.mp3?v=139',
  'audio/wreck.mp3?v=139',
  'audio/land.mp3?v=139',
  'audio/fanfare.mp3?v=139',
  'audio/lost.mp3?v=139',
  'audio/music.mp3?v=139',
  'images/sky.jpg',
  'manifest.json',
  'icon-192.png',
  'icon-512.png',
