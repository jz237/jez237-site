import {cityStuntLayout} from './city-stunts.js?v=0409f9dba1c4';
import {portStuntLayout} from './port-stunts.js?v=0409f9dba1c4';
import {fortStuntLayout} from './fort-stunts.js?v=0409f9dba1c4';
import {drakeStuntLayout} from './drake-stunts.js?v=0409f9dba1c4';
import {sunsetStuntLayout} from './sunset-stunts.js?v=0409f9dba1c4';
import {sunnyStuntLayout} from './sunny-stunts.js?v=0409f9dba1c4';
import {createDolphinCourse} from './dolphin-course.js?v=0409f9dba1c4';
...
const lake={
 name:'Drake Lake',theme:'lake',tag:'03 / DRAKE LAKE',layoutRevision:4,boundary:lakeOuter,stuntLayout:{...drakeStuntLayout(),rocks:lakePostObstacles(),resistance:lakeWeeds(lakeWeedMarkers)},
...
const fort={
 name:'Marine Fortress',theme:'fortress',tag:'04 / MARINE FORTRESS',layoutRevision:6,stuntLayout:fortStuntLayout(),
