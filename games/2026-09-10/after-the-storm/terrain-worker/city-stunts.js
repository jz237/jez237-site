...
export function cityStuntLayout(){
 ...
 const tail=[way([269,45]),way([229,29]),way([182,27]),way([173,55]),cp(0),ramp(1),target(9),way([190,169]),way([207,200]),way([204,218]),way([174,244]),cp(1),target(10),target(11),target(12),{...way([48,380]),tx:0,tz:1,speed:7},{...way([48,388]),tx:0,tz:1,speed:7},{...target(13),speed:7},{...target(14),speed:9},way([23,458]),cp(2),way([65,488]),ramp(2),target(15),way([150,489]),{...way([163,480]),tx:.948683298,tz:.316227766,speed:8},{...way([175,484]),tx:.948683298,tz:.316227766,speed:8},ramp(3),target(16),way([244,483]),way([266,456]),cp(3)];
