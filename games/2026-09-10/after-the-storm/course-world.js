...
export function makeCourseWorld(scene,course,ocean,{freeRide=false}={}){
 ...
 const scenery=makeCoastalScenery(root,course),distant=makeDistantCoast(root,course),obstacleFoam=makeObstacleFoam(root,course);
