...
export function makeCourseWorld(scene,course,ocean,{freeRide=false}={}){
 ...
 const materials=[],geometries=[],textures=[],buoys=[],animated=[],lights=[],weedMeshes=[];
