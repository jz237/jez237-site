...
export function recordWake(x,z,time,heading,power,owner=null,capacity=WAKE_COUNT){Object.assign(wakeTrail[cursor++%Math.min(WAKE_COUNT,capacity)],{x,z,time,heading,power,owner});}
