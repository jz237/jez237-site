...
import {localWaterHeight,setLocalWater} from './local-water.js';
import {gustHeight} from './wind-gusts.js';
import {hullContactHeight} from './hull-contact.js';
import {boundaryHeight,setBoundaryWaves} from './boundary-waves.js';
...
export function wave(x,z,t,storm=0,gust=null,wakes=wakeHeight){return localWaterHeight(x,z)+gustHeight(x,z,t,storm,gust)+hullContactHeight(x,z,craftFields)+boundaryHeight(x,z,t,storm)+waterLevel.value+sampleSwell(x,z,t,storm)+jetWake(x,z)+impactHeight(x,z,t)+wakes(x,z,t,storm);}
