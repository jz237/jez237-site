...
export function wave(x,z,t,storm=0){return boundaryHeight(x,z,t,storm)+waterLevel.value+sampleSwell(x,z,t,storm)+jetWake(x,z)+impactHeight(x,z,t)+wakeHeight(x,z,t,storm);}
