...
export function mappedGates(route,buoys){
 ...
 return {x:b.x-tz*b.side*offset,z:b.z+tx*b.side*offset,tx,tz,side:b.side,offset,bx:b.x,bz:b.z,width:b.width??23,routeIndex:best,approach:b.approach,recoverWrongSide:b.recoverWrongSide};})];
}
