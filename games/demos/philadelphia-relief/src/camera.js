...
import { damp, clamp, normalizeAngle, shortestAngleDelta } from './geo.js?v=philly-2026090402';
import { CAMERA } from './schema.js?v=philly-2026090402';
...
export function createCameraRig(THREE, options) {
  ...
  return {
    ...
    setAspect(aspect) {
      ...
      // 1.2 km and 190 km without ever clipping the terrain.
