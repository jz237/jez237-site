...
export const THEMES = {
  dusk: {
    ...
    ramp: [
      [0.00, '#3c4a58'], [0.03, '#4c5867'], [0.08, '#616655'],
      [0.18, '#807559'], [0.34, '#9c8862'], [0.55, '#b89c6f'],
      [0.78, '#d2ba8e'], [1.00, '#f0dcb6'],
    ],
    skyTop: '#16233c', skyFill: '#5b7ba8', skyHorizon: '#d9975c', sunColor: '#ffd9a0',
    fog: '#bf8a5e', fogTint: '#ffc27a',
