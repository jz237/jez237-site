...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ln,depthTest:!1,depthWrite:!1})}function yd(){return new at({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:bh(),fragmentShader:`
		...
		`,blending:Ln,depthTest:!1,depthWrite:!1})}function Md(){return new at({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:bh(),fragmentShader:`
	...
	`}function H_(i){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){let l=o.mapping,c=l===Jo||l===$o,h=l===ts||l===ns;if(c||h){let u=e.get(o),f=u!==void 0?u.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==f)return t===null&&(t=new er(i)),u=c?t.fromEquirectangular(o,u):t.fromCubemap(o,u),u.texture.pmremVersion=o.pmremVersion,e.set(o,u),u.texture;if(u!==void 0)return u.texture;{let p=o.image;return c&&p&&p.height>0||h&&p&&s(p)?(t===null&&(t=new er(i)),u=c?t.fromEquirectangular(o):t.fromCubemap(o),u.texture.pmremVersion=o.pmremVersion,e.set(o,u),o.addEventListener("dispose",r),u.texture):null}}}return o}function s(o){let l=0,c=6;for(let h=0;h<c;h++)o[h]!==void 0&&l++;return l===c}function r(o){let l=o.target;l.removeEventListener("dispose",r);let c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function G_(i){let e={};function t(n){if(e[n]!==void 0)return e[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){let s=t(n);return s===null&&Us("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function W_(i,e,t,n){let s={},r=new WeakMap;function a(u){let f=u.target;f.index!==null&&e.remove(f.index);for(let g in f.attributes)e.remove(f.attributes[g]);f.removeEventListener("dispose",a),delete s[f.id];let p=r.get(f);p&&(e.remove(p),r.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function o(u,f){return s[f.id]===!0||(f.addEventListener("dispose",a),s[f.id]=!0,t.memory.geometries++),f}function l(u){let f=u.attributes;for(let p in f)e.update(f[p],i.ARRAY_BUFFER)}function c(u){let f=[],p=u.index,g=u.attributes.position,x=0;if(p!==null){let T=p.array;x=p.version;for(let y=0,_=T.length;y<_;y+=3){let E=T[y+0],A=T[y+1],P=T[y+2];f.push(E,A,A,P,P,E)}}else if(g!==void 0){let T=g.array;x=g.version;for(let y=0,_=T.length/3-1;y<_;y+=3){let E=y+0,A=y+1,P=y+2;f.push(E,A,A,P,P,E)}}else return;let m=new(ih(f)?Nr:Ur)(f,1);m.version=x;let d=r.get(u);d&&e.remove(d),r.set(u,m)}function h(u){let f=r.get(u);if(f){let p=u.index;p!==null&&f.version<p.version&&c(u)}else c(u);return r.get(u)}return{get:o,update:l,getWireframeAttribute:h}}function X_(i,e,t){let n;function s(f){n=f}let r,a;function o(f){r=f.type,a=f.bytesPerElement}function l(f,p){i.drawElements(n,p,r,f*a),t.update(p,n,1)}function c(f,p,g){g!==0&&(i.drawElementsInstanced(n,p,r,f*a,g),t.update(p,n,g))}function h(f,p,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,p,0,r,f,0,g);let m=0;for(let d=0;d<g;d++)m+=p[d];t.update(m,n,1)}function u(f,p,g,x){if(g===0)return;let m=e.get("WEBGL_multi_draw");if(m===null)for(let d=0;d<f.length;d++)c(f[d]/a,p[d],x[d]);else{m.multiDrawElementsInstancedWEBGL(n,p,0,r,f,0,x,0,g);let d=0;for(let T=0;T<g;T++)d+=p[T]*x[T];t.update(d,n,1)}}this.setMode=s,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function q_(i){let e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function Y_(i,e,t){let n=new WeakMap,s=new lt;function r(a,o,l){let c=a.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=h!==void 0?h.length:0,f=n.get(o);if(f===void 0||f.count!==u){let S=function(){P.dispose(),n.delete(o),o.removeEventListener("dispose",S)};f!==void 0&&f.texture.dispose();let p=o.morphAttributes.position!==void 0,g=o.morphAttributes.normal!==void 0,x=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],d=o.morphAttributes.normal||[],T=o.morphAttributes.color||[],y=0;p===!0&&(y=1),g===!0&&(y=2),x===!0&&(y=3);let _=o.attributes.position.count*y,E=1;_>e.maxTextureSize&&(E=Math.ceil(_/e.maxTextureSize),_=e.maxTextureSize);let A=new Float32Array(_*E*4*u),P=new Dr(A,_,E,u);P.type=Nn,P.needsUpdate=!0;let D=y*4;for(let M=0;M<u;M++){let I=m[M],U=d[M],O=T[M],k=_*E*4*M;for(let z=0;z<I.count;z++){let H=z*D;p===!0&&(s.fromBufferAttribute(I,z),A[k+H+0]=s.x,A[k+H+1]=s.y,A[k+H+2]=s.z,A[k+H+3]=0),g===!0&&(s.fromBufferAttribute(U,z),A[k+H+4]=s.x,A[k+H+5]=s.y,A[k+H+6]=s.z,A[k+H+7]=0),x===!0&&(s.fromBufferAttribute(O,z),A[k+H+8]=s.x,A[k+H+9]=s.y,A[k+H+10]=s.z,A[k+H+11]=O.itemSize===4?s.w:1)}}f={count:u,texture:P,size:new Y(_,E)},n.set(o,f),o.addEventListener("dispose",S)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let p=0;for(let x=0;x<c.length;x++)p+=c[x];let g=o.morphTargetsRelative?1:1-p;l.getUniforms().setValue(i,"morphTargetBaseInfluence",g),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",f.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",f.size)}return{update:r}}function Z_(i,e,t,n){let s=new WeakMap;function r(l){let c=n.render.frame,h=l.geometry,u=e.get(l,h);if(s.get(u)!==c&&(e.update(u),s.set(u,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),s.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,c))),l.isSkinnedMesh){let f=l.skeleton;s.get(f)!==c&&(f.update(),s.set(f,c))}return u}function a(){s=new WeakMap}function o(l){let c=l.target;c.removeEventListener("dispose",o),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:r,dispose:a}}var kd=new $t,Sd=new Vr(1,1),Vd=new Dr,Hd=new co,Gd=new Or,bd=[],Td=[],wd=new Float32Array(16),Ed=new Float32Array(9),Ad=new Float32Array(4);function tr(i,e,t){let n=i[0];if(n<=0||n>0)return i;let s=e*t,r=bd[s];if(r===void 0&&(r=new Float32Array(s),bd[s]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(r,o)}return r}function It(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function Dt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function Ol(i,e){let t=Td[e];t===void 0&&(t=new Int32Array(e),Td[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function J_(i,e){let t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function $_(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(It(t,e))return;i.uniform2fv(this.addr,e),Dt(t,e)}}function K_(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(It(t,e))return;i.uniform3fv(this.addr,e),Dt(t,e)}}function j_(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(It(t,e))return;i.uniform4fv(this.addr,e),Dt(t,e)}}function Q_(i,e){let t=this.cache,n=e.elements;if(n===void 0){if(It(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),Dt(t,e)}else{if(It(t,n))return;Ad.set(n),i.uniformMatrix2fv(this.addr,!1,Ad),Dt(t,n)}}function e0(i,e){let t=this.cache,n=e.elements;if(n===void 0){if(It(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),Dt(t,e)}else{if(It(t,n))return;Ed.set(n),i.uniformMatrix3fv(this.addr,!1,Ed),Dt(t,n)}}function t0(i,e){let t=this.cache,n=e.elements;if(n===void 0){if(It(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),Dt(t,e)}else{if(It(t,n))return;wd.set(n),i.uniformMatrix4fv(this.addr,!1,wd),Dt(t,n)}}function n0(i,e){let t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function i0(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(It(t,e))return;i.uniform2iv(this.addr,e),Dt(t,e)}}function s0(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(It(t,e))return;i.uniform3iv(this.addr,e),Dt(t,e)}}function r0(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(It(t,e))return;i.uniform4iv(this.addr,e),Dt(t,e)}}function a0(i,e){let t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function o0(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(It(t,e))return;i.uniform2uiv(this.addr,e),Dt(t,e)}}function l0(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(It(t,e))return;i.uniform3uiv(this.addr,e),Dt(t,e)}}function c0(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(It(t,e))return;i.uniform4uiv(this.addr,e),Dt(t,e)}}function h0(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(Sd.compareFunction=eh,r=Sd):r=kd,t.setTexture2D(e||r,s)}function u0(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||Hd,s)}function d0(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||Gd,s)}function f0(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||Vd,s)}function p0(i){switch(i){case 5126:return J_;case 35664:return $_;case 35665:return K_;case 35666:return j_;case 35674:return Q_;case 35675:return e0;case 35676:return t0;case 5124:case 35670:return n0;case 35667:case 35671:return i0;case 35668:case 35672:return s0;case 35669:case 35673:return r0;case 5125:return a0;case 36294:return o0;case 36295:return l0;case 36296:return c0;case 35678:case 36198:case 36298:case 36306:case 35682:return h0;case 35679:case 36299:case 36307:return u0;case 35680:case 36300:case 36308:case 36293:return d0;case 36289:case 36303:case 36311:case 36292:return f0}}function m0(i,e){i.uniform1fv(this.addr,e)}function g0(i,e){let t=tr(e,this.size,2);i.uniform2fv(this.addr,t)}function _0(i,e){let t=tr(e,this.size,3);i.uniform3fv(this.addr,t)}function x0(i,e){let t=tr(e,this.size,4);i.uniform4fv(this.addr,t)}function v0(i,e){let t=tr(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function y0(i,e){let t=tr(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function M0(i,e){let t=tr(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function S0(i,e){i.uniform1iv(this.addr,e)}function b0(i,e){i.uniform2iv(this.addr,e)}function T0(i,e){i.uniform3iv(this.addr,e)}function w0(i,e){i.uniform4iv(this.addr,e)}function E0(i,e){i.uniform1uiv(this.addr,e)}function A0(i,e){i.uniform2uiv(this.addr,e)}function C0(i,e){i.uniform3uiv(this.addr,e)}function R0(i,e){i.uniform4uiv(this.addr,e)}function P0(i,e,t){let n=this.cache,s=e.length,r=Ol(t,s);It(n,r)||(i.uniform1iv(this.addr,r),Dt(n,r));for(let a=0;a!==s;++a)t.setTexture2D(e[a]||kd,r[a])}function I0(i,e,t){let n=this.cache,s=e.length,r=Ol(t,s);It(n,r)||(i.uniform1iv(this.addr,r),Dt(n,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||Hd,r[a])}function D0(i,e,t){let n=this.cache,s=e.length,r=Ol(t,s);It(n,r)||(i.uniform1iv(this.addr,r),Dt(n,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||Gd,r[a])}function L0(i,e,t){let n=this.cache,s=e.length,r=Ol(t,s);It(n,r)||(i.uniform1iv(this.addr,r),Dt(n,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||Vd,r[a])}function U0(i){switch(i){case 5126:return m0;case 35664:return g0;case 35665:return _0;case 35666:return x0;case 35674:return v0;case 35675:return y0;case 35676:return M0;case 5124:case 35670:return S0;case 35667:case 35671:return b0;case 35668:case 35672:return T0;case 35669:case 35673:return w0;case 5125:return E0;case 36294:return A0;case 36295:return C0;case 36296:return R0;case 35678:case 36198:case 36298:case 36306:case 35682:return P0;case 35679:case 36299:case 36307:return I0;case 35680:case 36300:case 36308:case 36293:return D0;case 36289:case 36303:case 36311:case 36292:return L0}}var mh=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=p0(t.type)}},gh=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=U0(t.type)}},_h=class{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){let s=this.seq;for(let r=0,a=s.length;r!==a;++r){let o=s[r];o.setValue(e,t[o.id],n)}}},ph=/(\w+)(\])?(\[|\.)?/g;function Cd(i,e){i.seq.push(e),i.map[e.id]=e}function N0(i,e,t){let n=i.name,s=n.length;for(ph.lastIndex=0;;){let r=ph.exec(n),a=ph.lastIndex,o=r[1],l=r[2]==="]",c=r[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===s){Cd(t,c===void 0?new mh(o,i,e):new gh(o,i,e));break}else{let u=t.map[o];u===void 0&&(u=new _h(o),Cd(t,u)),t=u}}}var Qs=class{constructor(e,t){this.seq=[],this.map={};let n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){let r=e.getActiveUniform(t,s),a=e.getUniformLocation(t,r.name);N0(r,a,this)}}setValue(e,t,n,s){let r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){let s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,a=t.length;r!==a;++r){let o=t[r],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,s)}}static seqWithValue(e,t){let n=[];for(let s=0,r=e.length;s!==r;++s){let a=e[s];a.id in t&&n.push(a)}return n}};function Rd(i,e,t){let n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}var F0=37297,O0=0;function B0(i,e){let t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){let o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}var Pd=new Ge;function z0(i){je._getMatrix(Pd,je.workingColorSpace,i);let e=`mat3( ${Pd.elements.map(t=>t.toFixed(4))} )`;switch(je.getTransfer(i)){case Rr:return[e,"LinearTransferOETF"];case nt:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function Id(i,e,t){let n=i.getShaderParameter(e,i.COMPILE_STATUS),r=(i.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";let a=/ERROR: 0:(\d+)/.exec(r);if(a){let o=parseInt(a[1]);return t.toUpperCase()+`

`+r+`

`+B0(i.getShaderSource(e),o)}else return r}function k0(i,e){let t=z0(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function V0(i,e){let t;switch(e){case Go:t="Linear";break;case Ys:t="Reinhard";break;case Wo:t="Cineon";break;case Xo:t="ACESFilmic";break;case Yo:t="AgX";break;case Zo:t="Neutral";break;case qo:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var Nl=new R;function H0(){je.getLuminanceCoefficients(Nl);let i=Nl.x.toFixed(4),e=Nl.y.toFixed(4),t=Nl.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function G0(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(da).join(`
`)}function W0(i){let e=[];for(let t in i){let n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function X0(i,e){let t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){let r=i.getActiveAttrib(e,s),a=r.name,o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function da(i){return i!==""}function Dd(i,e){let t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Ld(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}var q0=/^[ \t]*#include +<([\w\d./]+)>/gm;function xh(i){return i.replace(q0,Z0)}var Y0=new Map;function Z0(i,e){let t=qe[e];if(t===void 0){let n=Y0.get(e);if(n!==void 0)t=qe[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return xh(t)}var J0=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Ud(i){return i.replace(J0,$0)}function $0(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Nd(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function K0(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Vc?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===No?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===qn&&(e="SHADOWMAP_TYPE_VSM"),e}function j0(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case ts:case ns:e="ENVMAP_TYPE_CUBE";break;case aa:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Q0(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case ns:e="ENVMAP_MODE_REFRACTION";break}return e}function ex(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Wc:e="ENVMAP_BLENDING_MULTIPLY";break;case Zu:e="ENVMAP_BLENDING_MIX";break;case Ju:e="ENVMAP_BLENDING_ADD";break}return e}function tx(i){let e=i.envMapCubeUVHeight;if(e===null)return null;let t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function nx(i,e,t,n){let s=i.getContext(),r=t.defines,a=t.vertexShader,o=t.fragmentShader,l=K0(t),c=j0(t),h=Q0(t),u=ex(t),f=tx(t),p=G0(t),g=W0(r),x=s.createProgram(),m,d,T=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+d);let y=T+m+a,_=T+d+o,E=Rd(s,s.VERTEX_SHADER,y),A=Rd(s,s.FRAGMENT_SHADER,_);s.attachShader(x,E),s.attachShader(x,A),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function P(I){if(i.debug.checkShaderErrors){let U=s.getProgramInfoLog(x)||"",O=s.getShaderInfoLog(E)||"",k=s.getShaderInfoLog(A)||"",z=U.trim(),H=O.trim(),J=k.trim(),V=!0,ce=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(V=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,E,A);else{let pe=Id(s,E,"vertex"),ye=Id(s,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
varying vec3 vLocal;`).replace("#include <color_fragment>",`#include <color_fragment>
 ...
 `)};function Ih(i,e,t,n=!1){let s=Zn(i,e,t);if(n){let r=s.attributes.position;for(let a=0;a<r.count;a++)if(r.getY(a)>=1.75-1e-6){let o=r.getZ(a),l=Math.max(0,-o,o-e),c=l>=t-1e-6?0:Math.sqrt(Math.max(0,t*t-l*l));r.setY(a,1.75+c)}r.needsUpdate=!0,s.computeVertexNormals(),s.computeBoundingBox(),s.computeBoundingSphere()}return s}function nv(i,e=!1){let t=Ih(i,.095,.087,e),n=t.attributes.normal,s=t.attributes.position;for(let r=0;r<n.count;r++)if(n.getZ(r)>.99){let a=new R(.025,(s.getY(r)-.85)*.22,1).normalize();n.setXYZ(r,a.x,a.y,a.z)}return t}var us=new Je;us.name="Extruded SKYNET letters";us.position.set(-6.4,-2.74,1.55);Rt.add(us);var Dh=0;for(let i of"SKYNET"){let e=new Je;e.position.x=Dh,us.add(e);let t=tv[i].map(([r,a])=>[r*1.81+a*.14,a*1.75]),n=Oi(t),s=i==="K"||i==="Y";bt(Ih(n,.82,.125,s),Qt,e,0,0,-.74),bt(Ih(n,.045,.102,s),At,e,0,0,.105),bt(nv(n,s),ba,e,0,.025,.235),Dh+=Math.max(...t.map(r=>r[0]))+.16}us.scale.x=12.8/(Dh-.16);var mf=bt(Zn(Oi([[-6.85,-2.98],[-6.53,-1.01],[6.55,-1.01],[6.8,-2.98]]),.27,.065),Fi.withEdges(Fi.face),Rt,0,0,.89);mf.name="Brushed-metal SKYNET backing panel";di([[-6.8,-2.94,1.25],[-6.5,-1.04,1.25],[6.5,-1.04,1.25]],Ma);for(let i=0;i<44;i++)Ui(.16,.035,.025,i%7?Yt:At,Rt,-6.2+i*.29,-2.91,1.29);var ds=new Je;ds.name="Extruded CYBERDYNE SYSTEMS";ds.position.set(0,-.61,1.27);Rt.add(ds);var gf=bt(Zn(Oi([[-5.92,-.17],[-5.64,.43],[5.61,.43],[5.94,-.17]]),.2,.045),Fi.withEdges(Qt),ds,0,0,-.1),Bh=Jd("CYBERDYNE SYSTEMS",Fh);gf.geometry.computeBoundingBox();var rf=new Mn().setFromObject(Bh),af=gf.geometry.boundingBox;Bh.position.y=(af.min.y+af.max.y-rf.min.y-rf.max.y)/2;ds.add(Bh);Ui(11.4,.023,.03,At,ds,0,-.16,.23);bt(Zn(Oi([[-3.5,-2.62],[0,-4.31],[3.5,-2.62],[0,-1.8]]),.36,.06),Fi.withEdges(mt),Rt,0,0,-.35);bt(Zn(Oi([[-3.18,-2.63],[0,-4.12],[3.18,-2.63],[0,-2]]),.15,.025),Fi.withEdges(Qt),Rt,0,0,.09);di([[-3.1,-2.65,.31],[0,-4.1,.31],[3.1,-2.65,.31]],Ma);Ui(.065,1.42,.1,At,Rt,0,-3.55,.48);ar(16715818,1.3,Rt,0,-4.14,.52,.7);var $l=Qt.clone();$l.color.set(263689);$l.envMapIntensity=.025;$l.roughness=.34;var hr=new Je;hr.position.set(0,-4.45,0);Rt.add(hr);for(let i=0;i<4;i++){let e=6.8-i*.85;bt(new un(e,e+.08,.16,128),$l,hr,0,i*.12,0)}var wn=new Je;wn.rotation.x=-Math.PI/2;wn.position.y=.51;hr.add(wn);for(let i=0;i<11;i++){let e=1.55+i*.4;an(e,i%3===0?.025:.01,i%3===0?At:i%2?mt:Yt,wn),i%2===0&&(xa(e,96,.032,.055,mt,wn,.015),va(e,24,.023,wn,.015))}var Xl=new Je;wn.add(Xl);Li.push({g:Xl,s:.04});for(let i=0;i<18;i++)St(5.6,.16,i*gt/18,.25,.04,Qt,Xl),St(5.15,.035,i*gt/18,.1,.02,At,Xl,.02);for(let i=0;i<48;i++){let e=i/48*gt;St(6.32,.84,e,.115,.045,i%4===0?Yt:Qt,wn,-.27),St(5.9,.045,e+.012,.08,.05,mt,wn,-.2),i%3===0&&St(6.36,.035,e+.02,.06,.02,At,wn,-.18);let t=Math.cos(e),n=Math.sin(e);di([[t*5.78,n*5.78,.01],[t*5.93,n*5.93,.01],[Math.cos(e+.024)*6.03,Math.sin(e+.024)*6.03,.01],[Math.cos(e+.024)*6.45,Math.sin(e+.024)*6.45,.01]],i%4===0?Ma:hf,wn)}cs(Array.from({length:100},(i,e)=>{let t=e/100*gt,n=e%3===0?6.35:4.8;return[Math.cos(t)*n,Math.sin(t)*n,.06]}),wn,1.05);var iv=bt(new nn(110,110),new zt({color:132104}),ht,0,-4.62,0);iv.rotation.x=-Math.PI/2;function sv(){let i=document.createElement("canvas");i.width=512,i.height=512;let e=i.getContext("2d");e.clearRect(0,0,512,512),e.lineWidth=1;for(let n=0;n<75;n++){let s=Qe()*512,r=Qe()*420;e.strokeStyle=n%4===0?"#e34154":"#3c7598",e.globalAlpha=.2+Qe()*.6,e.beginPath(),e.moveTo(r,s),e.lineTo(r+30,s),e.lineTo(r+45,s+15),e.lineTo(r+80+Qe()*120,s+15),e.stroke(),e.fillStyle=e.strokeStyle,e.fillRect(r,s-1,3,3)}e.font="8px monospace",e.globalAlpha=.6;for(let n=0;n<40;n++)e.fillStyle=n%4===0?"#ef344e":"#5a9ab5",e.fillText(Array.from({length:28},()=>Math.floor(Qe()*16).toString(16)).join(" "),10,18+n*12);let t=new Hn(i);return t.colorSpace=Ft,t}var rv=new zt({map:sv(),transparent:!0,opacity:.18,side:Wt,depthWrite:!1,blending:Xt});for(let i of[-1,1])for(let e=0;e<4;e++){let t=new Je;t.position.set(i*(8.5+e*1.2),1.7+e%2*2,-3-e*4),t.rotation.y=-i*.4,ht.add(t),bt(new nn(4.2,4.8),rv,t),Ui(.035,4.9,.05,Fi.edge,t,i*2.16,0,0),Ui(4.3,.018,.025,e%2?Rh:Wl,t,0,-2.45,0),Ui(4.3,.01,.025,Rh,t,0,2.45,0)}var _f=new Je;ht.add(_f);var xf=new Vt({color:3695491,transparent:!0,opacity:.035}),vf=new Vt({color:9445678,transparent:!0,opacity:.06});for(let i=0;i<65;i++){let t=(i%2?1:-1)*(6+Qe()*20),n=-3+Qe()*16,s=-8-Qe()*26;di([[t,n,s],[t*.4,n*.4,s-25]],i%6===0?vf:xf,_f)}cs(Array.from({length:150},()=>[(Qe()-.5)*36,-3+Qe()*17,-3-Qe()*24]),ht,1.05);for(let i=0;i<7;i++){let e=new Je;e.position.set(0,1,-6-i*3),ht.add(e),an(12+i*.45,.075,Qt,e);for(let t=0;t<12;t++){let n=t*gt/12;St(12+i*.45,.045,n,.17,.05,Yt,e)}}for(let i=0;i<50;i++){let e=i*gt/50,t=7+Qe()*2;di([[Math.cos(e)*t,-4.59,Math.sin(e)*t],[Math.cos(e)*t*1.6,-4.59,Math.sin(e)*t*1.6],[Math.cos(e+.025)*t*2.8,-4.59,Math.sin(e+.025)*t*2.8]],i%9===0?vf:xf,ht)}var Kl=900,Gl=new Float32Array(Kl*3),or=new Float32Array(Kl*3);for(let i=0;i<Kl;i++)or[i*3]=(Qe()-.5)*45,or[i*3+1]=Qe()*19-5,or[i*3+2]=Qe()*36-20;var zh=new rt;zh.setAttribute("position",new Bt(Gl,3));var av=new wi(zh,new Vs({color:new Ce(2,.12,.15),size:.035,transparent:!0,opacity:.8,blending:Xt,depthWrite:!1}));ht.add(av);function ov(){let i=document.createElement("canvas");i.width=i.height=256;let e=i.getContext("2d");for(let n=0;n<180;n++){let s=Qe()*256,r=Qe()*256,a=8+Qe()*36,o=e.createRadialGradient(s,r,0,s,r,a);o.addColorStop(0,"rgba(130,149,171,.03)"),o.addColorStop(1,"rgba(0,0,0,0)"),e.fillStyle=o,e.fillRect(0,0,256,256)}return new Hn(i)}var lv=ov(),yf=[];for(let i=0;i<18;i++){let e=new Ji({map:lv,color:i%3===0?6652820:10241880,transparent:!0,opacity:.19,depthWrite:!1,blending:Xt}),t=new Bs(e);t.position.set((Qe()-.5)*25,-3.6+Qe()*.3,(Qe()-.5)*12),t.scale.set(8,2.2,1),ht.add(t),yf.push({s:t,x:t.position.x})}ar(8833791,7,ht,0,9,-5,.18);Ni=Zd({scene:ht,root:Rt,neural:fi,stars:ui,crest:On,plates:Jl,word:us,dais:hr,renderer:Ct,camera:mn,controls:Ze,chrome:mt,steel:Yt,black:Qt,letterMetal:ba,rnd:Qe});var Lh=$d({chassis:Sa,dais:hr,crest:On,neural:fi,word:us,subtitle:ds,primaryCore:pf,upperCore:ev,coreLight:Zl}),Mf=jd({scene:ht,root:Rt,crest:On,plates:Jl,wordBacking:mf,primaryCore:pf,renderer:Ct,steel:Yt,black:Qt}),cv=Qd(),hv=Ni.update;Ni.update=(...i)=>{hv(...i);let e=Ni.stats();Lh.update(e),Mf.update(i[0],e,Lh.stats().powerStages)};var Tn=!matchMedia("(prefers-reduced-motion: reduce)").matches,Fn=0,Sf=0,of=performance.now();Et("motion").setAttribute("aria-pressed",String(Tn));function bf(i){Tn&&(Fn+=i);for(let e of Oh)e.uniforms.time.value=Fn,e.uniforms.resolution.value=innerHeight*Ct.getPixelRatio();for(let{g:e,s:t,axis:n="z"}of Li)e.rotation[n]=Fn*t;for(let e of Ph){let t=e.base*(1+Math.sin(Fn*2.4)*.065);e.obj.scale.set(t,t,1)}Zl.intensity=18+Math.sin(Fn*2.4)*3;for(let e=0;e<Kl;e++)Gl[e*3]=or[e*3]+Math.sin(Fn*.12+e)*.13,Gl[e*3+1]=(or[e*3+1]+5+Fn*(.06+e%5*.013))%19-5,Gl[e*3+2]=or[e*3+2];zh.attributes.position.needsUpdate=!0;for(let e of yf)e.s.position.x=e.x+Math.sin(Fn*.1+e.x)*.4;Ni.update(Fn,Tn?i:0,Tn),sf(Ze,i,Tn),(Tn||ls)&&(Jx(),ls=!1,Sf++)}function Tf(i){let e=Math.max(0,Math.min((i-of)/1e3,.06));of=i,bf(e),requestAnimationFrame(Tf)}requestAnimationFrame(Tf);Et("home").onclick=ya;Ct.domElement.ondblclick=ya;Et("orbit").onclick=()=>{Ze.autoRotate=!Ze.autoRotate,Et("orbit").setAttribute("aria-pressed",String(Ze.autoRotate))};Et("motion").onclick=()=>{Tn=!Tn,Et("motion").setAttribute("aria-pressed",String(Tn))};Et("glow").oninput=i=>{Uh.strength=Number(i.target.value)};Et("compare").onclick=()=>{let i=Et("reference").classList.toggle("show");Et("compare").setAttribute("aria-pressed",String(i))};Et("fullscreen").onclick=async()=>{try{document.fullscreenElement?await document.exitFullscreen():await document.documentElement.requestFullscreen()}catch{Et("message").textContent="Fullscreen is unavailable in this viewer. Open the file in Chrome."}};Et("stage").addEventListener("keydown",i=>{let e=new Xn().setFromVector3(mn.position.clone().sub(Ze.target));if(i.key==="ArrowLeft")e.theta-=.1;else if(i.key==="ArrowRight")e.theta+=.1;else if(i.key==="ArrowUp")e.phi=Math.max(.2,e.phi-.1);else if(i.key==="ArrowDown")e.phi=Math.min(Math.PI*.8,e.phi+.1);else if(i.key==="Home"){ya();return}else return;i.preventDefault(),mn.position.copy(Ze.target).add(new R().setFromSpherical(e)),Ze.update()});addEventListener("resize",()=>{mn.aspect=innerWidth/innerHeight,mn.updateProjectionMatrix(),Ct.setSize(innerWidth,innerHeight),lr.setSize(innerWidth,innerHeight),cr.setSize(innerWidth,innerHeight)});Ct.domElement.addEventListener("webglcontextlost",i=>{i.preventDefault(),Et("message").textContent="The graphics context was interrupted. Reload to restore the scene."});Et("replay").onclick=()=>{Tn=!0,Et("motion").setAttribute("aria-pressed","true"),Ni.replay()};var uv=Et("motion").onclick;Et("motion").onclick=()=>{if(uv(),!Tn){let i=Ze.autoRotate,e=Ze.enableDamping;Ze.autoRotate=!1,Ze.enableDamping=!1,Ze.update(0),Ze.enableDamping=e,Ze.autoRotate=i}ls=!0};Et("glow").addEventListener("input",()=>{ls=!0});addEventListener("resize",()=>{ls=!0});window.skynet={scene:ht,camera:mn,controls:Ze,renderer:Ct,composer:lr,reset:ya,setTime(i){Fn=i,ls=!0,bf(0)},stats(){let i=0,e=0;return Rt.traverse(t=>{t.isMesh&&i++,t.geometry?.type==="ExtrudeGeometry"&&e++}),{version:"2026.09.05.8",...Ni.stats(),...Lh.stats(),...Mf.stats(),...cv.stats(),beaconCount:cf,beaconTime:Oh[0].uniforms.time.value,meshes:i,extrusions:e,frames:Sf,elapsed:Fn,camera:mn.position.toArray(),distance:mn.position.distanceTo(Ze.target),glow:Uh.strength,orbitAngle:Ze.getAzimuthalAngle(),orbitPath:"left-up-right-down",orbitElevation:Math.PI/2-Ze.getPolarAngle(),upperCoreAnimation:!0,autoOrbit:Ze.autoRotate,animated:Tn,drawCalls:Ct.info.render.calls}},ready:!0};Et("loading").remove();})();
