...
credited with its author and source link in [`audio/CREDITS.md`](audio/CREDITS.md).
...
## Scanned beach debris: `models/debris/`
...
[`models/debris/CREDITS.md`](models/debris/CREDITS.md).

## Vendor stalls: `models/props/`
...
`tools/props/fonts/`. Details are in [`models/props/CREDITS.md`](models/props/CREDITS.md).

## Humpback whale: `models/whale/`
