...
export const MAPS = [
  ...
  },
  {
    ...
    paths: [
      ...
      [ // the north loop — the long arc over the massif's crown
        [-60, 420], [150, 430], [360, 470], [520, 330], [700, 235],
        [960, 195], [1230, 245], [1430, 380], [1520, 540], [1560, 700],
        [1655, 862],
      ],
    ],
    pathWeights: [0.30, 0.28, 0.22, 0.20],
    heart: [1660, 870],
    portal: [-40, 420],
    floraCount: 170,
