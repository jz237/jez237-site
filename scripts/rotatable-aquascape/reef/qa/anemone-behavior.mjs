...
food.position.copy(b.tipAt(0,b.hosts[0].strands[40],1,new T.Vector3()));b.update(1,[food]);assert.equal(food.alive,false);assert.deepEqual(b.snapshot(),{captured:1,swallowed:0,carried:1,fold:[0,0,0]});
