...
export type Identification={kind:'fish'|'plant'|'invertebrate';name:string;subtitle:string;needs:string;role:string;behavior:string;point:T.Vector3;fishId?:number;coryId?:number;animalId?:number;angelId?:number;species?:string};
