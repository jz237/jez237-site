...
export type Identification={kind:'fish'|'plant';name:string;subtitle:string;needs:string;role:string;behavior:string;point:T.Vector3;fishId?:number;species?:string};
