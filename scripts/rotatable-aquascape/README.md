...
30 automated tests cover the reused locomotion, body/fin motion, needs, food perception, schooling, depth and spacing, plus world-coordinate conversion, solid contact, leaf confinement, bounded reflection capture, and collision coverage of every vertex of the six tapered wood scans. Browser checks cover the camera presets, drag, zoom, feeding, pause, lighting, responsive controls and comparison navigation.
