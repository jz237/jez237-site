...
function comparableSaleData(file) {
  return file.replace(/"generatedAt":\s*"[^"]*",/, '"generatedAt": "",');
}
...
const changed = nextPage !== page || comparableSaleData(nextSaleData) !== comparableSaleData(previousSaleData);
