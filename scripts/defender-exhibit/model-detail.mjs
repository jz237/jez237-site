...
export function buildDetailedCabinet(robotron=false){
 ...
 const {logic:boards,power}=addHardware({root,part,box,cyl,tube,ring,screw,m,mesh,mat,layouts:robotron?robotronLayouts:undefined});
 ...
 addFinish({robotron,root,cp,coin,crt,marquee,frame,back,box,cyl,ring,tube,mesh,screw,m,mat});
