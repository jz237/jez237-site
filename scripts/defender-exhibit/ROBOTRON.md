...
- Control arrangement: [surviving panel photograph](https://pixelatedarcade.com/pictures/130): left movement stick, right firing stick, two blue start buttons at the right edge. Printed panel/side design is a recreation, not a factory scan.
...
The battle and autonomous pilot are newly written. Original bitmap/sound data does **not** make this cycle-accurate Robotron emulation. Enemy timing, collision rules and wave populations are approximations. Cabinet profile, board placement, wiring and printed artwork are educational reconstructions; shared Williams components do not establish exact factory dimensions or fitment. The component notes distinguish these limits.
