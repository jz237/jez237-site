...
- Production build passes TypeScript and Vite. 27 source/model/sound/sprite tests pass. The autonomous-display tests explicitly forbid ground pickups; a separate legacy playable-game test is not the displayed demo.
