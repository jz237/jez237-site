...
for(const file of ['assets/showroom.js','assets/showroom.css','assets/showroom-navigation.js','assets/site/showroom-preview.jpg','assets/link-modal.js','assets/reef-background.js','assets/animated-header/header.js','assets/animated-header/index.html'])cpSync(resolve(site,file),resolve(preview,file));
