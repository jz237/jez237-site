...
| Intermediate / Ultimate acid, 109–114s | Replaced rigid disks with dark green, deforming lobed surfaces. Rendering and sensors share the complete concave mesh, including safe notches. All five Intermediate puddles now follow board-axis legs, including additional upper-right perpendicular turns; sound follows current position. See ACID-REFERENCE.md for measured screen centers. | Full original outlines, deformation cadence, dimensions, complete patrol loops, identity through overlapping outlines, speeds/phases and Ultimate paths remain provisional. Capture animation and original effects remain open. |
...
- Physics/replay version is `rapier-0.20.0-mm-21`: old recordings cannot silently
