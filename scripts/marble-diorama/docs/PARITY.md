...
| Silly | PARTIAL: reverse uphill course, mini room, flared powered red uplift, two mazes, bird field and split goal climbs; solo demo collects six of nine miniatures, paired paths collect three each, all finish without falls; exact original route coverage open | Nine collectible miniatures: three steelies, three curling munchers and three deforming puddles (+500/+3), flapping purple birds with articulated collision solids, pyramids; demos anticipate bird launches; exact flight pattern, second uplift horn and original transfer law open | 25 units added; upward transfer pays 2000; timed solo campaign now completes Silly; full score/time parity open |
