import {shadeCeramic} from '../lib/aquarium/CeramicShading';
...
export function FilterMaterialCloseup(){
 ...
 useEffect(()=>{
  ...
  const textures=ceramicSurface(),material=new T.MeshStandardMaterial({color:0xffffff,vertexColors:true,roughness:.83,...textures,bumpScale:.0012});const geometries:T.BufferGeometry[]=[];shadeCeramic(material);
